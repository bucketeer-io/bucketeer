...
{{- else -}}
{{ template "push-sender.fullname" . }}-service-cert
{{- end -}}
{{- end -}}
...
{{- else -}}
{{ template "push-sender.fullname" . }}-service-token
{{- end -}}
{{- end -}}