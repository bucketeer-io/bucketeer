...
var (
	...
	ErrMissingOrganizationID   = pkgErr.NewErrorInvalidEmpty(pkgErr.AccountPackageName, "organization id must be specified", "organization_id")
	ErrEmailIsEmpty            = pkgErr.NewErrorInvalidEmpty(pkgErr.AccountPackageName, "email is empty", "email")
	ErrEmailInvalidFormat      = pkgErr.NewErrorInvalidNotMatchFormat(pkgErr.AccountPackageName, "invalid email format", "email")
	ErrFullNameIsEmpty         = pkgErr.NewErrorInvalidEmpty(pkgErr.AccountPackageName, "full name is empty", "full_name")
	ErrFirstNameInvalidFormat  = pkgErr.NewErrorInvalidNotMatchFormat(pkgErr.AccountPackageName, "invalid first name format", "first name")
	ErrLastNameInvalidFormat   = pkgErr.NewErrorInvalidNotMatchFormat(pkgErr.AccountPackageName, "invalid last name format", "last_name")
	ErrLanguageIsEmpty         = pkgErr.NewErrorInvalidEmpty(pkgErr.AccountPackageName, "language is empty", "language")
	ErrOrganizationRoleInvalid = pkgErr.NewErrorInvalidEmpty(pkgErr.AccountPackageName, "invalid organization role", "organization_role")
)
