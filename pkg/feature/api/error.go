...
var (
	...
	statusMissingFeatureIDs          = gstatus.New(codes.InvalidArgument, "feature: missing feature ids")
	...
	statusCommentRequiredForUpdating = gstatus.New(
		codes.FailedPrecondition,
		"feature: a comment is required for updating",
	)
