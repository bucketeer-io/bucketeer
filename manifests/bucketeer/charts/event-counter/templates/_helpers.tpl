...
{{- else -}}
{{ template "event-counter.fullname" . }}-service-cert
{{- end -}}
{{- end -}}
...
{{- else -}}
{{ template "event-counter.fullname" . }}-oauth-key
{{- end -}}
{{- end -}}
...
{{- else -}}
{{ template "event-counter.fullname" . }}-service-token
{{- end -}}
{{- end -}}
