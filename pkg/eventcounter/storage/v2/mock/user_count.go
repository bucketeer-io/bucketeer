...
//
//	mockgen -source=user_count.go -package=mock -destination=./mock/user_count.go
//
...
func (mr *MockUserCountStorageMockRecorder) GetMAUCounts(ctx, yearMonth any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockUserCountStorageMockRecorder) GetMAUCountsGroupBySourceID(ctx, yearMonth any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
