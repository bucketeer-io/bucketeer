...
func TestTopologicalSort(t *testing.T) {
	...
	f5 := makeFeature("fID5")
	patterns := []struct {
		f0Prerequisite []*ftproto.Prerequisite
		f1Prerequisite []*ftproto.Prerequisite
		f2Prerequisite []*ftproto.Prerequisite
		f3Prerequisite []*ftproto.Prerequisite
		f4Prerequisite []*ftproto.Prerequisite
		f5Prerequisite []*ftproto.Prerequisite
	...
	for _, p := range patterns {
		...
		actual, err := evaluator.TopologicalSort(fs)
		assert.Equal(t, p.expectedError, err)
