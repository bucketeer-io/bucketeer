    ...
    >
      <div className="flex-center flex-col w-full items-start px-5 py-8 gap-y-8">
        <div className="flex-center w-full">
          <Icon icon={IconGoal} size={sizeIcon} />
        </div>
        ...
        <div className="flex-center flex-col w-full gap-y-5">
          <div className="flex-center w-full text-center px-0 sm:px-[67px] text-gray-700">
            <p className="typo-para-medium sm:typo-para-big">
              {t('goals-connected-desc')}
            </p>
          </div>
          <div className="flex flex-col w-full p-4 gap-y-5 rounded bg-gray-100 max-h-[300px] overflow-auto">
            {goals?.map((item, index) => (
              <div
                key={index}
                className="flex items-center gap-x-2 typo-para-small sm:typo-para-medium leading-4 text-primary-500"
              >
                <p>{index + 1}.</p>
                <Link
