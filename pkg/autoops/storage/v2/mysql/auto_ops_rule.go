...
func NewAutoOpsRuleStorage(qe mysqlstorage.QueryExecer) v2as.AutoOpsRuleStorage {
...
func (s *autoOpsRuleStorage) CreateAutoOpsRule(
	...
	_, err := s.qe.ExecContext(
		...
		e.FeatureId,
		int32(e.OpsType),
		mysqlstorage.JSONObject{Val: e.Clauses},
		e.CreatedAt,
		e.UpdatedAt,
		e.Deleted,
...
func (s *autoOpsRuleStorage) GetAutoOpsRule(
	...
	err := s.qe.QueryRowContext(
		...
		&opsType,
		&mysqlstorage.JSONObject{Val: &autoOpsRule.Clauses},
...
func (s *autoOpsRuleStorage) ListAutoOpsRules(
	...
	query, whereArgs := mysqlstorage.ConstructQueryAndWhereArgs(selectAutoOpsRulesSQL, options)
...
func listAutoOpsRulesOptionsFromParams(p v2as.ListAutoOpsRulesParams) (*mysqlstorage.ListOptions, error) {
