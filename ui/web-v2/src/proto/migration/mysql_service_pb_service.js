...
var MigrationMySQLService = (function () {
  ...
  MigrationMySQLService.serviceName =
...
MigrationMySQLServiceClient.prototype.migrateAllMasterSchema =
  function migrateAllMasterSchema(requestMessage, metadata, callback) {
...
MigrationMySQLServiceClient.prototype.rollbackMasterSchema =
  function rollbackMasterSchema(requestMessage, metadata, callback) {
    if (arguments.length === 2) {
      callback = arguments[1];
    }
