...
//
//	mockgen -source=mau_summary.go -package=mock -destination=./mock/mau_summary.go
//
...
func (mr *MockMAUSummaryStorageMockRecorder) UpsertMAUSummary(ctx, mauSummary any) *gomock.Call {
