...
import (
	...
	"github.com/bucketeer-io/bucketeer/v2/proto/autoops"
...
func TestCreateProgressiveRolloutMySQL(t *testing.T) {
	...
	patterns := []struct {
		...
		},
		{
			...
			expectedErr: createError(statusProgressiveRolloutControlVariationRequired, localizer.MustLocalizeWithTemplate(locale.RequiredFieldTemplate, "control_variation_id")),
		},
		{
			...
			expectedErr: createError(statusProgressiveRolloutControlVariationNotFound, localizer.MustLocalizeWithTemplate(locale.InvalidArgumentError, "control_variation_id")),
		},
		{
...
func TestCreateProgressiveRolloutNoCommandMySQL(t *testing.T) {
	...
	patterns := []struct {
		...
		},
		{
			...
			expectedErr: createError(statusProgressiveRolloutTargetVariationNotFound, localizer.MustLocalizeWithTemplate(locale.InvalidArgumentError, "target_variation_id")),
		},
		{
			desc: "err: template ErrControlVariationIdRequired",
			setup: func(aos *AutoOpsService) {
