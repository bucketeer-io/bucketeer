...
type TargetListValue struct {
	...
	Values []*Target `protobuf:"bytes,1,rep,name=values,proto3" json:"values"`
}

func (x *TargetListValue) Reset() {
	*x = TargetListValue{}
	if protoimpl.UnsafeEnabled {
		mi := &file_proto_feature_target_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}

func (x *TargetListValue) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*TargetListValue) ProtoMessage() {}

func (x *TargetListValue) ProtoReflect() protoreflect.Message {
	mi := &file_proto_feature_target_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use TargetListValue.ProtoReflect.Descriptor instead.
func (*TargetListValue) Descriptor() ([]byte, []int) {
	return file_proto_feature_target_proto_rawDescGZIP(), []int{1}
}

func (x *TargetListValue) GetValues() []*Target {
	if x != nil {
		return x.Values
	}
	return nil
...
var file_proto_feature_target_proto_rawDesc = []byte{
	...
	0x18, 0x02, 0x20, 0x03, 0x28, 0x09, 0x52, 0x05, 0x75, 0x73, 0x65, 0x72, 0x73, 0x22, 0x44, 0x0a,
	0x0f, 0x54, 0x61, 0x72, 0x67, 0x65, 0x74, 0x4c, 0x69, 0x73, 0x74, 0x56, 0x61, 0x6c, 0x75, 0x65,
	...
	0x74, 0x75, 0x72, 0x65, 0x2e, 0x54, 0x61, 0x72, 0x67, 0x65, 0x74, 0x52, 0x06, 0x76, 0x61, 0x6c,
...
var file_proto_feature_target_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_proto_feature_target_proto_goTypes = []interface{}{
	(*Target)(nil),          // 0: bucketeer.feature.Target
	(*TargetListValue)(nil), // 1: bucketeer.feature.TargetListValue
}
var file_proto_feature_target_proto_depIdxs = []int32{
	0, // 0: bucketeer.feature.TargetListValue.values:type_name -> bucketeer.feature.Target
...
func file_proto_feature_target_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_proto_feature_target_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*TargetListValue); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
