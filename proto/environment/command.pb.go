...
type CreateOrganizationCommand struct {
	...
	UrlCode     string `protobuf:"bytes,2,opt,name=url_code,json=urlCode,proto3" json:"url_code,omitempty"`
	Description string `protobuf:"bytes,3,opt,name=description,proto3" json:"description,omitempty"` // optional
	IsTrial     string `protobuf:"bytes,4,opt,name=is_trial,json=isTrial,proto3" json:"is_trial,omitempty"`
}
...
func (x *CreateOrganizationCommand) GetIsTrial() string {
	if x != nil {
		return x.IsTrial
	}
	return ""
...
var file_proto_environment_command_proto_rawDesc = []byte{
	...
	0x43, 0x6f, 0x6d, 0x6d, 0x61, 0x6e, 0x64, 0x22, 0x87, 0x01, 0x0a, 0x19, 0x43, 0x72, 0x65, 0x61,
	...
	0x61, 0x6c, 0x18, 0x04, 0x20, 0x01, 0x28, 0x09, 0x52, 0x07, 0x69, 0x73, 0x54, 0x72, 0x69, 0x61,
