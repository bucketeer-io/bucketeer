...
{{- else -}}
{{ template "auditlog.fullname" . }}-service-cert
{{- end -}}
{{- end -}}
...
{{- else -}}
{{ template "auditlog.fullname" . }}-oauth-key
{{- end -}}
{{- end -}}
...
{{- else -}}
{{ template "auditlog.fullname" . }}-service-token
{{- end -}}
{{- end -}}