...
<html lang="en">
	...
	defaultWelcomeSubject = "Welcome to Bucketeer – You’ve been invited to join"
	//nolint:lll
	defaultWelcomeBody = `
<!DOCTYPE html>
<html lang="en">
    ...
    <body style="margin:0;padding:0;background:#f5f5f5;color:#333;font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,Helvetica,Arial,sans-serif;line-height:1.6;">
        <div style="display:none;overflow:hidden;line-height:1px;opacity:0;max-height:0;max-width:0;">
            You've been added to Bucketeer — sign in to get started.
        </div>
        <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
            <tr>
                <td align="center" style="padding:24px 12px;">
                    <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="600" style="width:100%;max-width:600px;background:#ffffff;border-radius:8px;overflow:hidden;box-shadow:0 2px 8px rgba(0,0,0,0.08);">
                        <tr>
                            <td style="padding:32px;background:#ffffff;">
                                <img src="{{webConsoleEndpoint}}/img/bucketeer-logo-primary.png" alt="Bucketeer" width="205" height="48" style="display:block;margin-bottom:24px;" />
                                <p style="margin:0 0 24px 0;font-size:15px;color:#4b5563;">Hello, {{userEmail}}.</p>
                                <p style="margin:0 0 24px 0;font-size:15px;color:#4b5563;">You've been invited to join <strong>Bucketeer</strong>, a feature flag and A/B testing platform.</p>
                                <p style="margin:0 0 24px 0;font-size:15px;color:#4b5563;">You can access the Bucketeer console using the link below and sign in with the authentication method configured for your account.</p>
                                <table role="presentation" cellspacing="0" cellpadding="0" border="0" style="margin:0 0 24px 0;">
                                    <tr>
                                        <td align="center">
                                ...
                                <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%" style="margin:0 0 24px 0;">
                                    <tr>
                                        <td style="padding:16px 20px;background:#ECF6FD;border-left:4px solid #399CE4;border-radius:6px;">
                                            <p style="margin:0 0 12px 0;font-size:14px;font-weight:600;color:#23405D;">Need access help?</p>
                                            <ul style="margin:0;padding-left:20px;font-size:14px;color:#29577F;line-height:1.8;">
                                                <li>If you encounter any issues accessing the console, please contact your administrator.</li>
                                            </ul>
                                        </td>
                                    </tr>
                                </table>
                                <p style="margin:0;font-size:14px;color:#4b5563;">Welcome aboard,<br>The Bucketeer Team</p>
                            </td>
                        </tr>
                    </table>
                </td>
...
func NewTemplateRenderer(config auth.EmailConfig) *TemplateRenderer {
