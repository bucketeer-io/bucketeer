...
type Editor struct {
	...
	EnvironmentRoles []*account.AccountV2_EnvironmentRole `protobuf:"bytes,8,rep,name=environment_roles,json=environmentRoles,proto3" json:"environment_roles"`                                                     // this is not saved in auditlog table
	OrganizationRole account.AccountV2_Role_Organization  `protobuf:"varint,9,opt,name=organization_role,json=organizationRole,proto3,enum=bucketeer.account.AccountV2_Role_Organization" json:"organization_role"` // this is not saved in auditlog table
}
