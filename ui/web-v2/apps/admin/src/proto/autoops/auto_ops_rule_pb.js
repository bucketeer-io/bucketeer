...
proto.bucketeer.autoops.AutoOpsRules = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, proto.bucketeer.autoops.AutoOpsRules.repeatedFields_, null);
};
...
if (goog.DEBUG && !COMPILED) {
   ...
   * @override
   */
  proto.bucketeer.autoops.AutoOpsRules.displayName = 'proto.bucketeer.autoops.AutoOpsRules';
}
 ...
 * @return {!Object}
 */
proto.bucketeer.autoops.AutoOpsRules.prototype.toObject = function(opt_includeInstance) {
  return proto.bucketeer.autoops.AutoOpsRules.toObject(opt_includeInstance, this);
};
 ...
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.bucketeer.autoops.AutoOpsRules.toObject = function(includeInstance, msg) {
  var f, obj = {
    autoOpsRulesList: jspb.Message.toObjectList(msg.getAutoOpsRulesList(),
    proto.bucketeer.autoops.AutoOpsRule.toObject, includeInstance)
  };
...
proto.bucketeer.autoops.AutoOpsRules.deserializeBinary = function(bytes) {
  ...
  return proto.bucketeer.autoops.AutoOpsRules.deserializeBinaryFromReader(msg, reader);
};
 ...
 * @return {!proto.bucketeer.autoops.AutoOpsRules}
 */
proto.bucketeer.autoops.AutoOpsRules.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
    ...
    case 1:
      ...
      reader.readMessage(value,proto.bucketeer.autoops.AutoOpsRule.deserializeBinaryFromReader);
 ...
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.bucketeer.autoops.AutoOpsRules.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
 ...
 */
proto.bucketeer.autoops.AutoOpsRules.prototype.getAutoOpsRulesList = function() {
  return /** @type{!Array<!proto.bucketeer.autoops.AutoOpsRule>} */ (
    jspb.Message.getRepeatedWrapperField(this, proto.bucketeer.autoops.AutoOpsRule, 1));
};
...
*/
proto.bucketeer.autoops.AutoOpsRules.prototype.setAutoOpsRulesList = function(value) {
 ...
 * @return {!proto.bucketeer.autoops.AutoOpsRule}
 */
proto.bucketeer.autoops.AutoOpsRules.prototype.addAutoOpsRules = function(opt_value, opt_index) {
 ...
 * @return {!proto.bucketeer.autoops.AutoOpsRules} returns this
 */
proto.bucketeer.autoops.AutoOpsRules.prototype.clearAutoOpsRulesList = function() {
