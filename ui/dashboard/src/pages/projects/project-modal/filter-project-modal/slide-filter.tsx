...
import useFilterProjectLogic from './use-filter-project-logic';
...
const FilterProjectSlide = ({
  ...
  const {
    ...
    onConfirmHandler,
    setValueOption
  } = useFilterProjectLogic(onSubmit, filters);
  return (
...
export default FilterProjectSlide;
