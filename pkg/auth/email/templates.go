...
<html lang="en">
	...
	defaultPasswordSetupSubject = "Complete your Bucketeer account setup"
	//nolint:lll
...
<html lang="en">
  <head>
    ...
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <meta name="x-apple-disable-message-reformatting">
    <title>Complete your Bucketeer account setup</title>
  </head>
  <body style="margin:0;padding:0;background:#f5f5f5;color:#333;font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,Helvetica,Arial,sans-serif;line-height:1.6;">
    <div style="display:none;overflow:hidden;line-height:1px;opacity:0;max-height:0;max-width:0;">
      Finish setting up your sign-in to access the console.
    </div>
    <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
      <tr>
        <td align="center" style="padding:24px 12px;">
            ...
            <tr>
              <td style="padding:32px;background:#ffffff;">
                ...
                <p style="margin:0 0 20px 0;font-size:15px;color:#4b5563;">
                  To complete your account setup, click on the button below.
                </p>
                <table role="presentation" cellspacing="0" cellpadding="0" border="0" style="margin:0 0 24px 0;">
                  <tr><td align="center">
                    <a href="{{setupURL}}" style="background:#5B21B6;color:#ffffff;text-decoration:none;padding:14px 32px;border-radius:6px;display:inline-block;font-weight:600;font-size:15px;">Complete Account Setup</a>
                  </td></tr>
                </table>
                ...
                <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%" style="margin:0 0 24px 0;">
                  <tr><td style="padding:16px 20px;background:#ECF6FD;border-left:4px solid #399CE4;border-radius:6px;">
                    ...
                    <ul style="margin:0;padding-left:20px;font-size:14px;color:#29577F;line-height:1.8;">
                      ...
                      <li>If you didn't request this, you can safely ignore this message.</li>
                    </ul>
                  </td></tr>
                </table>
                <p style="margin:0;font-size:14px;color:#4b5563;">If you have any questions, please contact your administrator.</p>
              </td>
            </tr>
          </table>
        </td>
...
func (r *TemplateRenderer) RenderPasswordSetupEmail(
	...
	expirationTime := time.Now().Add(ttl).Format("2006/01/02 15:04")
