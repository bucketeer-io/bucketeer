...
*/}}
{{- define "user-persister.fullname" -}}
...
{{- else -}}
{{ template "user-persister.fullname" . }}-service-cert
{{- end -}}
{{- end -}}
...
{{- else -}}
{{ template "user-persister.fullname" . }}-service-token
{{- end -}}
{{- end -}}