...
const theme = {
  ...
  boxShadow: {
    ...
    left: '-10px 0 15px -10px rgba(0,0,0,0.1),-4px 0 6px -2px rgba(0,0,0,0.05)',
    right: '10px 0 15px -10px rgba(0,0,0,0.1),4px 0 6px -2px rgba(0,0,0,0.05)',
