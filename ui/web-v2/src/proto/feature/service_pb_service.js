...
FeatureService.DebugEvaluateFeatures = {
  methodName: 'DebugEvaluateFeatures',
  service: FeatureService,
  requestStream: false,
  responseStream: false,
  requestType: proto_feature_service_pb.DebugEvaluateFeaturesRequest,
  responseType: proto_feature_service_pb.DebugEvaluateFeaturesResponse
};
...
FeatureServiceClient.prototype.getFeature = function getFeature(
  requestMessage,
  metadata,
  callback
) {
...
FeatureServiceClient.prototype.getFeatures = function getFeatures(
  requestMessage,
  metadata,
  callback
) {
...
FeatureServiceClient.prototype.listFeatures = function listFeatures(
  requestMessage,
  metadata,
  callback
) {
...
FeatureServiceClient.prototype.listEnabledFeatures =
  function listEnabledFeatures(requestMessage, metadata, callback) {
    if (arguments.length === 2) {
      callback = arguments[1];
    }
...
FeatureServiceClient.prototype.createFeature = function createFeature(
  requestMessage,
  metadata,
  callback
) {
...
FeatureServiceClient.prototype.updateFeature = function updateFeature(
  requestMessage,
  metadata,
  callback
) {
...
FeatureServiceClient.prototype.disableFeature = function disableFeature(
  requestMessage,
  metadata,
  callback
) {
...
FeatureServiceClient.prototype.archiveFeature = function archiveFeature(
  requestMessage,
  metadata,
  callback
) {
...
FeatureServiceClient.prototype.unarchiveFeature = function unarchiveFeature(
  requestMessage,
  metadata,
  callback
) {
...
FeatureServiceClient.prototype.deleteFeature = function deleteFeature(
  requestMessage,
  metadata,
  callback
) {
...
FeatureServiceClient.prototype.updateFeatureDetails =
  function updateFeatureDetails(requestMessage, metadata, callback) {
    if (arguments.length === 2) {
      callback = arguments[1];
    }
...
FeatureServiceClient.prototype.updateFeatureVariations =
  function updateFeatureVariations(requestMessage, metadata, callback) {
    if (arguments.length === 2) {
      callback = arguments[1];
    }
...
FeatureServiceClient.prototype.updateFeatureTargeting =
  function updateFeatureTargeting(requestMessage, metadata, callback) {
    if (arguments.length === 2) {
      callback = arguments[1];
    }
...
FeatureServiceClient.prototype.cloneFeature = function cloneFeature(
  requestMessage,
  metadata,
  callback
) {
...
FeatureServiceClient.prototype.createSegment = function createSegment(
  requestMessage,
  metadata,
  callback
) {
...
FeatureServiceClient.prototype.getSegment = function getSegment(
  requestMessage,
  metadata,
  callback
) {
...
FeatureServiceClient.prototype.listSegments = function listSegments(
  requestMessage,
  metadata,
  callback
) {
...
FeatureServiceClient.prototype.deleteSegment = function deleteSegment(
  requestMessage,
  metadata,
  callback
) {
...
FeatureServiceClient.prototype.updateSegment = function updateSegment(
  requestMessage,
  metadata,
  callback
) {
...
FeatureServiceClient.prototype.addSegmentUser = function addSegmentUser(
  requestMessage,
  metadata,
  callback
) {
...
FeatureServiceClient.prototype.deleteSegmentUser = function deleteSegmentUser(
  requestMessage,
  metadata,
  callback
) {
...
FeatureServiceClient.prototype.getSegmentUser = function getSegmentUser(
  requestMessage,
  metadata,
  callback
) {
...
FeatureServiceClient.prototype.listSegmentUsers = function listSegmentUsers(
  requestMessage,
  metadata,
  callback
) {
...
FeatureServiceClient.prototype.bulkUploadSegmentUsers =
  function bulkUploadSegmentUsers(requestMessage, metadata, callback) {
    if (arguments.length === 2) {
      callback = arguments[1];
    }
...
FeatureServiceClient.prototype.bulkDownloadSegmentUsers =
  function bulkDownloadSegmentUsers(requestMessage, metadata, callback) {
    if (arguments.length === 2) {
      callback = arguments[1];
    }
...
FeatureServiceClient.prototype.evaluateFeatures = function evaluateFeatures(
  requestMessage,
  metadata,
  callback
) {
...
FeatureServiceClient.prototype.debugEvaluateFeatures =
  function debugEvaluateFeatures(requestMessage, metadata, callback) {
    if (arguments.length === 2) {
      callback = arguments[1];
    }
    var client = grpc.unary(FeatureService.DebugEvaluateFeatures, {
      request: requestMessage,
      host: this.serviceHost,
      metadata: metadata,
      transport: this.options.transport,
...
FeatureServiceClient.prototype.listTags = function listTags(
  requestMessage,
  metadata,
  callback
) {
...
FeatureServiceClient.prototype.createFlagTrigger = function createFlagTrigger(
  requestMessage,
  metadata,
  callback
) {
...
FeatureServiceClient.prototype.updateFlagTrigger = function updateFlagTrigger(
  requestMessage,
  metadata,
  callback
) {
...
FeatureServiceClient.prototype.enableFlagTrigger = function enableFlagTrigger(
  requestMessage,
  metadata,
  callback
) {
...
FeatureServiceClient.prototype.disableFlagTrigger = function disableFlagTrigger(
  requestMessage,
  metadata,
  callback
) {
...
FeatureServiceClient.prototype.resetFlagTrigger = function resetFlagTrigger(
  requestMessage,
  metadata,
  callback
) {
...
FeatureServiceClient.prototype.deleteFlagTrigger = function deleteFlagTrigger(
  requestMessage,
  metadata,
  callback
) {
...
FeatureServiceClient.prototype.getFlagTrigger = function getFlagTrigger(
  requestMessage,
  metadata,
  callback
) {
...
FeatureServiceClient.prototype.listFlagTriggers = function listFlagTriggers(
  requestMessage,
  metadata,
  callback
) {
