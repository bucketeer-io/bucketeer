...
export class VariationResult extends jspb.Message {
  ...
  getCvrProbBest():
    | proto_eventcounter_distribution_summary_pb.DistributionSummary
    | undefined;
  setCvrProbBest(
    value?: proto_eventcounter_distribution_summary_pb.DistributionSummary
  ): void;

  hasCvrProbBeatBaseline(): boolean;
  clearCvrProbBeatBaseline(): void;
  getCvrProbBeatBaseline():
    | proto_eventcounter_distribution_summary_pb.DistributionSummary
    | undefined;
  setCvrProbBeatBaseline(
    value?: proto_eventcounter_distribution_summary_pb.DistributionSummary
  ): void;
  ...
  getEvaluationUserCountTimeseries():
    | proto_eventcounter_timeseries_pb.Timeseries
    | undefined;
  setEvaluationUserCountTimeseries(
