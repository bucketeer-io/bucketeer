...
var (
	...
	ErrAccountNotFound               = pkgErr.NewErrorNotFound(PackageName, "account not found", "account")
	ErrBadCommand                    = pkgErr.NewErrorInvalidAugment(PackageName, "cannot handle command", pkgErr.InvalidTypeNotMatchFormat, "command")
	ErrAccountAlreadyExists          = pkgErr.NewErrorAlreadyExists(PackageName, "account already exists", "account")
	ErrAccountUnexpectedAffectedRows = pkgErr.NewErrorUnexpectedAffectedRows(PackageName, " unexpected affected rows")
)
