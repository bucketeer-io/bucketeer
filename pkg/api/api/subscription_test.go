...
import (
	...
	"github.com/bucketeer-io/bucketeer/v2/proto/subscription"
)
				...
				gs.subscriptionClient.(*mocksubscriptionclient.MockClient).EXPECT().
					...
					Return(&subscription.GetSubscriptionResponse{
						Subscription: &subscription.Subscription{
							Id: "sub-1",
							SourceTypes: []subscription.Subscription_SourceType{
								subscription.Subscription_DOMAIN_EVENT_ACCOUNT,
								subscription.Subscription_DOMAIN_EVENT_FEATURE,
							},
							Recipient: &subscription.Recipient{
								Type: subscription.Recipient_SlackChannel,
								SlackChannelRecipient: &subscription.SlackChannelRecipient{
									WebhookUrl: "webhook-url",
								},
								Language: subscription.Recipient_ENGLISH,
							},
							Name:            "sub-1",
