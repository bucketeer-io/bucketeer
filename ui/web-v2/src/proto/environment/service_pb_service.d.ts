...
type EnvironmentServiceExchangeDemoToken = {
  readonly methodName: string;
  readonly service: typeof EnvironmentService;
  readonly requestStream: false;
  readonly responseStream: false;
  readonly requestType: typeof proto_environment_service_pb.ExchangeDemoTokenRequest;
...
export class EnvironmentServiceClient {
  ...
  getEnvironmentV2(
    ...
    callback: (
      ...
      responseMessage: proto_environment_service_pb.GetEnvironmentV2Response | null
    ) => void
  ): UnaryResponse;
  getEnvironmentV2(
    requestMessage: proto_environment_service_pb.GetEnvironmentV2Request,
  ...
  listEnvironmentsV2(
    ...
    callback: (
      error: ServiceError | null,
      responseMessage: proto_environment_service_pb.ListEnvironmentsV2Response | null
    ) => void
  ): UnaryResponse;
  listEnvironmentsV2(
    requestMessage: proto_environment_service_pb.ListEnvironmentsV2Request,
  ...
  createEnvironmentV2(
    ...
    callback: (
      error: ServiceError | null,
      responseMessage: proto_environment_service_pb.CreateEnvironmentV2Response | null
    ) => void
  ): UnaryResponse;
  createEnvironmentV2(
    requestMessage: proto_environment_service_pb.CreateEnvironmentV2Request,
  ...
  updateEnvironmentV2(
    ...
    callback: (
      error: ServiceError | null,
      responseMessage: proto_environment_service_pb.UpdateEnvironmentV2Response | null
    ) => void
  ): UnaryResponse;
  updateEnvironmentV2(
    requestMessage: proto_environment_service_pb.UpdateEnvironmentV2Request,
  ...
  archiveEnvironmentV2(
    ...
    callback: (
      error: ServiceError | null,
      responseMessage: proto_environment_service_pb.ArchiveEnvironmentV2Response | null
    ) => void
  ): UnaryResponse;
  archiveEnvironmentV2(
    requestMessage: proto_environment_service_pb.ArchiveEnvironmentV2Request,
  ...
  unarchiveEnvironmentV2(
    ...
    callback: (
      error: ServiceError | null,
      responseMessage: proto_environment_service_pb.UnarchiveEnvironmentV2Response | null
    ) => void
  ): UnaryResponse;
  unarchiveEnvironmentV2(
    requestMessage: proto_environment_service_pb.UnarchiveEnvironmentV2Request,
  ...
  getProject(
    ...
    callback: (
      error: ServiceError | null,
      responseMessage: proto_environment_service_pb.GetProjectResponse | null
    ) => void
  ): UnaryResponse;
  getProject(
    requestMessage: proto_environment_service_pb.GetProjectRequest,
  ...
  listProjects(
    ...
    callback: (
      error: ServiceError | null,
      responseMessage: proto_environment_service_pb.ListProjectsResponse | null
    ) => void
  ): UnaryResponse;
  listProjects(
    requestMessage: proto_environment_service_pb.ListProjectsRequest,
  ...
  createProject(
    ...
    callback: (
      error: ServiceError | null,
      responseMessage: proto_environment_service_pb.CreateProjectResponse | null
    ) => void
  ): UnaryResponse;
  createProject(
    requestMessage: proto_environment_service_pb.CreateProjectRequest,
  ...
  createTrialProject(
    ...
    callback: (
      error: ServiceError | null,
      responseMessage: proto_environment_service_pb.CreateTrialProjectResponse | null
    ) => void
  ): UnaryResponse;
  createTrialProject(
    requestMessage: proto_environment_service_pb.CreateTrialProjectRequest,
  ...
  updateProject(
    ...
    callback: (
      error: ServiceError | null,
      responseMessage: proto_environment_service_pb.UpdateProjectResponse | null
    ) => void
  ): UnaryResponse;
  updateProject(
    requestMessage: proto_environment_service_pb.UpdateProjectRequest,
  ...
  enableProject(
    ...
    callback: (
      error: ServiceError | null,
      responseMessage: proto_environment_service_pb.EnableProjectResponse | null
    ) => void
  ): UnaryResponse;
  enableProject(
    requestMessage: proto_environment_service_pb.EnableProjectRequest,
  ...
  disableProject(
    ...
    callback: (
      error: ServiceError | null,
      responseMessage: proto_environment_service_pb.DisableProjectResponse | null
    ) => void
  ): UnaryResponse;
  disableProject(
    requestMessage: proto_environment_service_pb.DisableProjectRequest,
  ...
  convertTrialProject(
    ...
    callback: (
      error: ServiceError | null,
      responseMessage: proto_environment_service_pb.ConvertTrialProjectResponse | null
    ) => void
  ): UnaryResponse;
  convertTrialProject(
    requestMessage: proto_environment_service_pb.ConvertTrialProjectRequest,
  ...
  getOrganization(
    ...
    callback: (
      error: ServiceError | null,
      responseMessage: proto_environment_service_pb.GetOrganizationResponse | null
    ) => void
  ): UnaryResponse;
  getOrganization(
    requestMessage: proto_environment_service_pb.GetOrganizationRequest,
  ...
  listOrganizations(
    ...
    callback: (
      error: ServiceError | null,
      responseMessage: proto_environment_service_pb.ListOrganizationsResponse | null
    ) => void
  ): UnaryResponse;
  listOrganizations(
    requestMessage: proto_environment_service_pb.ListOrganizationsRequest,
  ...
  createOrganization(
    ...
    callback: (
      error: ServiceError | null,
      responseMessage: proto_environment_service_pb.CreateOrganizationResponse | null
    ) => void
  ): UnaryResponse;
  createOrganization(
    requestMessage: proto_environment_service_pb.CreateOrganizationRequest,
  ...
  updateOrganization(
    ...
    callback: (
      error: ServiceError | null,
      responseMessage: proto_environment_service_pb.UpdateOrganizationResponse | null
    ) => void
  ): UnaryResponse;
  updateOrganization(
    requestMessage: proto_environment_service_pb.UpdateOrganizationRequest,
  ...
  enableOrganization(
    ...
    callback: (
      error: ServiceError | null,
      responseMessage: proto_environment_service_pb.EnableOrganizationResponse | null
    ) => void
  ): UnaryResponse;
  enableOrganization(
    requestMessage: proto_environment_service_pb.EnableOrganizationRequest,
  ...
  disableOrganization(
    ...
    callback: (
      error: ServiceError | null,
      responseMessage: proto_environment_service_pb.DisableOrganizationResponse | null
    ) => void
  ): UnaryResponse;
  disableOrganization(
    requestMessage: proto_environment_service_pb.DisableOrganizationRequest,
  ...
  archiveOrganization(
    ...
    callback: (
      error: ServiceError | null,
      responseMessage: proto_environment_service_pb.ArchiveOrganizationResponse | null
    ) => void
  ): UnaryResponse;
  archiveOrganization(
    requestMessage: proto_environment_service_pb.ArchiveOrganizationRequest,
  ...
  unarchiveOrganization(
    ...
    callback: (
      error: ServiceError | null,
      responseMessage: proto_environment_service_pb.UnarchiveOrganizationResponse | null
    ) => void
  ): UnaryResponse;
  unarchiveOrganization(
    requestMessage: proto_environment_service_pb.UnarchiveOrganizationRequest,
  ...
  exchangeDemoToken(
    requestMessage: proto_environment_service_pb.ExchangeDemoTokenRequest,
    metadata: grpc.Metadata,
    callback: (
      error: ServiceError | null,
