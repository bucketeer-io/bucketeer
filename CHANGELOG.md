...
## [2.4.0](https://github.com/bucketeer-io/bucketeer/compare/v2.3.0...v2.4.0) (2026-09-18)
...
* **auditlog:** organization audit logs for organization admins ([#2817](https://github.com/bucketeer-io/bucketeer/issues/2817)) ([900853e](https://github.com/bucketeer-io/bucketeer/commit/900853e2cb1fbdfa026974d89fc3cbdcb21789d0))
...
* **migration:** merge the admin audit log history into audit_log ([#2818](https://github.com/bucketeer-io/bucketeer/issues/2818)) ([c94b6a5](https://github.com/bucketeer-io/bucketeer/commit/c94b6a5daf91d663de015f311282ba3eb8834f49))
* **migration:** resolve admin_audit_log organizations in a working table ([#2811](https://github.com/bucketeer-io/bucketeer/issues/2811)) ([c702fd0](https://github.com/bucketeer-io/bucketeer/commit/c702fd0634f2744ed2ec87ae96d20e0e4b30798b))
...
* **api:** re-evaluate rule-based flags on SSE reconnect ([#2816](https://github.com/bucketeer-io/bucketeer/issues/2816)) ([85b7811](https://github.com/bucketeer-io/bucketeer/commit/85b78114419bbfb6cb97eab0be7f935cfa4c6e8c))
...
* send specific messageKey for FailedPrecondition errors to frontend ([#2780](https://github.com/bucketeer-io/bucketeer/issues/2780)) ([c977377](https://github.com/bucketeer-io/bucketeer/commit/c977377f41816d216334e644a51749369f84e2af))
* **ui/dashboard:** show discard confirmation when removing user segment values ([#2810](https://github.com/bucketeer-io/bucketeer/issues/2810)) ([a211127](https://github.com/bucketeer-io/bucketeer/commit/a211127ac296e366c894323daa7dcbcfc79d41dc))
...
* **deps:** bump @humanfs/node from 0.16.7 to 0.16.8 in /ui/dashboard ([#2807](https://github.com/bucketeer-io/bucketeer/issues/2807)) ([5633816](https://github.com/bucketeer-io/bucketeer/commit/5633816745ca6b8016fc2ce73fa99b62a9395d11))
* **deps:** bump @humanfs/node in /evaluation/typescript ([#2806](https://github.com/bucketeer-io/bucketeer/issues/2806)) ([334d9fb](https://github.com/bucketeer-io/bucketeer/commit/334d9fb31fe0ba8db46ef7a7b22cdb2d64c13d18))
* **deps:** bump browserslist in /evaluation/typescript ([#2804](https://github.com/bucketeer-io/bucketeer/issues/2804)) ([7a532cd](https://github.com/bucketeer-io/bucketeer/commit/7a532cde52926e89e57c950ae4718c0af01dfd52))
* **deps:** bump js-yaml from 4.3.1 to 4.3.2 in /evaluation/typescript ([#2815](https://github.com/bucketeer-io/bucketeer/issues/2815)) ([1b60aca](https://github.com/bucketeer-io/bucketeer/commit/1b60aca4b036e432eb8baee3022285fef9ce2a40))
* **deps:** bump postcss-selector-parser in /ui/dashboard ([#2799](https://github.com/bucketeer-io/bucketeer/issues/2799)) ([e3eab9f](https://github.com/bucketeer-io/bucketeer/commit/e3eab9f9aaa96c86100f30653faf3983a2218e16))
...
* **deps:** bump the dependencies group in /ui/dashboard with 20 updates ([#2797](https://github.com/bucketeer-io/bucketeer/issues/2797)) ([934c976](https://github.com/bucketeer-io/bucketeer/commit/934c976da19e43e7b0603e57088c360b10e88158))
...
* add ai recommend chat ([#2441](https://github.com/bucketeer-io/bucketeer/issues/2441)) ([12ce9f5](https://github.com/bucketeer-io/bucketeer/commit/12ce9f557d61874feafb91904ab4e49b2ca3b606))
* add domain event-driven redis cache eviction via subscriber service ([#2542](https://github.com/bucketeer-io/bucketeer/issues/2542)) ([887d055](https://github.com/bucketeer-io/bucketeer/commit/887d055f7e3649bf3990293241e873168cfefebe))
* add multi-layer caching with domain event invalidation for feature flags and segment users ([#2529](https://github.com/bucketeer-io/bucketeer/issues/2529)) ([cd3ec5a](https://github.com/bucketeer-io/bucketeer/commit/cd3ec5a03d0313dc7d2a108a29a6c46dc5f12dff))
* add search filter for auto operations ([#2507](https://github.com/bucketeer-io/bucketeer/issues/2507)) ([0d0ec08](https://github.com/bucketeer-io/bucketeer/commit/0d0ec08a4968737221831a6fbf253dd71d76c99f))
* add variation value schema persistence ([#2578](https://github.com/bucketeer-io/bucketeer/issues/2578)) ([3fc0c55](https://github.com/bucketeer-io/bucketeer/commit/3fc0c55c81eccae701ba772a53d1d4d285306cad))
* add workflow to trigger ai-docs-update on issue close ([#2472](https://github.com/bucketeer-io/bucketeer/issues/2472)) ([7567fba](https://github.com/bucketeer-io/bucketeer/commit/7567fba7a32da194c5ece0bf45b945ebccc70cbb))
* bulk flag duplication across envs ([#2527](https://github.com/bucketeer-io/bucketeer/issues/2527)) ([d68ac60](https://github.com/bucketeer-io/bucketeer/commit/d68ac60791f480f4fa736da9ed9066e5c50d6380))
* **calculator:** add sample ratio mismatch (srm) detection ([#2655](https://github.com/bucketeer-io/bucketeer/issues/2655)) ([5060547](https://github.com/bucketeer-io/bucketeer/commit/5060547120e7b8fc5d49ec9a8e2c2fdcc2ae2766))
* **calculator:** add sequential bayes factor stopping rule for always-valid inference ([#2664](https://github.com/bucketeer-io/bucketeer/issues/2664)) ([aedaadc](https://github.com/bucketeer-io/bucketeer/commit/aedaadcfef03710ad7a241819733cf268d34abdd))
* **calculator:** winsorize per-user goal values at p99 before dwh aggregation ([#2661](https://github.com/bucketeer-io/bucketeer/issues/2661)) ([98e8c22](https://github.com/bucketeer-io/bucketeer/commit/98e8c2226e517cad5fe23bd36dea796949895604))
* implement onboard walkthrough for new user ([#2712](https://github.com/bucketeer-io/bucketeer/issues/2712)) ([5b475f6](https://github.com/bucketeer-io/bucketeer/commit/5b475f696ed4884169d1f99175829441e6edb8ad))
* implement postgres for account svc ([#2593](https://github.com/bucketeer-io/bucketeer/issues/2593)) ([dabe25c](https://github.com/bucketeer-io/bucketeer/commit/dabe25c7bf85097ae167ee8d431704e7ad8a154c))
* implement postgres for audit log service ([#2589](https://github.com/bucketeer-io/bucketeer/issues/2589)) ([064b3c2](https://github.com/bucketeer-io/bucketeer/commit/064b3c2f986a56af0e01ea62e8f48855588f7f58))
* implement postgres for autoops service ([#2625](https://github.com/bucketeer-io/bucketeer/issues/2625)) ([9ffcf3d](https://github.com/bucketeer-io/bucketeer/commit/9ffcf3d96243e43e6bba61ab0951bd13e89a6258))
* implement postgres for coderef service ([#2606](https://github.com/bucketeer-io/bucketeer/issues/2606)) ([4236565](https://github.com/bucketeer-io/bucketeer/commit/4236565a5a5f0541d47aafc89970a9f869ddb457))
* implement postgres for environment svc ([#2595](https://github.com/bucketeer-io/bucketeer/issues/2595)) ([1a44fd6](https://github.com/bucketeer-io/bucketeer/commit/1a44fd64e86e149d3622c87ecf05a8f757d52fe8))
* implement postgres for eventcounter svc ([#2627](https://github.com/bucketeer-io/bucketeer/issues/2627)) ([e2e043a](https://github.com/bucketeer-io/bucketeer/commit/e2e043a1db3aa522259d8632f2c8dfea9f95607a))
* implement postgres for experiment svc ([#2633](https://github.com/bucketeer-io/bucketeer/issues/2633)) ([6c010c6](https://github.com/bucketeer-io/bucketeer/commit/6c010c63c7eb959af5ddfadeb078f74d02a3fd8f))
* implement postgres for feature last used info svc ([#2587](https://github.com/bucketeer-io/bucketeer/issues/2587)) ([aa8a8a5](https://github.com/bucketeer-io/bucketeer/commit/aa8a8a5ce3817da6dbfbca6222e9eeaccf18ef37))
* implement postgres for feature service ([#2575](https://github.com/bucketeer-io/bucketeer/issues/2575)) ([2dd2ade](https://github.com/bucketeer-io/bucketeer/commit/2dd2adedc7635c9feb7a241a5eab19bb39ccc0cc))
* implement postgres for flag trigger svc ([#2584](https://github.com/bucketeer-io/bucketeer/issues/2584)) ([c23fcac](https://github.com/bucketeer-io/bucketeer/commit/c23fcacf063ecc5a9afb48e1167736dd6e94191b))
* implement postgres for insight svc ([#2635](https://github.com/bucketeer-io/bucketeer/issues/2635)) ([a6d9a45](https://github.com/bucketeer-io/bucketeer/commit/a6d9a456ee1bea63361200b689059efbf55006fa))
* implement postgres for notification svc ([#2636](https://github.com/bucketeer-io/bucketeer/issues/2636)) ([6b0bbf0](https://github.com/bucketeer-io/bucketeer/commit/6b0bbf085be536056130088def837eecc9b5a6fd))
* implement postgres for ops event ([#2608](https://github.com/bucketeer-io/bucketeer/issues/2608)) ([9282cec](https://github.com/bucketeer-io/bucketeer/commit/9282cec9e37ec95c0aa939436154a604bce69c1e))
* implement postgres for scheduled feature change svc ([#2642](https://github.com/bucketeer-io/bucketeer/issues/2642)) ([8f5e017](https://github.com/bucketeer-io/bucketeer/commit/8f5e017dd1b8762d93e6206b7adaa2f36d2e4c8a))
* implement postgres for segment APIs ([#2576](https://github.com/bucketeer-io/bucketeer/issues/2576)) ([901ae41](https://github.com/bucketeer-io/bucketeer/commit/901ae41d41f6d6a1aef360ce9a7da96e573a444e))
* implement postgres for subscribers and refactor dwh layer ([#2650](https://github.com/bucketeer-io/bucketeer/issues/2650)) ([6f54019](https://github.com/bucketeer-io/bucketeer/commit/6f540196d7f82ba603e657b89d22ba8843654d96))
...
* **insights:** add 2 and update 1 Prometheus metrics ([#2389](https://github.com/bucketeer-io/bucketeer/issues/2389)) ([512491b](https://github.com/bucketeer-io/bucketeer/commit/512491be5b48015ca8bdfd34112b821599cd78f4))
* **insights:** add a daily batch of MAU ([#2443](https://github.com/bucketeer-io/bucketeer/issues/2443)) ([96b1145](https://github.com/bucketeer-io/bucketeer/commit/96b1145624d6121ac0715b6ee2f1e09db32dbe15))
* **insights:** add Prometheus request count to monthly summary batch ([#2444](https://github.com/bucketeer-io/bucketeer/issues/2444)) ([79e9e27](https://github.com/bucketeer-io/bucketeer/commit/79e9e27629e566d22a5a8a9520647cf6f049dfae))
* **insights:** add SQL of creating monthly_summary ([#2392](https://github.com/bucketeer-io/bucketeer/issues/2392)) ([1173b25](https://github.com/bucketeer-io/bucketeer/commit/1173b25b98cf9fc431f9daacacef0e4f1880d6d2))
* **insights:** count DAU in APIs ([#2391](https://github.com/bucketeer-io/bucketeer/issues/2391)) ([41bba3d](https://github.com/bucketeer-io/bucketeer/commit/41bba3d55d2a8d0e74b5df53ce8edf3754b28609))
* **insights:** count DAU in evaluation_count_event_persister ([#2437](https://github.com/bucketeer-io/bucketeer/issues/2437)) ([7007184](https://github.com/bucketeer-io/bucketeer/commit/7007184f35b99d6aa441d9d849aceb70fe0d792d))
* **insights:** defined the proto  ([#2390](https://github.com/bucketeer-io/bucketeer/issues/2390)) ([82f2bec](https://github.com/bucketeer-io/bucketeer/commit/82f2bec8417c36d8b8e7c1c4d45752b6bb5d3482))
* **insights:** impl 5 APIs ([#2448](https://github.com/bucketeer-io/bucketeer/issues/2448)) ([0b834a3](https://github.com/bucketeer-io/bucketeer/commit/0b834a351b6555b45a3c07a3e84cc6de5663fe91))
* map synonym to improve correction ([#2598](https://github.com/bucketeer-io/bucketeer/issues/2598)) ([3a9ddea](https://github.com/bucketeer-io/bucketeer/commit/3a9ddea0bfb57ab8541f3897a0ec5be63cad6f96))
* **notification:** add notification center proto contract and service skeleton ([#2690](https://github.com/bucketeer-io/bucketeer/issues/2690)) ([8d5009f](https://github.com/bucketeer-io/bucketeer/commit/8d5009f483e0dc5d3070601850e69ee92f43718a))
* **notification:** add notification center table migrations ([#2697](https://github.com/bucketeer-io/bucketeer/issues/2697)) ([d938a4f](https://github.com/bucketeer-io/bucketeer/commit/d938a4fb1710139f91ff2bec090c96abb59f6513))
* **notification:** implement CreateNotification API ([#2708](https://github.com/bucketeer-io/bucketeer/issues/2708)) ([b2d62d1](https://github.com/bucketeer-io/bucketeer/commit/b2d62d164b1ddeaf97ddf632785378b34306710f))
* **notification:** implement DeleteAdminNotification API ([#2731](https://github.com/bucketeer-io/bucketeer/issues/2731)) ([d996382](https://github.com/bucketeer-io/bucketeer/commit/d9963821376dc4f8a8f396ed6ed884162754c6d9))
* **notification:** implement ListDraftAdminNotifications API ([#2710](https://github.com/bucketeer-io/bucketeer/issues/2710)) ([e4f88c1](https://github.com/bucketeer-io/bucketeer/commit/e4f88c16dd9b9a69b8e2968895047bbdee5fa08e))
* **notification:** implement PublishAdminNotification API ([#2733](https://github.com/bucketeer-io/bucketeer/issues/2733)) ([23b90bb](https://github.com/bucketeer-io/bucketeer/commit/23b90bb23a0bac20512d22b129d9a0a61bc5eb4d))
* obfuscate API key in the UI console ([#2463](https://github.com/bucketeer-io/bucketeer/issues/2463)) ([726f105](https://github.com/bucketeer-io/bucketeer/commit/726f10595589ca893fad475d9508adc013f8f678))
* postgres implementation for team ([#2637](https://github.com/bucketeer-io/bucketeer/issues/2637)) ([60923b6](https://github.com/bucketeer-io/bucketeer/commit/60923b64e583512e4396506400ed838910dbe924))
* **realtime-sync:** add SSE stream evaluations messages ([#2592](https://github.com/bucketeer-io/bucketeer/issues/2592)) ([4d9350f](https://github.com/bucketeer-io/bucketeer/commit/4d9350f1987a513cff6c0a134a1f914a68b757c7))
...
* show relative lift and make the confidence banner metric-aware ([#2658](https://github.com/bucketeer-io/bucketeer/issues/2658)) ([029e842](https://github.com/bucketeer-io/bucketeer/commit/029e842162896d6ccb54be7111b5d0bdf912dced))
* split has_auto_ops filter into active and finished ([#2616](https://github.com/bucketeer-io/bucketeer/issues/2616)) ([df2926b](https://github.com/bucketeer-io/bucketeer/commit/df2926b3af6c30c072d842fb97495fe4920c4520))
* **sse:** implemented the evaluation logic and add 7 metrics ([#2665](https://github.com/bucketeer-io/bucketeer/issues/2665)) ([f1bc1f0](https://github.com/bucketeer-io/bucketeer/commit/f1bc1f020a8517d68b2567606b134852c3cec14f))
* **sse:** prepare the fan-out dispatcher ([#2630](https://github.com/bucketeer-io/bucketeer/issues/2630)) ([74b9f52](https://github.com/bucketeer-io/bucketeer/commit/74b9f52d01a6739a20c1d8e56143f1f96acf55e7))
* **stream:** add Envoy circuit breaker and connection budget for SSE ([#2698](https://github.com/bucketeer-io/bucketeer/issues/2698)) ([b9b0e4f](https://github.com/bucketeer-io/bucketeer/commit/b9b0e4f0bf2c2514641e307760d827c809bf462a))
* **stream:** add graceful shutdown for SSE connections ([#2675](https://github.com/bucketeer-io/bucketeer/issues/2675)) ([eeed7f2](https://github.com/bucketeer-io/bucketeer/commit/eeed7f285afaab472ff36f7647eebaf41f4b9773))
* **stream:** add per-pod SSE connection limit ([#2676](https://github.com/bucketeer-io/bucketeer/issues/2676)) ([20c6ad2](https://github.com/bucketeer-io/bucketeer/commit/20c6ad2888d21d209278f506e3cf2a952bf68068))
* **stream:** add SSE connection-based HPA for api gateway ([#2699](https://github.com/bucketeer-io/bucketeer/issues/2699)) ([ac86505](https://github.com/bucketeer-io/bucketeer/commit/ac865055c29b95a8fb03ff986938beafe1a1a8f2))
* **stream:** add SSE-dedicated service and timeout config for streaming ([#2688](https://github.com/bucketeer-io/bucketeer/issues/2688)) ([72ded5e](https://github.com/bucketeer-io/bucketeer/commit/72ded5e359dd9616061be9b877e18cb5ea377164))
* **stream:** propagate prerequisite-dependent tags in SSE dispatch ([#2679](https://github.com/bucketeer-io/bucketeer/issues/2679)) ([5cae4cc](https://github.com/bucketeer-io/bucketeer/commit/5cae4cce064617dab78ccf711729a0d90876eea0))
* support for 3 or more variation when using progressive rollout ([#2199](https://github.com/bucketeer-io/bucketeer/issues/2199)) ([2a54dc3](https://github.com/bucketeer-io/bucketeer/commit/2a54dc359f82a11cc3820969890249f6f11960d9))
* support rule-based user segments ([#2723](https://github.com/bucketeer-io/bucketeer/issues/2723)) ([28f1eb0](https://github.com/bucketeer-io/bucketeer/commit/28f1eb01bd309c7b601f29aa4615cd15b92667e6))
* support rules reorder ([#2517](https://github.com/bucketeer-io/bucketeer/issues/2517)) ([21a0284](https://github.com/bucketeer-io/bucketeer/commit/21a028486f4fa1541ea0320a51ffd062f47d1e99))
* system admin account have read only permission ([#2550](https://github.com/bucketeer-io/bucketeer/issues/2550)) ([bbd5354](https://github.com/bucketeer-io/bucketeer/commit/bbd5354cd124cb9fc28855988be22fcafed0c226))
...
* **ui/dashboard:** add comprehensive change summary to confirmation dialog ([#2147](https://github.com/bucketeer-io/bucketeer/issues/2147)) ([e165394](https://github.com/bucketeer-io/bucketeer/commit/e165394b2fc85f56bcd3c32c19282ce01706be25))
* **ui/dashboard:** implement ui insight dashboard page ([#2450](https://github.com/bucketeer-io/bucketeer/issues/2450)) ([3cf7a6f](https://github.com/bucketeer-io/bucketeer/commit/3cf7a6f0380ae57d2ad782333f985adae7c24c62))
* **ui/dashboard:** improve the URL to enable to copy ([#2522](https://github.com/bucketeer-io/bucketeer/issues/2522)) ([967ed51](https://github.com/bucketeer-io/bucketeer/commit/967ed51f9dcebfc73cc564b1aa48365445aa362b))
...
* **ui:** add drag-and-drop reordering for segment rules ([#2581](https://github.com/bucketeer-io/bucketeer/issues/2581)) ([0fd8357](https://github.com/bucketeer-io/bucketeer/commit/0fd835779cb21718b2b9b836baca63b0a22c8e22))
* **ui:** add recurring setting to schedule auto operation  ([#2494](https://github.com/bucketeer-io/bucketeer/issues/2494)) ([176734c](https://github.com/bucketeer-io/bucketeer/commit/176734c0e289e75f49cb57fa8d26f97e12d7438a))
* **ui:** add reorder discard change ([#2537](https://github.com/bucketeer-io/bucketeer/issues/2537)) ([b521792](https://github.com/bucketeer-io/bucketeer/commit/b521792b7bf87e26c108fad9f3a90eb82181b1f8))
* **ui:** designate primary goal and drive experiment verdict from it ([#2668](https://github.com/bucketeer-io/bucketeer/issues/2668)) ([1a0e597](https://github.com/bucketeer-io/bucketeer/commit/1a0e5972278e14a5f7f611a0a49aedb97eed64f5))
* **ui:** implement infinite loading for feature flags dropdown ([#2362](https://github.com/bucketeer-io/bucketeer/issues/2362)) ([0dca8d7](https://github.com/bucketeer-io/bucketeer/commit/0dca8d78de138088a99f96831c906ace831363a5))
* **ui:** implement sequential bayes factor confidence banner ([#2666](https://github.com/bucketeer-io/bucketeer/issues/2666)) ([235c931](https://github.com/bucketeer-io/bucketeer/commit/235c931219a19a706df89cd31f05b2427e31cbd3))
* **ui:** infinite loading for the organization settings ([#2541](https://github.com/bucketeer-io/bucketeer/issues/2541)) ([e7feab9](https://github.com/bucketeer-io/bucketeer/commit/e7feab9d2c2fdad3388819c6604c13ec3227eee9))
* **ui:** surface sample ratio mismatch (srm) check on the experiment results page ([#2656](https://github.com/bucketeer-io/bucketeer/issues/2656)) ([f6918ed](https://github.com/bucketeer-io/bucketeer/commit/f6918ed270784af23067944e68a1ff9e7eab7b82))


### Bug Fixes

* add grace window to feature flag diff filter to prevent partial-diff trap ([#2621](https://github.com/bucketeer-io/bucketeer/issues/2621)) ([d4adf72](https://github.com/bucketeer-io/bucketeer/commit/d4adf72d81c8f994faa6c91821d89f3014f809c8))
...
* add subscription cleanup on shutdown and expiration policy for cache invalidator ([#2532](https://github.com/bucketeer-io/bucketeer/issues/2532)) ([43358d6](https://github.com/bucketeer-io/bucketeer/commit/43358d64b2d7269fcb860740719e691c48b0f802))
* allow service tokens to bypass system admin read-only restriction ([#2610](https://github.com/bucketeer-io/bucketeer/issues/2610)) ([b08d1ee](https://github.com/bucketeer-io/bucketeer/commit/b08d1eeb4fd2025d8b0c44bd7e028bdfd4553503))
* **calculator:** correct normal-inverse-gamma posterior update for value metrics ([#2639](https://github.com/bucketeer-io/bucketeer/issues/2639)) ([2c5e15f](https://github.com/bucketeer-io/bucketeer/commit/2c5e15f96041ebf79da029e6c77ae12cb137ee53))
* **calculator:** derive normal-inverse-gamma priors from observed data (empirical bayes) ([#2651](https://github.com/bucketeer-io/bucketeer/issues/2651)) ([86efabd](https://github.com/bucketeer-io/bucketeer/commit/86efabdca5706dd3e05fd6b2116fc3203171cae1))
* copy srm result from json blob in operational-db read storage ([#2657](https://github.com/bucketeer-io/bucketeer/issues/2657)) ([425be4b](https://github.com/bucketeer-io/bucketeer/commit/425be4b80726ce9215e772eee2899d4e582b281d))
...
* **devcontainer:** deadlock error when using bigquery emulator ([#2505](https://github.com/bucketeer-io/bucketeer/issues/2505)) ([1217e8a](https://github.com/bucketeer-io/bucketeer/commit/1217e8a8f9afa3ed9f4e1dbe3bc053e6c725c47c))
...
* **e2e:** remove GET method test case from stream request errors ([#2696](https://github.com/bucketeer-io/bucketeer/issues/2696)) ([365e1ec](https://github.com/bucketeer-io/bucketeer/commit/365e1ec9da89f0eb02ecaec4441326233994ed0b))
* **eventcounter:** deduplicate events by ID in BigQuery count queries ([#2738](https://github.com/bucketeer-io/bucketeer/issues/2738)) ([479cd30](https://github.com/bucketeer-io/bucketeer/commit/479cd30b46c0d3bf0b2d3f1af52a05d9921cd810))
* **feature:** persist failed status when scheduled flag change execution fails ([#2709](https://github.com/bucketeer-io/bucketeer/issues/2709)) ([c6e3d7b](https://github.com/bucketeer-io/bucketeer/commit/c6e3d7b36b8b2d9c173c0752d9dd71d3a31cbd1d))
* force full payload when GetFeatureFlags diff filter would be empty ([#2612](https://github.com/bucketeer-io/bucketeer/issues/2612)) ([01b08a6](https://github.com/bucketeer-io/bucketeer/commit/01b08a61b783941df44daf011a07ba49a8497546))
* include UNKNOWN sdk ([#2585](https://github.com/bucketeer-io/bucketeer/issues/2585)) ([3770e0a](https://github.com/bucketeer-io/bucketeer/commit/3770e0a6de3a9f5dfccf89e57075f9d099fe9ff8))
* **insights:** use longer `writeTimeout` for batches ([#2489](https://github.com/bucketeer-io/bucketeer/issues/2489)) ([de3d407](https://github.com/bucketeer-io/bucketeer/commit/de3d407b2000744c29d13a2468c8b76175bc665f))
* **insights:** set longer `writeTimeout` in batch gateway ([#2492](https://github.com/bucketeer-io/bucketeer/issues/2492)) ([b95697b](https://github.com/bucketeer-io/bucketeer/commit/b95697b3c36fcd49ec7eb4f3f6b9ebbeff25daf6))
* **insights:** use recordingRule in batch ([#2484](https://github.com/bucketeer-io/bucketeer/issues/2484)) ([7561930](https://github.com/bucketeer-io/bucketeer/commit/756193048c2a73e74f415022ccda62f2fd109bf1))
* make redis non-blocking for graceful degradation ([#2440](https://github.com/bucketeer-io/bucketeer/issues/2440)) ([1499d50](https://github.com/bucketeer-io/bucketeer/commit/1499d5019fafab120caf61b93d5b9f56cca43e1c))
* persist create-time schedule conflicts and add granular rule clause summaries ([#2420](https://github.com/bucketeer-io/bucketeer/issues/2420)) ([ac87b11](https://github.com/bucketeer-io/bucketeer/commit/ac87b11bb1a3b22a56e3f578a72bcae7fa3ac2cc))
...
* postgres can't resolve output column aliases in list features ([#2588](https://github.com/bucketeer-io/bucketeer/issues/2588)) ([adb1995](https://github.com/bucketeer-io/bucketeer/commit/adb1995891354240abbf9462e44b6cb146cacd46))
* prevent cache-miss thundering-herd cancellation in gateway service ([#2551](https://github.com/bucketeer-io/bucketeer/issues/2551)) ([2c64b50](https://github.com/bucketeer-io/bucketeer/commit/2c64b50181ee70e56d55e67b377db3389d1b5e5e))
* prevent sdk cache staleness caused by requestedAt advancement in none responses ([#2462](https://github.com/bucketeer-io/bucketeer/issues/2462)) ([a27b058](https://github.com/bucketeer-io/bucketeer/commit/a27b058a280484af9b80b80db4793de05d2f9be9))
...
* publish segment domain events after commit to prevent stale cache refresh ([#2740](https://github.com/bucketeer-io/bucketeer/issues/2740)) ([945f0ed](https://github.com/bucketeer-io/bucketeer/commit/945f0eded1c7a173e0b4925f6f42735ea485d295))
* remove sourceIds of req=0 for 12Months ([#2535](https://github.com/bucketeer-io/bucketeer/issues/2535)) ([f57a398](https://github.com/bucketeer-io/bucketeer/commit/f57a398b02bcaed7781ddb077a66ac7668e51187))
...
* **rest:** skip logging for HTTP redirect responses ([#2663](https://github.com/bucketeer-io/bucketeer/issues/2663)) ([728e319](https://github.com/bucketeer-io/bucketeer/commit/728e31985a81ab4579a1425d24f533b7df64f958))
...
* set longer writeTimeout for longer batches ([59318b4](https://github.com/bucketeer-io/bucketeer/commit/59318b4841eeb00dbcfb1aba3fd10010c847cc3e))
* **stream:** prevent buffer overflow in SSE streaming middleware ([#2684](https://github.com/bucketeer-io/bucketeer/issues/2684)) ([0faf970](https://github.com/bucketeer-io/bucketeer/commit/0faf970f54dc1bf11000cc1ba7af897f71fbd6d8))
* **stream:** set SSE circuit breaker maxPendingRequests to 100 ([#2730](https://github.com/bucketeer-io/bucketeer/issues/2730)) ([0cdd20e](https://github.com/bucketeer-io/bucketeer/commit/0cdd20eb8d93d9a7c02f36db2a9eaf51ed736eda))
* subscriber preserve "id" attribute on reclaimed redis stream messages ([#2618](https://github.com/bucketeer-io/bucketeer/issues/2618)) ([04aac8f](https://github.com/bucketeer-io/bucketeer/commit/04aac8f8c5c371e2f69941e03dfeaa4cb686182e))
* **subscriber:** discard goal events older than the user's latest evaluation ([#2734](https://github.com/bucketeer-io/bucketeer/issues/2734)) ([6afb699](https://github.com/bucketeer-io/bucketeer/commit/6afb69974a8ef1e93d8dd1fb29bdc2c410c3bed6))
* **subscriber:** retain in-memory buffers when periodic writes fail ([#2736](https://github.com/bucketeer-io/bucketeer/issues/2736)) ([054d068](https://github.com/bucketeer-io/bucketeer/commit/054d068ab291bbd6df022c340ddf4cacd02cd93e))
* system admin can't see other envs if it's a member ([#2601](https://github.com/bucketeer-io/bucketeer/issues/2601)) ([10496ef](https://github.com/bucketeer-io/bucketeer/commit/10496efd285420aedc070e84e181f334777ed90c))
* tighten pdb selectors to exclude job-owned pods ([#2599](https://github.com/bucketeer-io/bucketeer/issues/2599)) ([a7eedbb](https://github.com/bucketeer-io/bucketeer/commit/a7eedbb16f3364343c650330fb5afccc98be4f70))
* treat pub/sub not found error as ok when deleting cache invalidator subscription ([#2549](https://github.com/bucketeer-io/bucketeer/issues/2549)) ([4e374d5](https://github.com/bucketeer-io/bucketeer/commit/4e374d5ceef71955491361e9a724db81db6f77ac))
...
* **ui/dashboard:** unsaved leave page switch organization and environment ([#2447](https://github.com/bucketeer-io/bucketeer/issues/2447)) ([7d4b391](https://github.com/bucketeer-io/bucketeer/commit/7d4b39132ac3e75cb28623f80e6c1b19fae2b27e))
* **ui/insights:** formatLatency ms ([#2523](https://github.com/bucketeer-io/bucketeer/issues/2523)) ([cf8e348](https://github.com/bucketeer-io/bucketeer/commit/cf8e348a663ccfb8a7c73e85a7f2c3104bb688ce))
* **ui/insights:** reset SDK filter when switching environments ([#2536](https://github.com/bucketeer-io/bucketeer/issues/2536)) ([ae3ed7f](https://github.com/bucketeer-io/bucketeer/commit/ae3ed7f9624f23d23c1c6153a8e22224f5641aee))
* **ui:** auto-generation id stops working after 2 characters ([#2622](https://github.com/bucketeer-io/bucketeer/issues/2622)) ([5fbd407](https://github.com/bucketeer-io/bucketeer/commit/5fbd4071b411735495177ebee92acec744c5281a))
* **ui:** auto-invalidate react query cache on mutations to prevent stale data ([#2624](https://github.com/bucketeer-io/bucketeer/issues/2624)) ([fe7f8a1](https://github.com/bucketeer-io/bucketeer/commit/fe7f8a186c5d5f0f747256a7a628827fa893ca21))
* **ui:** coerce boolean URL params to prevent silent filter inversion ([#2531](https://github.com/bucketeer-io/bucketeer/issues/2531)) ([24874ae](https://github.com/bucketeer-io/bucketeer/commit/24874aeb5b999fad24723c23a317bbc411bf0fc8))
* **ui:** copy button stays disabled after discarding the changes ([#2594](https://github.com/bucketeer-io/bucketeer/issues/2594)) ([f93cc23](https://github.com/bucketeer-io/bucketeer/commit/f93cc2336805ef45faa00ed9fd137190479146af))
* **ui:** correct split-equally weights and show variation allocation bar ([#2643](https://github.com/bucketeer-io/bucketeer/issues/2643)) ([9b7d73b](https://github.com/bucketeer-io/bucketeer/commit/9b7d73b08e6c0e77e4122bdc2a13165b31febb68))
* **ui:** fix stale featureRef, uuid mismatch, and rollout weight unit in segment rule targeting ([#2582](https://github.com/bucketeer-io/bucketeer/issues/2582)) ([9c0a88c](https://github.com/bucketeer-io/bucketeer/commit/9c0a88c1197f827d7a2c68909929ef3eb609fa83))
* **ui:** improve insights dashboard env default and chart y-axis ([#2525](https://github.com/bucketeer-io/bucketeer/issues/2525)) ([8a79729](https://github.com/bucketeer-io/bucketeer/commit/8a79729b52cfd5e17b8b095b15519486f66d2e27))
* **ui:** prevent infinite 401 retry loop in axios interceptor ([#2452](https://github.com/bucketeer-io/bucketeer/issues/2452)) ([e1a2495](https://github.com/bucketeer-io/bucketeer/commit/e1a24955720d47762029bdecc188d91a333ccd4f))
* **ui:** recurring schedule update not recalculating nextExecutionAt ([#2519](https://github.com/bucketeer-io/bucketeer/issues/2519)) ([4aeb0b5](https://github.com/bucketeer-io/bucketeer/commit/4aeb0b5e12a25a58f64da53e8a2aafdd77f6b0c7))
* **ui:** remove schedule option from flag switch confirmation modal ([#2486](https://github.com/bucketeer-io/bucketeer/issues/2486)) ([b42ee18](https://github.com/bucketeer-io/bucketeer/commit/b42ee18303d7e416b6fe5e25622fb59dec8de806))
* **ui:** render archive warning interpolation ([#2678](https://github.com/bucketeer-io/bucketeer/issues/2678)) ([e9a806a](https://github.com/bucketeer-io/bucketeer/commit/e9a806aa3b1ca9f870c60bbd483032540fa15f68))
* **ui:** replace nested button with span in tooltip triggers on create flag page ([#2571](https://github.com/bucketeer-io/bucketeer/issues/2571)) ([0e20eaa](https://github.com/bucketeer-io/bucketeer/commit/0e20eaa3cdd8fc55d044a0899600e14c3e196884))
...
* **ui:** show correct cycle dates in recurring schedule timeline ([#2515](https://github.com/bucketeer-io/bucketeer/issues/2515)) ([f32eb6f](https://github.com/bucketeer-io/bucketeer/commit/f32eb6f1aac1fa6a1d00b0a7c4b0f59d7d6390f4))
* **ui:** show correct modal for stop/delete operations by type ([#2483](https://github.com/bucketeer-io/bucketeer/issues/2483)) ([80dd23a](https://github.com/bucketeer-io/bucketeer/commit/80dd23aa150c198ae763c016b857d9d14154946a))
* **ui:** update now option is scheduling instead of updating immediately ([#2481](https://github.com/bucketeer-io/bucketeer/issues/2481)) ([a2d4d90](https://github.com/bucketeer-io/bucketeer/commit/a2d4d90c04c513082c2cc96252598a0fc7e817ef))
* **ui:** use variation name as label in evaluation chart for YAML/JSON types ([#2573](https://github.com/bucketeer-io/bucketeer/issues/2573)) ([6b464ac](https://github.com/bucketeer-io/bucketeer/commit/6b464ac9190fb256e59706bce80976edb3f37c35))
* use resilient token source for google pub/sub to survive spot preemption ([#2545](https://github.com/bucketeer-io/bucketeer/issues/2545)) ([89e6002](https://github.com/bucketeer-io/bucketeer/commit/89e60021601dfa46d36963572f67b36b188fe268))
...
* add recurring schedule proto definitions and domain logic ([#2465](https://github.com/bucketeer-io/bucketeer/issues/2465)) ([43d8032](https://github.com/bucketeer-io/bucketeer/commit/43d8032613836fa2703952c07249c3ea16db7029))
* add recurring schedule support to DatetimeWatcher and api service ([#2469](https://github.com/bucketeer-io/bucketeer/issues/2469)) ([5045124](https://github.com/bucketeer-io/bucketeer/commit/50451247c38659bd02a8b6e1d771caf85217c625))
...
* change default auto-archive unused days from 90 to 60 ([#2460](https://github.com/bucketeer-io/bucketeer/issues/2460)) ([694dc77](https://github.com/bucketeer-io/bucketeer/commit/694dc771edaa9d320b759c7cc066487299a7b15a))
* **ci:** add --frozen-lockfile in 'yarn install' ([#2543](https://github.com/bucketeer-io/bucketeer/issues/2543)) ([5134afc](https://github.com/bucketeer-io/bucketeer/commit/5134afc21cf09bdbdeabea56c85582500d86f809))
* create hack script to create service account for e2e ([#2559](https://github.com/bucketeer-io/bucketeer/issues/2559)) ([832e73c](https://github.com/bucketeer-io/bucketeer/commit/832e73c9040f1c66c9ab8e57b06972dfdb4c5493))
* **devcontainer:** add dynamic hack tool dependency tracking ([#2419](https://github.com/bucketeer-io/bucketeer/issues/2419)) ([8fe10fd](https://github.com/bucketeer-io/bucketeer/commit/8fe10fd6b58be612207ce9cb66517043f8199a67))
* **devcontainer:** add SSH server to devcontainer base image ([#2704](https://github.com/bucketeer-io/bucketeer/issues/2704)) ([c217029](https://github.com/bucketeer-io/bucketeer/commit/c2170292d10f50d843614eea9a2f375ba28fd2bf))
* **devcontainer:** remove unused files ([#2705](https://github.com/bucketeer-io/bucketeer/issues/2705)) ([253f70d](https://github.com/bucketeer-io/bucketeer/commit/253f70d241295d84709f6eb2d689ef229bc0d706))
...
* downgrade cache invalidator shutdown logs to debug  ([#2563](https://github.com/bucketeer-io/bucketeer/issues/2563)) ([c9e06c0](https://github.com/bucketeer-io/bucketeer/commit/c9e06c0f24acc3bc786716e5f71d87513ad6c31b))
* drop unused mau and mau_summary tables ([#2424](https://github.com/bucketeer-io/bucketeer/issues/2424)) ([adf9761](https://github.com/bucketeer-io/bucketeer/commit/adf9761e50f82c52197b2b054f7f9c9f5b82cf3f))
* enforce homogeneous schedule types per operation ([#2491](https://github.com/bucketeer-io/bucketeer/issues/2491)) ([49c77c6](https://github.com/bucketeer-io/bucketeer/commit/49c77c601afb38ade77191898fff271b34f42f2c))
* **evaluation:** remove gRPC requests and reduce the release package size. ([#2431](https://github.com/bucketeer-io/bucketeer/issues/2431)) ([74d1ec4](https://github.com/bucketeer-io/bucketeer/commit/74d1ec4edfa6fb923bac9aa15f1821a4403734bf))
...
* **hack:** update delete redis retry keys app ([#2458](https://github.com/bucketeer-io/bucketeer/issues/2458)) ([c3c8e11](https://github.com/bucketeer-io/bucketeer/commit/c3c8e11b0dbdbb61a51aaea3867a3aa7e092e8ee))
* ignore sdk cache not found warning logs ([#2526](https://github.com/bucketeer-io/bucketeer/issues/2526)) ([9165b13](https://github.com/bucketeer-io/bucketeer/commit/9165b1323dd9d43d027bdce3ceb94529600f4660))
* implement delete e2e data for postgres ([#2659](https://github.com/bucketeer-io/bucketeer/issues/2659)) ([8749e79](https://github.com/bucketeer-io/bucketeer/commit/8749e79cf1fb1210c24170df8820db2f78500003))
* implement delete postgres data warehouse data ([#2660](https://github.com/bucketeer-io/bucketeer/issues/2660)) ([b8f7c64](https://github.com/bucketeer-io/bucketeer/commit/b8f7c64f0baa32d53b4ee70ba6f77bb2df19a102))
...
* improve scheduled change summaries with segment and cross-flag names ([#2422](https://github.com/bucketeer-io/bucketeer/issues/2422)) ([dd27215](https://github.com/bucketeer-io/bucketeer/commit/dd27215d64e60ab952b37e232909661a4837f116))
* init Claude context window for auto memory ([#2546](https://github.com/bucketeer-io/bucketeer/issues/2546)) ([2f7b6f3](https://github.com/bucketeer-io/bucketeer/commit/2f7b6f3f57e7e37bbb35cbddeda7247c651c1897))
* init database dump, fix pg host and global yaml config ([#2568](https://github.com/bucketeer-io/bucketeer/issues/2568)) ([48d78dc](https://github.com/bucketeer-io/bucketeer/commit/48d78dce1e3bf3a0f114c38365f5dfa7ad97210f))
* **insights:** add local prometheus for E2E ([#2524](https://github.com/bucketeer-io/bucketeer/issues/2524)) ([888edb7](https://github.com/bucketeer-io/bucketeer/commit/888edb776af806f1bb8ac48e8a3d6968dc11b1ad))
* **insights:** rename the DAU/MAU key ([#2442](https://github.com/bucketeer-io/bucketeer/issues/2442)) ([d42f42b](https://github.com/bucketeer-io/bucketeer/commit/d42f42bba31b79073829140e3080fe0af63b8168))
* make big query optional in minikube ([#2435](https://github.com/bucketeer-io/bucketeer/issues/2435)) ([860de2f](https://github.com/bucketeer-io/bucketeer/commit/860de2fa9c95c1eaee92160282ba323d56e2b795))
* **metrics:** collect prometheus error metric for batch jobs/subscriber ([#2626](https://github.com/bucketeer-io/bucketeer/issues/2626)) ([5c29e30](https://github.com/bucketeer-io/bucketeer/commit/5c29e3099551c226857b4d3cfe1d199c10cfd145))
* refresh L2 caches on domain events to eliminate cache-miss thundering herd ([#2562](https://github.com/bucketeer-io/bucketeer/issues/2562)) ([65d3548](https://github.com/bucketeer-io/bucketeer/commit/65d35485af35638395437b23aaba209ecfc909a8))
* regenerate service token for local development ([#2611](https://github.com/bucketeer-io/bucketeer/issues/2611)) ([c5ac44e](https://github.com/bucketeer-io/bucketeer/commit/c5ac44e30fa589d5316cf9764a517f8228e53d86))
* remove empty environment id migration code ([#2459](https://github.com/bucketeer-io/bucketeer/issues/2459)) ([13b5577](https://github.com/bucketeer-io/bucketeer/commit/13b55778d0046a10d84172981896006a34bd9778))
* remove logging of sensitive information ([#2490](https://github.com/bucketeer-io/bucketeer/issues/2490)) ([ee2b047](https://github.com/bucketeer-io/bucketeer/commit/ee2b047efca73f3e7b6cc07e3045782a94ceed25))
* remove unnecessary warning logs from api svc ([#2554](https://github.com/bucketeer-io/bucketeer/issues/2554)) ([7e28980](https://github.com/bucketeer-io/bucketeer/commit/7e289801de40d4a47fb2c4009234de16f9487dcb))
* remove unused mau and mau_summary implementation ([#2425](https://github.com/bucketeer-io/bucketeer/issues/2425)) ([a18f233](https://github.com/bucketeer-io/bucketeer/commit/a18f233cccf7b037e746112ea282fa75e6aa8802))
* remove user event persisters (upsert maus) ([#2653](https://github.com/bucketeer-io/bucketeer/issues/2653)) ([f708382](https://github.com/bucketeer-io/bucketeer/commit/f70838274be59463c43185de9ae73d8a9b264c21))
* replace deprecated ingress k8s config ([#2456](https://github.com/bucketeer-io/bucketeer/issues/2456)) ([bc7e69d](https://github.com/bucketeer-io/bucketeer/commit/bc7e69ddb4bf99317a3dfe0ba55c7a76227ccde6))
* replace ptypes with google.golang.org/protobuf ([#2493](https://github.com/bucketeer-io/bucketeer/issues/2493)) ([3014b6b](https://github.com/bucketeer-io/bucketeer/commit/3014b6b9844c7dd503ae4ed4f2011c0703ecff9f))
* switch local image to timescale db ([#2436](https://github.com/bucketeer-io/bucketeer/issues/2436)) ([1d3f0f4](https://github.com/bucketeer-io/bucketeer/commit/1d3f0f4413d8579f09e0e9722fc2171f6f5d02cc))
...
* **ui:** enhance flag creation with template tooltips and smart defaults ([#2479](https://github.com/bucketeer-io/bucketeer/issues/2479)) ([5c518db](https://github.com/bucketeer-io/bucketeer/commit/5c518db0f2a1289580c6250821d5ed9662ad16aa))
* **ui:** implement infinite loader for filter maintainer dropdown ([#2560](https://github.com/bucketeer-io/bucketeer/issues/2560)) ([2600de0](https://github.com/bucketeer-io/bucketeer/commit/2600de0cac3a32b3cd4f0df520edb00b69459019))
* **ui:** improve targeting tab UX with evaluation flow indicators ([#2488](https://github.com/bucketeer-io/bucketeer/issues/2488)) ([3003662](https://github.com/bucketeer-io/bucketeer/commit/30036624edb8812038151f252a5fb0328f65b3b2))
* **ui:** improve variation dropdown display and validation error messages ([#2500](https://github.com/bucketeer-io/bucketeer/issues/2500)) ([bcbb169](https://github.com/bucketeer-io/bucketeer/commit/bcbb169b0b2ec28238dec8c0a44d6a9c997cbf4a))
* **ui:** visualize targeting evaluation order with a vertical flow ([#2644](https://github.com/bucketeer-io/bucketeer/issues/2644)) ([5045a6b](https://github.com/bucketeer-io/bucketeer/commit/5045a6bc29402c07f17c0637cac0a337f47387fc))
...
* validate variation values against schema ([#2683](https://github.com/bucketeer-io/bucketeer/issues/2683)) ([10d82c8](https://github.com/bucketeer-io/bucketeer/commit/10d82c84dfb9045c1c820f5348136272a529b1ce))


### Performance Improvements

* bound metrics event processing with a worker pool ([#2564](https://github.com/bucketeer-io/bucketeer/issues/2564)) ([849ff1f](https://github.com/bucketeer-io/bucketeer/commit/849ff1f97c2244be66f696a0bfb0b12c5228204c))
* optimize evaluation count persistence with aggregation ([#2449](https://github.com/bucketeer-io/bucketeer/issues/2449)) ([04de7e6](https://github.com/bucketeer-io/bucketeer/commit/04de7e6c57ad19b5d18e90d6be5ce5da557b8637))
* use in-memory cache for environment API key lookups ([#2520](https://github.com/bucketeer-io/bucketeer/issues/2520)) ([d644360](https://github.com/bucketeer-io/bucketeer/commit/d644360fbc670babe5ba6d10aa4d24211c16d865))


### Reverts

* feat(insights): count DAU in APIs ([#2391](https://github.com/bucketeer-io/bucketeer/issues/2391)) ([077f543](https://github.com/bucketeer-io/bucketeer/commit/077f543e1358057c705ec9bde3b4a0434130be59))


### Build System

* **deps-dev:** bump @babel/core in /evaluation/typescript ([#2647](https://github.com/bucketeer-io/bucketeer/issues/2647)) ([f46f50e](https://github.com/bucketeer-io/bucketeer/commit/f46f50e2abb3aacff3836ba7ebb0c16d0b098088))
* **deps-dev:** bump postcss from 8.5.15 to 8.5.18 in /ui/dashboard ([#2726](https://github.com/bucketeer-io/bucketeer/issues/2726)) ([c67d591](https://github.com/bucketeer-io/bucketeer/commit/c67d5919d9880be46cb69f60ab601d8c882b449d))
* **deps-dev:** bump postcss from 8.5.8 to 8.5.10 in /ui/dashboard ([#2558](https://github.com/bucketeer-io/bucketeer/issues/2558)) ([b652653](https://github.com/bucketeer-io/bucketeer/commit/b652653d2e7ec774c70292b65a4f1074540c44f5))
* **deps-dev:** bump svgo from 3.3.2 to 3.3.3 in /ui/dashboard ([#2438](https://github.com/bucketeer-io/bucketeer/issues/2438)) ([1232279](https://github.com/bucketeer-io/bucketeer/commit/123227965710180e672d07157d32496a8691797c))
* **deps-dev:** bump svgo from 3.3.3 to 3.3.4 in /ui/dashboard ([#2713](https://github.com/bucketeer-io/bucketeer/issues/2713)) ([a415c5a](https://github.com/bucketeer-io/bucketeer/commit/a415c5ad97f1bdbbc45d1956d10866602eba64d3))
* **deps-dev:** bump vite from 7.3.1 to 7.3.2 in /ui/dashboard ([#2516](https://github.com/bucketeer-io/bucketeer/issues/2516)) ([25f3839](https://github.com/bucketeer-io/bucketeer/commit/25f383951bfe5cb936599611aa90f46bfaec672a))
* **deps-dev:** bump vite from 7.3.3 to 7.3.5 in /ui/dashboard ([#2645](https://github.com/bucketeer-io/bucketeer/issues/2645)) ([b33654c](https://github.com/bucketeer-io/bucketeer/commit/b33654c883cb06447226bf3f66101bccd7994762))
* **deps-ui:** upgrade React to v19 and React Router to v7 ([#2502](https://github.com/bucketeer-io/bucketeer/issues/2502)) ([17fd2a5](https://github.com/bucketeer-io/bucketeer/commit/17fd2a59bd1d4a735dc1431abccb9cbf7c42feac))
* **deps:** bump @babel/core from 7.29.0 to 7.29.7 in /ui/dashboard ([#2649](https://github.com/bucketeer-io/bucketeer/issues/2649)) ([ff185c8](https://github.com/bucketeer-io/bucketeer/commit/ff185c81c1098ca9da58fbca20cf0953a52b49f8))
* **deps:** bump @babel/plugin-transform-modules-systemjs ([#2570](https://github.com/bucketeer-io/bucketeer/issues/2570)) ([1616cf6](https://github.com/bucketeer-io/bucketeer/commit/1616cf616e5f14b7722dfb89108d75cee22d25a9))
...
* **deps:** bump axios from 1.14.0 to 1.15.0 in /ui/dashboard ([#2533](https://github.com/bucketeer-io/bucketeer/issues/2533)) ([76fad2c](https://github.com/bucketeer-io/bucketeer/commit/76fad2cdba8093079655b584cb74e7ae041c91dc))
* **deps:** bump axios from 1.15.2 to 1.16.0 in /ui/dashboard ([#2602](https://github.com/bucketeer-io/bucketeer/issues/2602)) ([932fa91](https://github.com/bucketeer-io/bucketeer/commit/932fa917fad1df64e86c9b2b6fc756a61e0feeea))
* **deps:** bump axios from 1.16.1 to 1.18.0 in /ui/dashboard ([#2706](https://github.com/bucketeer-io/bucketeer/issues/2706)) ([463f502](https://github.com/bucketeer-io/bucketeer/commit/463f502b20edee837ee5169d281f4c190c6dd8fa))
* **deps:** bump benc-uk/workflow-dispatch in the dependencies group ([#2603](https://github.com/bucketeer-io/bucketeer/issues/2603)) ([68b4bc5](https://github.com/bucketeer-io/bucketeer/commit/68b4bc5a985ae8b6a66dca3a26c1cc061c730e3a))
...
* **deps:** bump flatted from 3.3.3 to 3.4.2 in /evaluation/typescript ([#2471](https://github.com/bucketeer-io/bucketeer/issues/2471)) ([9a122ce](https://github.com/bucketeer-io/bucketeer/commit/9a122ce90d10d078d5eecd6c06ad606f3d601022))
* **deps:** bump flatted from 3.3.3 to 3.4.2 in /ui/dashboard ([#2470](https://github.com/bucketeer-io/bucketeer/issues/2470)) ([4ad402a](https://github.com/bucketeer-io/bucketeer/commit/4ad402a7afe548895edca7f36a9e63f954b90eae))
* **deps:** bump follow-redirects in /ui/dashboard ([#2538](https://github.com/bucketeer-io/bucketeer/issues/2538)) ([a4df7df](https://github.com/bucketeer-io/bucketeer/commit/a4df7df5682915a668a4f9d9e564d7d305934b24))
* **deps:** bump form-data from 4.0.5 to 4.0.6 in /ui/dashboard ([#2648](https://github.com/bucketeer-io/bucketeer/issues/2648)) ([1528290](https://github.com/bucketeer-io/bucketeer/commit/1528290533c1cfefc29c184b901b2a11ae78ecdf))
* **deps:** bump github.com/slack-go/slack from 0.21.0 to 0.23.1 ([#2579](https://github.com/bucketeer-io/bucketeer/issues/2579)) ([6c9e6a2](https://github.com/bucketeer-io/bucketeer/commit/6c9e6a223be9cd08dd08957887e774ef45c1a515))
* **deps:** bump go.opentelemetry.io/otel ([#2557](https://github.com/bucketeer-io/bucketeer/issues/2557)) ([b5e3e4c](https://github.com/bucketeer-io/bucketeer/commit/b5e3e4c5abb3dfaee49177dfd0ef2f574af1cc05))
* **deps:** bump golang.org/x/crypto ([#2693](https://github.com/bucketeer-io/bucketeer/issues/2693)) ([b6f7adc](https://github.com/bucketeer-io/bucketeer/commit/b6f7adcf9823886d861afa025ff9941ae32c83df))
* **deps:** bump golang.org/x/crypto in /hack/create-e2e-accounts ([#2692](https://github.com/bucketeer-io/bucketeer/issues/2692)) ([0d73975](https://github.com/bucketeer-io/bucketeer/commit/0d73975b4dba41da9128f7052f8c02d2571da163))
* **deps:** bump golang.org/x/crypto in /hack/delete-e2e-data-mysql ([#2695](https://github.com/bucketeer-io/bucketeer/issues/2695)) ([8672ae8](https://github.com/bucketeer-io/bucketeer/commit/8672ae839ee8718b528e4a1616dea94fdf380f74))
* **deps:** bump golang.org/x/crypto in /hack/delete-e2e-data-postgres ([#2694](https://github.com/bucketeer-io/bucketeer/issues/2694)) ([edfd637](https://github.com/bucketeer-io/bucketeer/commit/edfd63710c8f856345ffb23d4145f88c04bb4427))
* **deps:** bump golang.org/x/net in /hack/delete-e2e-data-mysql ([#2681](https://github.com/bucketeer-io/bucketeer/issues/2681)) ([9be57f4](https://github.com/bucketeer-io/bucketeer/commit/9be57f497f4fe43a8c794fb513e0a5a18a0f6afb))
* **deps:** bump golang.org/x/net in /hack/delete-redis-retry-keys ([#2682](https://github.com/bucketeer-io/bucketeer/issues/2682)) ([04eab89](https://github.com/bucketeer-io/bucketeer/commit/04eab89ddf0a492d5ee1e11aa46f76cef6f8f2ea))
* **deps:** bump google.golang.org/grpc ([#2467](https://github.com/bucketeer-io/bucketeer/issues/2467)) ([ff1de07](https://github.com/bucketeer-io/bucketeer/commit/ff1de0754b52db048f54182584b02719d27c055c))
* **deps:** bump google.golang.org/grpc ([#2715](https://github.com/bucketeer-io/bucketeer/issues/2715)) ([1a9de21](https://github.com/bucketeer-io/bucketeer/commit/1a9de21eb11efbbe287a85d3325510e52bfb0c22))
* **deps:** bump google.golang.org/grpc from 1.79.1 to 1.79.3 ([#2468](https://github.com/bucketeer-io/bucketeer/issues/2468)) ([451e0f9](https://github.com/bucketeer-io/bucketeer/commit/451e0f9d941026d19cf9628dd2c1a972f5adf40a))
* **deps:** bump google.golang.org/grpc from 1.82.0 to 1.82.1 ([#2717](https://github.com/bucketeer-io/bucketeer/issues/2717)) ([e1180c6](https://github.com/bucketeer-io/bucketeer/commit/e1180c65dc8c05a15a92b3a47cb299862ca49ac4))
* **deps:** bump google.golang.org/grpc in /hack/delete-e2e-data-mysql ([#2466](https://github.com/bucketeer-io/bucketeer/issues/2466)) ([cab2570](https://github.com/bucketeer-io/bucketeer/commit/cab25701e13817049a4334bcbdb54a5795ce56dc))
* **deps:** bump i18next-http-backend in /ui/dashboard ([#2553](https://github.com/bucketeer-io/bucketeer/issues/2553)) ([261351a](https://github.com/bucketeer-io/bucketeer/commit/261351a7940622499572aa4e4074c8d57e1fbb34))
* **deps:** bump js-cookie from 3.0.5 to 3.0.7 in /ui/dashboard ([#2590](https://github.com/bucketeer-io/bucketeer/issues/2590)) ([73afedc](https://github.com/bucketeer-io/bucketeer/commit/73afedc7489c37e083913f86927bb8880e07cb93))
* **deps:** bump js-yaml from 4.1.1 to 4.2.0 in /evaluation/typescript ([#2646](https://github.com/bucketeer-io/bucketeer/issues/2646)) ([7dd5105](https://github.com/bucketeer-io/bucketeer/commit/7dd510554836c6c3f7d1c30d0973e72d3a2c0ef2))
* **deps:** bump js-yaml from 4.2.0 to 4.3.0 in /evaluation/typescript ([#2718](https://github.com/bucketeer-io/bucketeer/issues/2718)) ([e1002ab](https://github.com/bucketeer-io/bucketeer/commit/e1002ab161e467635125bb5218a30d579aa78fe7))
* **deps:** bump js-yaml from 4.2.0 to 4.3.0 in /ui/dashboard ([#2716](https://github.com/bucketeer-io/bucketeer/issues/2716)) ([3353ba9](https://github.com/bucketeer-io/bucketeer/commit/3353ba9be4f81c7f89e1cf05ea5514f3f5cd3f8e))
...
* **deps:** bump lodash from 4.17.21 to 4.18.1 in /ui/dashboard ([#2508](https://github.com/bucketeer-io/bucketeer/issues/2508)) ([0ccc1bb](https://github.com/bucketeer-io/bucketeer/commit/0ccc1bba31a21a3f4dcfb13a797949191affa323))
...
* **deps:** bump lodash in /evaluation/typescript ([#2509](https://github.com/bucketeer-io/bucketeer/issues/2509)) ([51582eb](https://github.com/bucketeer-io/bucketeer/commit/51582ebcef0a6e795b4b3a0d328d8d41865b2812))
* **deps:** bump minor dependencies ([#2498](https://github.com/bucketeer-io/bucketeer/issues/2498)) ([1556228](https://github.com/bucketeer-io/bucketeer/commit/15562286c61a1d4cbed37962dc004586003db8d4))
* **deps:** bump react-router from 7.16.0 to 7.18.0 in /ui/dashboard ([#2714](https://github.com/bucketeer-io/bucketeer/issues/2714)) ([b635b7b](https://github.com/bucketeer-io/bucketeer/commit/b635b7b075c54a440ea7c009c1b3428aacaf9f29))
* **deps:** bump rollup from 4.45.1 to 4.59.0 in /ui/dashboard ([#2430](https://github.com/bucketeer-io/bucketeer/issues/2430)) ([7f74051](https://github.com/bucketeer-io/bucketeer/commit/7f7405127fbb6e30d4fb788f71a1182999cd4b4d))
* **deps:** bump shell-quote in /evaluation/typescript ([#2629](https://github.com/bucketeer-io/bucketeer/issues/2629)) ([16e4512](https://github.com/bucketeer-io/bucketeer/commit/16e4512e9289386682c6a237ec68cfc1da37b554))
* **deps:** bump shell-quote in /evaluation/typescript ([#2719](https://github.com/bucketeer-io/bucketeer/issues/2719)) ([bf965df](https://github.com/bucketeer-io/bucketeer/commit/bf965df1e62ec1bb82ae0dfc5134c5508f98df25))
* **deps:** bump the dependencies group ([#2567](https://github.com/bucketeer-io/bucketeer/issues/2567)) ([b29fc5d](https://github.com/bucketeer-io/bucketeer/commit/b29fc5d590e6477b2c0dfa20709f24e191d08194))
* **deps:** bump the dependencies group ([#2605](https://github.com/bucketeer-io/bucketeer/issues/2605)) ([2e2c243](https://github.com/bucketeer-io/bucketeer/commit/2e2c24316050260245ca9ea3360a1547375c4a8d))
* **deps:** bump the dependencies group across 1 directory with 20 updates ([#2596](https://github.com/bucketeer-io/bucketeer/issues/2596)) ([6c93366](https://github.com/bucketeer-io/bucketeer/commit/6c9336650277bc3f86d9790e15668846823fbd2b))
* **deps:** bump the dependencies group across 1 directory with 33 updates ([#2724](https://github.com/bucketeer-io/bucketeer/issues/2724)) ([ee2fd9f](https://github.com/bucketeer-io/bucketeer/commit/ee2fd9f1723b56c76598a7fb1f7a95e29eb4958a))
* **deps:** bump the dependencies group across 1 directory with 5 updates ([#2511](https://github.com/bucketeer-io/bucketeer/issues/2511)) ([9e1f606](https://github.com/bucketeer-io/bucketeer/commit/9e1f606130e74fc68277614fa41ae0b3ab19731b))
* **deps:** bump the dependencies group in /ui/dashboard with 7 updates ([#2513](https://github.com/bucketeer-io/bucketeer/issues/2513)) ([8a8695b](https://github.com/bucketeer-io/bucketeer/commit/8a8695b9e45575c1019c8e0da90dc44b87d2fb2e))
* **deps:** bump the dependencies group with 10 updates ([#2604](https://github.com/bucketeer-io/bucketeer/issues/2604)) ([bc64be9](https://github.com/bucketeer-io/bucketeer/commit/bc64be9c3c56a0fe60f291caff10439581ecbed6))
* **deps:** bump the dependencies group with 12 updates ([#2512](https://github.com/bucketeer-io/bucketeer/issues/2512)) ([8ee6bc0](https://github.com/bucketeer-io/bucketeer/commit/8ee6bc070b276854a0e7f4b516bbaf04d06bd803))
* **deps:** bump the dependencies group with 13 updates ([#2671](https://github.com/bucketeer-io/bucketeer/issues/2671)) ([06cfaea](https://github.com/bucketeer-io/bucketeer/commit/06cfaea3719e192dea08d6fd2759d1706a291966))
...
* **deps:** bump the dependencies group with 17 updates ([#2729](https://github.com/bucketeer-io/bucketeer/issues/2729)) ([f5e0809](https://github.com/bucketeer-io/bucketeer/commit/f5e0809527d0dc232aad07e44c4721fe04853a81))
* **deps:** bump the dependencies group with 21 updates ([#2433](https://github.com/bucketeer-io/bucketeer/issues/2433)) ([8725a0c](https://github.com/bucketeer-io/bucketeer/commit/8725a0ce3743fcbdd5643ae9fbb4d0b187054a2d))
* **deps:** bump the dependencies group with 21 updates ([#2497](https://github.com/bucketeer-io/bucketeer/issues/2497)) ([0e9f119](https://github.com/bucketeer-io/bucketeer/commit/0e9f119f90682bbf6b4a3a3d72809d35d19f2524))
* **deps:** bump the dependencies group with 3 updates ([#2728](https://github.com/bucketeer-io/bucketeer/issues/2728)) ([39a5c87](https://github.com/bucketeer-io/bucketeer/commit/39a5c87eaf18f5d1f67b70c4c614e881d1c0b4fc))
* **deps:** bump the dependencies group with 4 updates ([#2432](https://github.com/bucketeer-io/bucketeer/issues/2432)) ([914f043](https://github.com/bucketeer-io/bucketeer/commit/914f043afcdeae4147e9523f0b80c73e261c4bec))
* **deps:** bump the dependencies group with 4 updates ([#2565](https://github.com/bucketeer-io/bucketeer/issues/2565)) ([b39eb15](https://github.com/bucketeer-io/bucketeer/commit/b39eb1579aa70eeb889a1d1da10fda6e8436890e))
* **deps:** bump the dependencies group with 4 updates ([#2670](https://github.com/bucketeer-io/bucketeer/issues/2670)) ([e8d9dab](https://github.com/bucketeer-io/bucketeer/commit/e8d9dab3d810351149cc4844d3cc59115314b4e4))
...
* **ui:** bump uuid from 10.0.0 to 14.0.0 ([#2555](https://github.com/bucketeer-io/bucketeer/issues/2555)) ([fd416c5](https://github.com/bucketeer-io/bucketeer/commit/fd416c536af9e60610d0a0cc2aa838c3f30d8cb0))
