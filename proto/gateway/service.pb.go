...
var file_proto_gateway_service_proto_rawDesc = []byte{
	...
	0x2f, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x0d,
	...
	0x74, 0x22, 0xda, 0x04, 0x0a, 0x15, 0x4c, 0x69, 0x73, 0x74, 0x41, 0x63, 0x63, 0x6f, 0x75, 0x6e,
	...
	0x6e, 0x76, 0x69, 0x72, 0x6f, 0x6e, 0x6d, 0x65, 0x6e, 0x74, 0x52, 0x6f, 0x6c, 0x65, 0x22, 0x8b,
	...
	0x75, 0x6e, 0x74, 0x32, 0xc6, 0x4d, 0x0a, 0x07, 0x47, 0x61, 0x74, 0x65, 0x77, 0x61, 0x79, 0x12,
	...
	0x68, 0x69, 0x73, 0x74, 0x6f, 0x72, 0x79, 0x2e, 0x6c, 0x69, 0x73, 0x74, 0x42, 0x84, 0x06, 0x5a,
...
var file_proto_gateway_service_proto_msgTypes = make([]protoimpl.MessageInfo, 75)
var file_proto_gateway_service_proto_goTypes = []interface{}{
	...
	(*GetEvaluationsRequest_UserEvaluationCondition)(nil),        // 72: bucketeer.gateway.GetEvaluationsRequest.UserEvaluationCondition
	(*RegisterEventsResponse_Error)(nil),                         // 73: bucketeer.gateway.RegisterEventsResponse.Error
	nil,                                                          // 74: bucketeer.gateway.RegisterEventsResponse.ErrorsEntry
	(client.SourceId)(0),                                         // 75: bucketeer.event.client.SourceId
	(*feature.Feature)(nil),                                      // 76: bucketeer.feature.Feature
	(*feature.SegmentUsers)(nil),                                 // 77: bucketeer.feature.SegmentUsers
	(*user.User)(nil),                                            // 78: bucketeer.user.User
	(feature.UserEvaluations_State)(0),                           // 79: bucketeer.feature.UserEvaluations.State
	(*feature.UserEvaluations)(nil),                              // 80: bucketeer.feature.UserEvaluations
	(*feature.Evaluation)(nil),                                   // 81: bucketeer.feature.Evaluation
	(*client.Event)(nil),                                         // 82: bucketeer.event.client.Event
	(feature.Feature_VariationType)(0),                           // 83: bucketeer.feature.Feature.VariationType
	(*feature.Variation)(nil),                                    // 84: bucketeer.feature.Variation
	(*wrapperspb.Int32Value)(nil),                                // 85: google.protobuf.Int32Value
	(feature.ListFeaturesRequest_OrderBy)(0),                     // 86: bucketeer.feature.ListFeaturesRequest.OrderBy
	(feature.ListFeaturesRequest_OrderDirection)(0),              // 87: bucketeer.feature.ListFeaturesRequest.OrderDirection
	...
	(*feature.Strategy)(nil),                                     // 91: bucketeer.feature.Strategy
	(*feature.VariationChange)(nil),                              // 92: bucketeer.feature.VariationChange
	(*feature.RuleChange)(nil),                                   // 93: bucketeer.feature.RuleChange
	(*feature.PrerequisiteChange)(nil),                           // 94: bucketeer.feature.PrerequisiteChange
	(*feature.TargetChange)(nil),                                 // 95: bucketeer.feature.TargetChange
	(*feature.TagChange)(nil),                                    // 96: bucketeer.feature.TagChange
	(push.ListPushesRequest_OrderBy)(0),                          // 97: bucketeer.push.ListPushesRequest.OrderBy
	(push.ListPushesRequest_OrderDirection)(0),                   // 98: bucketeer.push.ListPushesRequest.OrderDirection
	(*push.Push)(nil),                                            // 99: bucketeer.push.Push
	(account.AccountV2_Role_Organization)(0),                     // 100: bucketeer.account.AccountV2.Role.Organization
	(*account.AccountV2_EnvironmentRole)(nil),                    // 101: bucketeer.account.AccountV2.EnvironmentRole
	(*account.AccountV2)(nil),                                    // 102: bucketeer.account.AccountV2
	(*account.UpdateAccountV2Request_OrganizationRoleValue)(nil), // 103: bucketeer.account.UpdateAccountV2Request.OrganizationRoleValue
	(*wrapperspb.Int64Value)(nil),                                // 104: google.protobuf.Int64Value
	(*account.UpdateAccountV2Request_AccountV2Avatar)(nil),       // 105: bucketeer.account.UpdateAccountV2Request.AccountV2Avatar
	(*account.ConsoleAccount)(nil),                               // 106: bucketeer.account.ConsoleAccount
	(account.ListAccountsV2Request_OrderBy)(0),                   // 107: bucketeer.account.ListAccountsV2Request.OrderBy
	(account.ListAccountsV2Request_OrderDirection)(0),            // 108: bucketeer.account.ListAccountsV2Request.OrderDirection
	(*coderef.CodeReference)(nil),                                // 109: bucketeer.coderef.CodeReference
	(coderef.ListCodeReferencesRequest_OrderBy)(0),               // 110: bucketeer.coderef.ListCodeReferencesRequest.OrderBy
	(coderef.ListCodeReferencesRequest_OrderDirection)(0),        // 111: bucketeer.coderef.ListCodeReferencesRequest.OrderDirection
	(coderef.CodeReference_RepositoryType)(0),                    // 112: bucketeer.coderef.CodeReference.RepositoryType
	(*feature.Segment)(nil),                                      // 113: bucketeer.feature.Segment
	(feature.ListSegmentsRequest_OrderBy)(0),                     // 114: bucketeer.feature.ListSegmentsRequest.OrderBy
	(feature.ListSegmentsRequest_OrderDirection)(0),              // 115: bucketeer.feature.ListSegmentsRequest.OrderDirection
	(feature.SegmentUser_State)(0),                               // 116: bucketeer.feature.SegmentUser.State
	(*auditlog.AuditLog)(nil),                                    // 117: bucketeer.auditlog.AuditLog
	(auditlog.ListAuditLogsRequest_OrderBy)(0),                   // 118: bucketeer.auditlog.ListAuditLogsRequest.OrderBy
	(auditlog.ListAuditLogsRequest_OrderDirection)(0),            // 119: bucketeer.auditlog.ListAuditLogsRequest.OrderDirection
	(auditlog.ListFeatureHistoryRequest_OrderBy)(0),              // 120: bucketeer.auditlog.ListFeatureHistoryRequest.OrderBy
	(auditlog.ListFeatureHistoryRequest_OrderDirection)(0),       // 121: bucketeer.auditlog.ListFeatureHistoryRequest.OrderDirection
}
var file_proto_gateway_service_proto_depIdxs = []int32{
	75,  // 0: bucketeer.gateway.GetFeatureFlagsRequest.source_id:type_name -> bucketeer.event.client.SourceId
	76,  // 1: bucketeer.gateway.GetFeatureFlagsResponse.features:type_name -> bucketeer.feature.Feature
	75,  // 2: bucketeer.gateway.GetSegmentUsersRequest.source_id:type_name -> bucketeer.event.client.SourceId
	77,  // 3: bucketeer.gateway.GetSegmentUsersResponse.segment_users:type_name -> bucketeer.feature.SegmentUsers
	78,  // 4: bucketeer.gateway.GetEvaluationsRequest.user:type_name -> bucketeer.user.User
	75,  // 5: bucketeer.gateway.GetEvaluationsRequest.source_id:type_name -> bucketeer.event.client.SourceId
	72,  // 6: bucketeer.gateway.GetEvaluationsRequest.user_evaluation_condition:type_name -> bucketeer.gateway.GetEvaluationsRequest.UserEvaluationCondition
	79,  // 7: bucketeer.gateway.GetEvaluationsResponse.state:type_name -> bucketeer.feature.UserEvaluations.State
	80,  // 8: bucketeer.gateway.GetEvaluationsResponse.evaluations:type_name -> bucketeer.feature.UserEvaluations
	78,  // 9: bucketeer.gateway.GetEvaluationRequest.user:type_name -> bucketeer.user.User
	75,  // 10: bucketeer.gateway.GetEvaluationRequest.source_id:type_name -> bucketeer.event.client.SourceId
	81,  // 11: bucketeer.gateway.GetEvaluationResponse.evaluation:type_name -> bucketeer.feature.Evaluation
	82,  // 12: bucketeer.gateway.RegisterEventsRequest.events:type_name -> bucketeer.event.client.Event
	75,  // 13: bucketeer.gateway.RegisterEventsRequest.source_id:type_name -> bucketeer.event.client.SourceId
	74,  // 14: bucketeer.gateway.RegisterEventsResponse.errors:type_name -> bucketeer.gateway.RegisterEventsResponse.ErrorsEntry
	78,  // 15: bucketeer.gateway.DebugEvaluateFeaturesRequest.users:type_name -> bucketeer.user.User
	81,  // 16: bucketeer.gateway.DebugEvaluateFeaturesResponse.evaluations:type_name -> bucketeer.feature.Evaluation
	83,  // 17: bucketeer.gateway.CreateFeatureRequest.variation_type:type_name -> bucketeer.feature.Feature.VariationType
	84,  // 18: bucketeer.gateway.CreateFeatureRequest.variations:type_name -> bucketeer.feature.Variation
	76,  // 19: bucketeer.gateway.CreateFeatureResponse.feature:type_name -> bucketeer.feature.Feature
	85,  // 20: bucketeer.gateway.GetFeatureRequest.feature_version:type_name -> google.protobuf.Int32Value
	76,  // 21: bucketeer.gateway.GetFeatureResponse.feature:type_name -> bucketeer.feature.Feature
	86,  // 22: bucketeer.gateway.ListFeaturesRequest.order_by:type_name -> bucketeer.feature.ListFeaturesRequest.OrderBy
	87,  // 23: bucketeer.gateway.ListFeaturesRequest.order_direction:type_name -> bucketeer.feature.ListFeaturesRequest.OrderDirection
	76,  // 24: bucketeer.gateway.ListFeaturesResponse.features:type_name -> bucketeer.feature.Feature
	88,  // 25: bucketeer.gateway.UpdateFeatureRequest.name:type_name -> google.protobuf.StringValue
	88,  // 26: bucketeer.gateway.UpdateFeatureRequest.description:type_name -> google.protobuf.StringValue
	89,  // 27: bucketeer.gateway.UpdateFeatureRequest.tags:type_name -> bucketeer.common.StringListValue
	90,  // 28: bucketeer.gateway.UpdateFeatureRequest.enabled:type_name -> google.protobuf.BoolValue
	90,  // 29: bucketeer.gateway.UpdateFeatureRequest.archived:type_name -> google.protobuf.BoolValue
	91,  // 30: bucketeer.gateway.UpdateFeatureRequest.default_strategy:type_name -> bucketeer.feature.Strategy
	88,  // 31: bucketeer.gateway.UpdateFeatureRequest.off_variation:type_name -> google.protobuf.StringValue
	92,  // 32: bucketeer.gateway.UpdateFeatureRequest.variation_changes:type_name -> bucketeer.feature.VariationChange
	93,  // 33: bucketeer.gateway.UpdateFeatureRequest.rule_changes:type_name -> bucketeer.feature.RuleChange
	94,  // 34: bucketeer.gateway.UpdateFeatureRequest.prerequisite_changes:type_name -> bucketeer.feature.PrerequisiteChange
	95,  // 35: bucketeer.gateway.UpdateFeatureRequest.target_changes:type_name -> bucketeer.feature.TargetChange
	96,  // 36: bucketeer.gateway.UpdateFeatureRequest.tag_changes:type_name -> bucketeer.feature.TagChange
	76,  // 37: bucketeer.gateway.UpdateFeatureResponse.feature:type_name -> bucketeer.feature.Feature
	97,  // 38: bucketeer.gateway.ListPushesRequest.order_by:type_name -> bucketeer.push.ListPushesRequest.OrderBy
	98,  // 39: bucketeer.gateway.ListPushesRequest.order_direction:type_name -> bucketeer.push.ListPushesRequest.OrderDirection
	99,  // 40: bucketeer.gateway.ListPushesResponse.pushes:type_name -> bucketeer.push.Push
	99,  // 41: bucketeer.gateway.CreatePushResponse.push:type_name -> bucketeer.push.Push
	99,  // 42: bucketeer.gateway.GetPushResponse.push:type_name -> bucketeer.push.Push
	88,  // 43: bucketeer.gateway.UpdatePushRequest.name:type_name -> google.protobuf.StringValue
	90,  // 44: bucketeer.gateway.UpdatePushRequest.deleted:type_name -> google.protobuf.BoolValue
	99,  // 45: bucketeer.gateway.UpdatePushResponse.push:type_name -> bucketeer.push.Push
	100, // 46: bucketeer.gateway.CreateAccountV2Request.organization_role:type_name -> bucketeer.account.AccountV2.Role.Organization
	101, // 47: bucketeer.gateway.CreateAccountV2Request.environment_roles:type_name -> bucketeer.account.AccountV2.EnvironmentRole
	102, // 48: bucketeer.gateway.CreateAccountV2Response.account:type_name -> bucketeer.account.AccountV2
	88,  // 49: bucketeer.gateway.UpdateAccountV2Request.name:type_name -> google.protobuf.StringValue
	88,  // 50: bucketeer.gateway.UpdateAccountV2Request.avatar_image_url:type_name -> google.protobuf.StringValue
	103, // 51: bucketeer.gateway.UpdateAccountV2Request.organization_role:type_name -> bucketeer.account.UpdateAccountV2Request.OrganizationRoleValue
	101, // 52: bucketeer.gateway.UpdateAccountV2Request.environment_roles:type_name -> bucketeer.account.AccountV2.EnvironmentRole
	88,  // 53: bucketeer.gateway.UpdateAccountV2Request.first_name:type_name -> google.protobuf.StringValue
	88,  // 54: bucketeer.gateway.UpdateAccountV2Request.last_name:type_name -> google.protobuf.StringValue
	88,  // 55: bucketeer.gateway.UpdateAccountV2Request.language:type_name -> google.protobuf.StringValue
	104, // 56: bucketeer.gateway.UpdateAccountV2Request.last_seen:type_name -> google.protobuf.Int64Value
	105, // 57: bucketeer.gateway.UpdateAccountV2Request.avatar:type_name -> bucketeer.account.UpdateAccountV2Request.AccountV2Avatar
	90,  // 58: bucketeer.gateway.UpdateAccountV2Request.disabled:type_name -> google.protobuf.BoolValue
	90,  // 59: bucketeer.gateway.UpdateAccountV2Request.deleted:type_name -> google.protobuf.BoolValue
	102, // 60: bucketeer.gateway.UpdateAccountV2Response.account:type_name -> bucketeer.account.AccountV2
	102, // 61: bucketeer.gateway.GetAccountV2Response.account:type_name -> bucketeer.account.AccountV2
	102, // 62: bucketeer.gateway.GetAccountV2ByEnvironmentIDResponse.account:type_name -> bucketeer.account.AccountV2
	106, // 63: bucketeer.gateway.GetMeResponse.account:type_name -> bucketeer.account.ConsoleAccount
	107, // 64: bucketeer.gateway.ListAccountsV2Request.order_by:type_name -> bucketeer.account.ListAccountsV2Request.OrderBy
	108, // 65: bucketeer.gateway.ListAccountsV2Request.order_direction:type_name -> bucketeer.account.ListAccountsV2Request.OrderDirection
	90,  // 66: bucketeer.gateway.ListAccountsV2Request.disabled:type_name -> google.protobuf.BoolValue
	85,  // 67: bucketeer.gateway.ListAccountsV2Request.organization_role:type_name -> google.protobuf.Int32Value
	88,  // 68: bucketeer.gateway.ListAccountsV2Request.environment_id:type_name -> google.protobuf.StringValue
	85,  // 69: bucketeer.gateway.ListAccountsV2Request.environment_role:type_name -> google.protobuf.Int32Value
	102, // 70: bucketeer.gateway.ListAccountsV2Response.accounts:type_name -> bucketeer.account.AccountV2
	109, // 71: bucketeer.gateway.GetCodeReferenceResponse.code_reference:type_name -> bucketeer.coderef.CodeReference
	110, // 72: bucketeer.gateway.ListCodeReferencesRequest.order_by:type_name -> bucketeer.coderef.ListCodeReferencesRequest.OrderBy
	111, // 73: bucketeer.gateway.ListCodeReferencesRequest.order_direction:type_name -> bucketeer.coderef.ListCodeReferencesRequest.OrderDirection
	109, // 74: bucketeer.gateway.ListCodeReferencesResponse.code_references:type_name -> bucketeer.coderef.CodeReference
	112, // 75: bucketeer.gateway.CreateCodeReferenceRequest.repository_type:type_name -> bucketeer.coderef.CodeReference.RepositoryType
	109, // 76: bucketeer.gateway.CreateCodeReferenceResponse.code_reference:type_name -> bucketeer.coderef.CodeReference
	109, // 77: bucketeer.gateway.UpdateCodeReferenceResponse.code_reference:type_name -> bucketeer.coderef.CodeReference
	113, // 78: bucketeer.gateway.CreateSegmentResponse.segment:type_name -> bucketeer.feature.Segment
	113, // 79: bucketeer.gateway.GetSegmentResponse.segment:type_name -> bucketeer.feature.Segment
	114, // 80: bucketeer.gateway.ListSegmentsRequest.order_by:type_name -> bucketeer.feature.ListSegmentsRequest.OrderBy
	115, // 81: bucketeer.gateway.ListSegmentsRequest.order_direction:type_name -> bucketeer.feature.ListSegmentsRequest.OrderDirection
	85,  // 82: bucketeer.gateway.ListSegmentsRequest.status:type_name -> google.protobuf.Int32Value
	90,  // 83: bucketeer.gateway.ListSegmentsRequest.is_in_use_status:type_name -> google.protobuf.BoolValue
	113, // 84: bucketeer.gateway.ListSegmentsResponse.segments:type_name -> bucketeer.feature.Segment
	88,  // 85: bucketeer.gateway.UpdateSegmentRequest.name:type_name -> google.protobuf.StringValue
	88,  // 86: bucketeer.gateway.UpdateSegmentRequest.description:type_name -> google.protobuf.StringValue
	113, // 87: bucketeer.gateway.UpdateSegmentResponse.segment:type_name -> bucketeer.feature.Segment
	116, // 88: bucketeer.gateway.BulkUploadSegmentUsersRequest.state:type_name -> bucketeer.feature.SegmentUser.State
	117, // 89: bucketeer.gateway.GetAuditLogResponse.audit_log:type_name -> bucketeer.auditlog.AuditLog
	118, // 90: bucketeer.gateway.ListAuditLogsRequest.order_by:type_name -> bucketeer.auditlog.ListAuditLogsRequest.OrderBy
	119, // 91: bucketeer.gateway.ListAuditLogsRequest.order_direction:type_name -> bucketeer.auditlog.ListAuditLogsRequest.OrderDirection
	85,  // 92: bucketeer.gateway.ListAuditLogsRequest.entity_type:type_name -> google.protobuf.Int32Value
	117, // 93: bucketeer.gateway.ListAuditLogsResponse.audit_logs:type_name -> bucketeer.auditlog.AuditLog
	120, // 94: bucketeer.gateway.ListFeatureHistoryRequest.order_by:type_name -> bucketeer.auditlog.ListFeatureHistoryRequest.OrderBy
	121, // 95: bucketeer.gateway.ListFeatureHistoryRequest.order_direction:type_name -> bucketeer.auditlog.ListFeatureHistoryRequest.OrderDirection
	117, // 96: bucketeer.gateway.ListFeatureHistoryResponse.audit_logs:type_name -> bucketeer.auditlog.AuditLog
	73,  // 97: bucketeer.gateway.RegisterEventsResponse.ErrorsEntry.value:type_name -> bucketeer.gateway.RegisterEventsResponse.Error
	6,   // 98: bucketeer.gateway.Gateway.GetEvaluations:input_type -> bucketeer.gateway.GetEvaluationsRequest
	8,   // 99: bucketeer.gateway.Gateway.GetEvaluation:input_type -> bucketeer.gateway.GetEvaluationRequest
	2,   // 100: bucketeer.gateway.Gateway.GetFeatureFlags:input_type -> bucketeer.gateway.GetFeatureFlagsRequest
	4,   // 101: bucketeer.gateway.Gateway.GetSegmentUsers:input_type -> bucketeer.gateway.GetSegmentUsersRequest
	10,  // 102: bucketeer.gateway.Gateway.RegisterEvents:input_type -> bucketeer.gateway.RegisterEventsRequest
	12,  // 103: bucketeer.gateway.Gateway.Track:input_type -> bucketeer.gateway.TrackRequest
	14,  // 104: bucketeer.gateway.Gateway.DebugEvaluateFeatures:input_type -> bucketeer.gateway.DebugEvaluateFeaturesRequest
	16,  // 105: bucketeer.gateway.Gateway.CreateFeature:input_type -> bucketeer.gateway.CreateFeatureRequest
	18,  // 106: bucketeer.gateway.Gateway.GetFeature:input_type -> bucketeer.gateway.GetFeatureRequest
	20,  // 107: bucketeer.gateway.Gateway.ListFeatures:input_type -> bucketeer.gateway.ListFeaturesRequest
	22,  // 108: bucketeer.gateway.Gateway.UpdateFeature:input_type -> bucketeer.gateway.UpdateFeatureRequest
	0,   // 109: bucketeer.gateway.Gateway.Ping:input_type -> bucketeer.gateway.PingRequest
	24,  // 110: bucketeer.gateway.Gateway.ListPushes:input_type -> bucketeer.gateway.ListPushesRequest
	26,  // 111: bucketeer.gateway.Gateway.CreatePush:input_type -> bucketeer.gateway.CreatePushRequest
	28,  // 112: bucketeer.gateway.Gateway.GetPush:input_type -> bucketeer.gateway.GetPushRequest
	30,  // 113: bucketeer.gateway.Gateway.UpdatePush:input_type -> bucketeer.gateway.UpdatePushRequest
	32,  // 114: bucketeer.gateway.Gateway.CreateAccountV2:input_type -> bucketeer.gateway.CreateAccountV2Request
	34,  // 115: bucketeer.gateway.Gateway.UpdateAccountV2:input_type -> bucketeer.gateway.UpdateAccountV2Request
	36,  // 116: bucketeer.gateway.Gateway.GetAccountV2:input_type -> bucketeer.gateway.GetAccountV2Request
	38,  // 117: bucketeer.gateway.Gateway.GetAccountV2ByEnvironmentID:input_type -> bucketeer.gateway.GetAccountV2ByEnvironmentIDRequest
	40,  // 118: bucketeer.gateway.Gateway.GetMe:input_type -> bucketeer.gateway.GetMeRequest
	42,  // 119: bucketeer.gateway.Gateway.ListAccountsV2:input_type -> bucketeer.gateway.ListAccountsV2Request
	44,  // 120: bucketeer.gateway.Gateway.GetCodeReference:input_type -> bucketeer.gateway.GetCodeReferenceRequest
	46,  // 121: bucketeer.gateway.Gateway.ListCodeReferences:input_type -> bucketeer.gateway.ListCodeReferencesRequest
	48,  // 122: bucketeer.gateway.Gateway.CreateCodeReference:input_type -> bucketeer.gateway.CreateCodeReferenceRequest
	50,  // 123: bucketeer.gateway.Gateway.UpdateCodeReference:input_type -> bucketeer.gateway.UpdateCodeReferenceRequest
	52,  // 124: bucketeer.gateway.Gateway.DeleteCodeReference:input_type -> bucketeer.gateway.DeleteCodeReferenceRequest
	54,  // 125: bucketeer.gateway.Gateway.CreateSegment:input_type -> bucketeer.gateway.CreateSegmentRequest
	56,  // 126: bucketeer.gateway.Gateway.GetSegment:input_type -> bucketeer.gateway.GetSegmentRequest
	58,  // 127: bucketeer.gateway.Gateway.ListSegments:input_type -> bucketeer.gateway.ListSegmentsRequest
	60,  // 128: bucketeer.gateway.Gateway.DeleteSegment:input_type -> bucketeer.gateway.DeleteSegmentRequest
	62,  // 129: bucketeer.gateway.Gateway.UpdateSegment:input_type -> bucketeer.gateway.UpdateSegmentRequest
	64,  // 130: bucketeer.gateway.Gateway.BulkUploadSegmentUsers:input_type -> bucketeer.gateway.BulkUploadSegmentUsersRequest
	66,  // 131: bucketeer.gateway.Gateway.GetAuditLog:input_type -> bucketeer.gateway.GetAuditLogRequest
	68,  // 132: bucketeer.gateway.Gateway.ListAuditLogs:input_type -> bucketeer.gateway.ListAuditLogsRequest
	70,  // 133: bucketeer.gateway.Gateway.ListFeatureHistory:input_type -> bucketeer.gateway.ListFeatureHistoryRequest
	7,   // 134: bucketeer.gateway.Gateway.GetEvaluations:output_type -> bucketeer.gateway.GetEvaluationsResponse
	9,   // 135: bucketeer.gateway.Gateway.GetEvaluation:output_type -> bucketeer.gateway.GetEvaluationResponse
	3,   // 136: bucketeer.gateway.Gateway.GetFeatureFlags:output_type -> bucketeer.gateway.GetFeatureFlagsResponse
	5,   // 137: bucketeer.gateway.Gateway.GetSegmentUsers:output_type -> bucketeer.gateway.GetSegmentUsersResponse
	11,  // 138: bucketeer.gateway.Gateway.RegisterEvents:output_type -> bucketeer.gateway.RegisterEventsResponse
	13,  // 139: bucketeer.gateway.Gateway.Track:output_type -> bucketeer.gateway.TrackResponse
	15,  // 140: bucketeer.gateway.Gateway.DebugEvaluateFeatures:output_type -> bucketeer.gateway.DebugEvaluateFeaturesResponse
	17,  // 141: bucketeer.gateway.Gateway.CreateFeature:output_type -> bucketeer.gateway.CreateFeatureResponse
	19,  // 142: bucketeer.gateway.Gateway.GetFeature:output_type -> bucketeer.gateway.GetFeatureResponse
	21,  // 143: bucketeer.gateway.Gateway.ListFeatures:output_type -> bucketeer.gateway.ListFeaturesResponse
	23,  // 144: bucketeer.gateway.Gateway.UpdateFeature:output_type -> bucketeer.gateway.UpdateFeatureResponse
	1,   // 145: bucketeer.gateway.Gateway.Ping:output_type -> bucketeer.gateway.PingResponse
	25,  // 146: bucketeer.gateway.Gateway.ListPushes:output_type -> bucketeer.gateway.ListPushesResponse
	27,  // 147: bucketeer.gateway.Gateway.CreatePush:output_type -> bucketeer.gateway.CreatePushResponse
	29,  // 148: bucketeer.gateway.Gateway.GetPush:output_type -> bucketeer.gateway.GetPushResponse
	31,  // 149: bucketeer.gateway.Gateway.UpdatePush:output_type -> bucketeer.gateway.UpdatePushResponse
	33,  // 150: bucketeer.gateway.Gateway.CreateAccountV2:output_type -> bucketeer.gateway.CreateAccountV2Response
	35,  // 151: bucketeer.gateway.Gateway.UpdateAccountV2:output_type -> bucketeer.gateway.UpdateAccountV2Response
	37,  // 152: bucketeer.gateway.Gateway.GetAccountV2:output_type -> bucketeer.gateway.GetAccountV2Response
	39,  // 153: bucketeer.gateway.Gateway.GetAccountV2ByEnvironmentID:output_type -> bucketeer.gateway.GetAccountV2ByEnvironmentIDResponse
	41,  // 154: bucketeer.gateway.Gateway.GetMe:output_type -> bucketeer.gateway.GetMeResponse
	43,  // 155: bucketeer.gateway.Gateway.ListAccountsV2:output_type -> bucketeer.gateway.ListAccountsV2Response
	45,  // 156: bucketeer.gateway.Gateway.GetCodeReference:output_type -> bucketeer.gateway.GetCodeReferenceResponse
	47,  // 157: bucketeer.gateway.Gateway.ListCodeReferences:output_type -> bucketeer.gateway.ListCodeReferencesResponse
	49,  // 158: bucketeer.gateway.Gateway.CreateCodeReference:output_type -> bucketeer.gateway.CreateCodeReferenceResponse
	51,  // 159: bucketeer.gateway.Gateway.UpdateCodeReference:output_type -> bucketeer.gateway.UpdateCodeReferenceResponse
	53,  // 160: bucketeer.gateway.Gateway.DeleteCodeReference:output_type -> bucketeer.gateway.DeleteCodeReferenceResponse
	55,  // 161: bucketeer.gateway.Gateway.CreateSegment:output_type -> bucketeer.gateway.CreateSegmentResponse
	57,  // 162: bucketeer.gateway.Gateway.GetSegment:output_type -> bucketeer.gateway.GetSegmentResponse
	59,  // 163: bucketeer.gateway.Gateway.ListSegments:output_type -> bucketeer.gateway.ListSegmentsResponse
	61,  // 164: bucketeer.gateway.Gateway.DeleteSegment:output_type -> bucketeer.gateway.DeleteSegmentResponse
	63,  // 165: bucketeer.gateway.Gateway.UpdateSegment:output_type -> bucketeer.gateway.UpdateSegmentResponse
	65,  // 166: bucketeer.gateway.Gateway.BulkUploadSegmentUsers:output_type -> bucketeer.gateway.BulkUploadSegmentUsersResponse
	67,  // 167: bucketeer.gateway.Gateway.GetAuditLog:output_type -> bucketeer.gateway.GetAuditLogResponse
	69,  // 168: bucketeer.gateway.Gateway.ListAuditLogs:output_type -> bucketeer.gateway.ListAuditLogsResponse
	71,  // 169: bucketeer.gateway.Gateway.ListFeatureHistory:output_type -> bucketeer.gateway.ListFeatureHistoryResponse
	134, // [134:170] is the sub-list for method output_type
	98,  // [98:134] is the sub-list for method input_type
