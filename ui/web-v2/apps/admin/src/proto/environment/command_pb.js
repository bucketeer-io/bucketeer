...
goog.exportSymbol('proto.bucketeer.environment.ChangeRequireCommentCommand', null, global);
...
goog.inherits(proto.bucketeer.environment.ChangeRequireCommentCommand, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.bucketeer.environment.ChangeRequireCommentCommand.displayName = 'proto.bucketeer.environment.ChangeRequireCommentCommand';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @return {boolean}
 */
proto.bucketeer.environment.CreateEnvironmentV2Command.prototype.getRequireComment = function() {
 ...
 * @return {!proto.bucketeer.environment.CreateEnvironmentV2Command} returns this
 */
proto.bucketeer.environment.CreateEnvironmentV2Command.prototype.setRequireComment = function(value) {
 ...
 * @return {!Object}
 */
proto.bucketeer.environment.ChangeRequireCommentCommand.prototype.toObject = function(opt_includeInstance) {
  return proto.bucketeer.environment.ChangeRequireCommentCommand.toObject(opt_includeInstance, this);
};
 ...
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.bucketeer.environment.ChangeRequireCommentCommand.toObject = function(includeInstance, msg) {
  var f, obj = {
 ...
 */
proto.bucketeer.environment.ChangeRequireCommentCommand.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.bucketeer.environment.ChangeRequireCommentCommand;
  return proto.bucketeer.environment.ChangeRequireCommentCommand.deserializeBinaryFromReader(msg, reader);
};
 ...
 * @return {!proto.bucketeer.environment.ChangeRequireCommentCommand}
 */
proto.bucketeer.environment.ChangeRequireCommentCommand.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.bucketeer.environment.ChangeRequireCommentCommand.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.bucketeer.environment.ChangeRequireCommentCommand.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.bucketeer.environment.ChangeRequireCommentCommand.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getRequireComment();
  if (f) {
    writer.writeBool(
 ...
 * @return {boolean}
 */
proto.bucketeer.environment.ChangeRequireCommentCommand.prototype.getRequireComment = function() {
 ...
 */
proto.bucketeer.environment.ChangeRequireCommentCommand.prototype.setRequireComment = function(value) {
