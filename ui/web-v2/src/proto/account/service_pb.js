...
goog.exportSymbol('proto.bucketeer.account.ChangeType', null, global);
...
goog.exportSymbol('proto.bucketeer.account.TeamChange', null, global);
 ...
 * @constructor
 */
proto.bucketeer.account.TeamChange = function (opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.bucketeer.account.TeamChange, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.bucketeer.account.TeamChange.displayName =
...
if (jspb.Message.GENERATE_TO_OBJECT) {
   ...
   * @return {!Object}
   */
  proto.bucketeer.account.TeamChange.prototype.toObject = function (
    opt_includeInstance
  ) {
    return proto.bucketeer.account.TeamChange.toObject(
      opt_includeInstance,
      this
    );
  };
   ...
   *     the JSPB instance for transitional soy proto support:
   *     http://goto/soy-param-migration
   * @param {!proto.bucketeer.account.TeamChange} msg The msg instance to transform.
   * @return {!Object}
   * @suppress {unusedLocalVariables} f is only used for nested messages
   */
  proto.bucketeer.account.TeamChange.toObject = function (
    includeInstance,
    msg
  ) {
    var f,
 ...
 */
proto.bucketeer.account.TeamChange.deserializeBinary = function (bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.bucketeer.account.TeamChange();
  return proto.bucketeer.account.TeamChange.deserializeBinaryFromReader(
    msg,
    reader
  );
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.bucketeer.account.TeamChange} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.bucketeer.account.TeamChange}
 */
proto.bucketeer.account.TeamChange.deserializeBinaryFromReader = function (
  msg,
  reader
) {
  while (reader.nextField()) {
    ...
    switch (field) {
      case 1:
        var value = /** @type {!proto.bucketeer.account.ChangeType} */ (
          reader.readEnum()
        );
 ...
 * @return {!Uint8Array}
 */
proto.bucketeer.account.TeamChange.prototype.serializeBinary = function () {
  var writer = new jspb.BinaryWriter();
  proto.bucketeer.account.TeamChange.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.bucketeer.account.TeamChange} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.bucketeer.account.TeamChange.serializeBinaryToWriter = function (
  message,
  writer
) {
  var f = undefined;
 ...
 * @return {!proto.bucketeer.account.ChangeType}
 */
proto.bucketeer.account.TeamChange.prototype.getChangeType = function () {
  return /** @type {!proto.bucketeer.account.ChangeType} */ (
    jspb.Message.getFieldWithDefault(this, 1, 0)
  );
};

/**
 * @param {!proto.bucketeer.account.ChangeType} value
 * @return {!proto.bucketeer.account.TeamChange} returns this
 */
proto.bucketeer.account.TeamChange.prototype.setChangeType = function (value) {
 ...
 * @return {string}
 */
proto.bucketeer.account.TeamChange.prototype.getTeam = function () {
 ...
 * @return {!proto.bucketeer.account.TeamChange} returns this
 */
proto.bucketeer.account.TeamChange.prototype.setTeam = function (value) {
  return jspb.Message.setProto3StringField(this, 2, value);
};
    ...
    while (reader.nextField()) {
      ...
      switch (field) {
        ...
        case 23:
          ...
          break;
        case 24:
          var value = new proto.bucketeer.account.TeamChange();
          reader.readMessage(
            value,
 ...
 * @enum {number}
 */
proto.bucketeer.account.ChangeType = {
  UNSPECIFIED: 0,
  CREATE: 1,
  UPDATE: 2,
  DELETE: 3
