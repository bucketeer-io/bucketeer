...
export class Subscription extends jspb.Message {
  ...
  >;
  setSourceTypesList(
    value: Array<Subscription.SourceTypeMap[keyof Subscription.SourceTypeMap]>
  ): void;
  addSourceTypes(
    value: Subscription.SourceTypeMap[keyof Subscription.SourceTypeMap],
    index?: number
  ): Subscription.SourceTypeMap[keyof Subscription.SourceTypeMap];
...
export namespace Subscription {
  ...
  export interface SourceTypeMap {
    ...
    DOMAIN_EVENT_DEMO_ORGANIZATION: 20;
    FEATURE_STALE: 100;
