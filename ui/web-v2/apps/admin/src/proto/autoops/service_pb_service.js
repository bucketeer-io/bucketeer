...
AutoOpsService.CreateFlagTrigger = {
  methodName: "CreateFlagTrigger",
  service: AutoOpsService,
  requestStream: false,
  responseStream: false,
  requestType: proto_autoops_service_pb.CreateFlagTriggerRequest,
...
AutoOpsService.ResetFlagTrigger = {
  ...
  requestStream: false,
  responseStream: false,
  requestType: proto_autoops_service_pb.ResetFlagTriggerRequest,
  responseType: proto_autoops_service_pb.ResetFlagTriggerResponse
};

AutoOpsService.DeleteFlagTrigger = {
  methodName: "DeleteFlagTrigger",
  service: AutoOpsService,
  requestStream: false,
  responseStream: false,
  requestType: proto_autoops_service_pb.DeleteFlagTriggerRequest,
  responseType: proto_autoops_service_pb.DeleteFlagTriggerResponse
};

AutoOpsService.GetFlagTrigger = {
  methodName: "GetFlagTrigger",
  service: AutoOpsService,
  requestStream: false,
  responseStream: false,
  requestType: proto_autoops_service_pb.GetFlagTriggerRequest,
  responseType: proto_autoops_service_pb.GetFlagTriggerResponse
};

AutoOpsService.ListFlagTriggers = {
  methodName: "ListFlagTriggers",
  service: AutoOpsService,
  requestStream: false,
  responseStream: false,
  requestType: proto_autoops_service_pb.ListFlagTriggersRequest,
  responseType: proto_autoops_service_pb.ListFlagTriggersResponse
};
...
AutoOpsServiceClient.prototype.createFlagTrigger = function createFlagTrigger(requestMessage, metadata, callback) {
  if (arguments.length === 2) {
    callback = arguments[1];
  }
  var client = grpc.unary(AutoOpsService.CreateFlagTrigger, {
    request: requestMessage,
    host: this.serviceHost,
    metadata: metadata,
    transport: this.options.transport,
...
AutoOpsServiceClient.prototype.resetFlagTrigger = function resetFlagTrigger(requestMessage, metadata, callback) {
  if (arguments.length === 2) {
    callback = arguments[1];
  }
  var client = grpc.unary(AutoOpsService.ResetFlagTrigger, {
    request: requestMessage,
    host: this.serviceHost,
    metadata: metadata,
    transport: this.options.transport,
...
AutoOpsServiceClient.prototype.deleteFlagTrigger = function deleteFlagTrigger(requestMessage, metadata, callback) {
  if (arguments.length === 2) {
    callback = arguments[1];
  }
  var client = grpc.unary(AutoOpsService.DeleteFlagTrigger, {
    request: requestMessage,
    host: this.serviceHost,
    metadata: metadata,
    transport: this.options.transport,
...
AutoOpsServiceClient.prototype.getFlagTrigger = function getFlagTrigger(requestMessage, metadata, callback) {
  if (arguments.length === 2) {
    callback = arguments[1];
  }
  var client = grpc.unary(AutoOpsService.GetFlagTrigger, {
    request: requestMessage,
    host: this.serviceHost,
    metadata: metadata,
    transport: this.options.transport,
...
AutoOpsServiceClient.prototype.listFlagTriggers = function listFlagTriggers(requestMessage, metadata, callback) {
  if (arguments.length === 2) {
    callback = arguments[1];
  }
  var client = grpc.unary(AutoOpsService.ListFlagTriggers, {
    request: requestMessage,
    host: this.serviceHost,
    metadata: metadata,
    transport: this.options.transport,
