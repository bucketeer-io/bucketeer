...
type UserAttributes struct {
	...
	UserAttributes []*UserAttribute `protobuf:"bytes,2,rep,name=user_attributes,json=userAttributes,proto3" json:"user_attributes"`
}
...
func (x *UserAttributes) GetEnvironmentId() string {
	if x != nil {
...
func (x *UserAttributes) GetUserAttributes() []*UserAttribute {
	if x != nil {
...
var file_proto_user_user_proto_rawDesc = []byte{
	...
	0x61, 0x6c, 0x75, 0x65, 0x3a, 0x02, 0x38, 0x01, 0x22, 0x7f, 0x0a, 0x0e, 0x55, 0x73, 0x65, 0x72,
	0x41, 0x74, 0x74, 0x72, 0x69, 0x62, 0x75, 0x74, 0x65, 0x73, 0x12, 0x25, 0x0a, 0x0e, 0x65, 0x6e,
	...
	0x64, 0x12, 0x46, 0x0a, 0x0f, 0x75, 0x73, 0x65, 0x72, 0x5f, 0x61, 0x74, 0x74, 0x72, 0x69, 0x62,
	0x75, 0x74, 0x65, 0x73, 0x18, 0x02, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x1d, 0x2e, 0x62, 0x75, 0x63,
	0x6b, 0x65, 0x74, 0x65, 0x65, 0x72, 0x2e, 0x75, 0x73, 0x65, 0x72, 0x2e, 0x55, 0x73, 0x65, 0x72,
	0x41, 0x74, 0x74, 0x72, 0x69, 0x62, 0x75, 0x74, 0x65, 0x52, 0x0e, 0x75, 0x73, 0x65, 0x72, 0x41,
	0x74, 0x74, 0x72, 0x69, 0x62, 0x75, 0x74, 0x65, 0x73, 0x22, 0x39, 0x0a, 0x0d, 0x55, 0x73, 0x65,
	...
	0x6c, 0x75, 0x65, 0x73, 0x42, 0x31, 0x5a, 0x2f, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63,
...
var file_proto_user_user_proto_goTypes = []interface{}{
	...
	(*UserAttributes)(nil), // 1: bucketeer.user.UserAttributes
	(*UserAttribute)(nil),  // 2: bucketeer.user.UserAttribute
	(*User_Data)(nil),      // 3: bucketeer.user.User.Data
	nil,                    // 4: bucketeer.user.User.DataEntry
	nil,                    // 5: bucketeer.user.User.TaggedDataEntry
	nil,                    // 6: bucketeer.user.User.Data.ValueEntry
}
var file_proto_user_user_proto_depIdxs = []int32{
	4, // 0: bucketeer.user.User.data:type_name -> bucketeer.user.User.DataEntry
	5, // 1: bucketeer.user.User.tagged_data:type_name -> bucketeer.user.User.TaggedDataEntry
	2, // 2: bucketeer.user.UserAttributes.user_attributes:type_name -> bucketeer.user.UserAttribute
	6, // 3: bucketeer.user.User.Data.value:type_name -> bucketeer.user.User.Data.ValueEntry
	3, // 4: bucketeer.user.User.TaggedDataEntry.value:type_name -> bucketeer.user.User.Data
