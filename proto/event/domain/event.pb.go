...
var file_proto_event_domain_event_proto_rawDesc = []byte{
	...
	0x52, 0x10, 0x10, 0x22, 0x04, 0x08, 0x0d, 0x10, 0x0d, 0x22, 0x82, 0x26, 0x0a, 0x04, 0x54, 0x79,
	...
	0x6e, 0x74, 0x12, 0x0e, 0x0a, 0x02, 0x69, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x02,
	0x69, 0x64, 0x22, 0xc6, 0x01, 0x0a, 0x12, 0x41, 0x50, 0x49, 0x4b, 0x65, 0x79, 0x43, 0x72, 0x65,
	...
	0x52, 0x09, 0x75, 0x70, 0x64, 0x61, 0x74, 0x65, 0x64, 0x41, 0x74, 0x22, 0x3c, 0x0a, 0x16, 0x41,
	...
	0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x02, 0x69, 0x64, 0x22, 0x3d, 0x0a, 0x17, 0x53, 0x65,
	...
	0x04, 0x6e, 0x61, 0x6d, 0x65, 0x22, 0xc3, 0x01, 0x0a, 0x18, 0x53, 0x75, 0x62, 0x73, 0x63, 0x72,
	...
	0x03, 0x20, 0x01, 0x28, 0x09, 0x52, 0x04, 0x6e, 0x61, 0x6d, 0x65, 0x22, 0x1a, 0x0a, 0x18, 0x53,
	...
	0x6e, 0x61, 0x6d, 0x65, 0x22, 0xc8, 0x01, 0x0a, 0x1d, 0x41, 0x64, 0x6d, 0x69, 0x6e, 0x53, 0x75,
	...
	0x43, 0x6f, 0x64, 0x65, 0x22, 0x52, 0x0a, 0x1e, 0x50, 0x72, 0x6f, 0x6a, 0x65, 0x63, 0x74, 0x44,
	0x65, 0x73, 0x63, 0x72, 0x69, 0x70, 0x74, 0x69, 0x6f, 0x6e, 0x43, 0x68, 0x61, 0x6e, 0x67, 0x65,
	0x64, 0x45, 0x76, 0x65, 0x6e, 0x74, 0x12, 0x0e, 0x0a, 0x02, 0x69, 0x64, 0x18, 0x01, 0x20, 0x01,
...
var file_proto_event_domain_event_proto_msgTypes = make([]protoimpl.MessageInfo, 158)
var file_proto_event_domain_event_proto_goTypes = []interface{}{
	...
	(*OrganizationNameChangedEvent)(nil),                      // 147: bucketeer.event.domain.OrganizationNameChangedEvent
	(*OrganizationEnabledEvent)(nil),                          // 148: bucketeer.event.domain.OrganizationEnabledEvent
	(*OrganizationDisabledEvent)(nil),                         // 149: bucketeer.event.domain.OrganizationDisabledEvent
	(*OrganizationArchivedEvent)(nil),                         // 150: bucketeer.event.domain.OrganizationArchivedEvent
	(*OrganizationUnarchivedEvent)(nil),                       // 151: bucketeer.event.domain.OrganizationUnarchivedEvent
	(*OrganizationTrialConvertedEvent)(nil),                   // 152: bucketeer.event.domain.OrganizationTrialConvertedEvent
	(*FlagTriggerCreatedEvent)(nil),                           // 153: bucketeer.event.domain.FlagTriggerCreatedEvent
	(*FlagTriggerResetEvent)(nil),                             // 154: bucketeer.event.domain.FlagTriggerResetEvent
	(*FlagTriggerDescriptionChangedEvent)(nil),                // 155: bucketeer.event.domain.FlagTriggerDescriptionChangedEvent
	(*FlagTriggerDisabledEvent)(nil),                          // 156: bucketeer.event.domain.FlagTriggerDisabledEvent
	(*FlagTriggerEnabledEvent)(nil),                           // 157: bucketeer.event.domain.FlagTriggerEnabledEvent
	(*FlagTriggerDeletedEvent)(nil),                           // 158: bucketeer.event.domain.FlagTriggerDeletedEvent
	(*FlagTriggerUsageUpdatedEvent)(nil),                      // 159: bucketeer.event.domain.FlagTriggerUsageUpdatedEvent
	...
	(account.FilterTargetType)(0),                             // 174: bucketeer.account.FilterTargetType
	(account.APIKey_Role)(0),                                  // 175: bucketeer.account.APIKey.Role
	(feature.SegmentUser_State)(0),                            // 176: bucketeer.feature.SegmentUser.State
	(feature.Segment_Status)(0),                               // 177: bucketeer.feature.Segment.Status
	(autoops.OpsType)(0),                                      // 178: bucketeer.autoops.OpsType
	(*autoops.Clause)(nil),                                    // 179: bucketeer.autoops.Clause
	(autoops.AutoOpsStatus)(0),                                // 180: bucketeer.autoops.AutoOpsStatus
	(*autoops.OpsEventRateClause)(nil),                        // 181: bucketeer.autoops.OpsEventRateClause
	(*autoops.DatetimeClause)(nil),                            // 182: bucketeer.autoops.DatetimeClause
	(notification.Subscription_SourceType)(0),                 // 183: bucketeer.notification.Subscription.SourceType
	(*notification.Recipient)(nil),                            // 184: bucketeer.notification.Recipient
	(autoops.ProgressiveRollout_Type)(0),                      // 185: bucketeer.autoops.ProgressiveRollout.Type
	(autoops.ProgressiveRollout_Status)(0),                    // 186: bucketeer.autoops.ProgressiveRollout.Status
	(autoops.ProgressiveRollout_StoppedBy)(0),                 // 187: bucketeer.autoops.ProgressiveRollout.StoppedBy
	(feature.FlagTrigger_Type)(0),                             // 188: bucketeer.feature.FlagTrigger.Type
	(feature.FlagTrigger_Action)(0),                           // 189: bucketeer.feature.FlagTrigger.Action
}
var file_proto_event_domain_event_proto_depIdxs = []int32{
	...
	160, // 3: bucketeer.event.domain.Event.data:type_name -> google.protobuf.Any
	4,   // 4: bucketeer.event.domain.Event.options:type_name -> bucketeer.event.domain.Options
	161, // 5: bucketeer.event.domain.FeatureCreatedEvent.variations:type_name -> bucketeer.feature.Variation
	162, // 6: bucketeer.event.domain.FeatureCreatedEvent.default_on_variation_index:type_name -> google.protobuf.Int32Value
	162, // 7: bucketeer.event.domain.FeatureCreatedEvent.default_off_variation_index:type_name -> google.protobuf.Int32Value
	163, // 8: bucketeer.event.domain.FeatureCreatedEvent.variation_type:type_name -> bucketeer.feature.Feature.VariationType
	164, // 9: bucketeer.event.domain.FeatureCreatedEvent.prerequisites:type_name -> bucketeer.feature.Prerequisite
	165, // 10: bucketeer.event.domain.FeatureCreatedEvent.rules:type_name -> bucketeer.feature.Rule
	166, // 11: bucketeer.event.domain.FeatureCreatedEvent.targets:type_name -> bucketeer.feature.Target
	161, // 12: bucketeer.event.domain.FeatureVariationAddedEvent.variation:type_name -> bucketeer.feature.Variation
	165, // 13: bucketeer.event.domain.FeatureRuleAddedEvent.rule:type_name -> bucketeer.feature.Rule
	167, // 14: bucketeer.event.domain.FeatureChangeRuleStrategyEvent.strategy:type_name -> bucketeer.feature.Strategy
	168, // 15: bucketeer.event.domain.FeatureFixedStrategyChangedEvent.strategy:type_name -> bucketeer.feature.FixedStrategy
	169, // 16: bucketeer.event.domain.FeatureRolloutStrategyChangedEvent.strategy:type_name -> bucketeer.feature.RolloutStrategy
	170, // 17: bucketeer.event.domain.RuleClauseAddedEvent.clause:type_name -> bucketeer.feature.Clause
	171, // 18: bucketeer.event.domain.ClauseOperatorChangedEvent.operator:type_name -> bucketeer.feature.Clause.Operator
	167, // 19: bucketeer.event.domain.FeatureDefaultStrategyChangedEvent.strategy:type_name -> bucketeer.feature.Strategy
	161, // 20: bucketeer.event.domain.FeatureClonedEvent.variations:type_name -> bucketeer.feature.Variation
	166, // 21: bucketeer.event.domain.FeatureClonedEvent.targets:type_name -> bucketeer.feature.Target
	165, // 22: bucketeer.event.domain.FeatureClonedEvent.rules:type_name -> bucketeer.feature.Rule
	167, // 23: bucketeer.event.domain.FeatureClonedEvent.default_strategy:type_name -> bucketeer.feature.Strategy
	163, // 24: bucketeer.event.domain.FeatureClonedEvent.variation_type:type_name -> bucketeer.feature.Feature.VariationType
	164, // 25: bucketeer.event.domain.FeatureClonedEvent.prerequisites:type_name -> bucketeer.feature.Prerequisite
	161, // 26: bucketeer.event.domain.ExperimentCreatedEvent.variations:type_name -> bucketeer.feature.Variation
	172, // 27: bucketeer.event.domain.AccountV2CreatedEvent.organization_role:type_name -> bucketeer.account.AccountV2.Role.Organization
	173, // 28: bucketeer.event.domain.AccountV2CreatedEvent.environment_roles:type_name -> bucketeer.account.AccountV2.EnvironmentRole
	172, // 29: bucketeer.event.domain.AccountV2OrganizationRoleChangedEvent.organization_role:type_name -> bucketeer.account.AccountV2.Role.Organization
	173, // 30: bucketeer.event.domain.AccountV2EnvironmentRolesChangedEvent.environment_roles:type_name -> bucketeer.account.AccountV2.EnvironmentRole
	174, // 31: bucketeer.event.domain.SearchFilterCreatedEvent.TargetType:type_name -> bucketeer.account.FilterTargetType
	175, // 32: bucketeer.event.domain.APIKeyCreatedEvent.role:type_name -> bucketeer.account.APIKey.Role
	165, // 33: bucketeer.event.domain.SegmentRuleAddedEvent.rule:type_name -> bucketeer.feature.Rule
	170, // 34: bucketeer.event.domain.SegmentRuleClauseAddedEvent.clause:type_name -> bucketeer.feature.Clause
	171, // 35: bucketeer.event.domain.SegmentClauseOperatorChangedEvent.operator:type_name -> bucketeer.feature.Clause.Operator
	176, // 36: bucketeer.event.domain.SegmentUserAddedEvent.state:type_name -> bucketeer.feature.SegmentUser.State
	176, // 37: bucketeer.event.domain.SegmentUserDeletedEvent.state:type_name -> bucketeer.feature.SegmentUser.State
	177, // 38: bucketeer.event.domain.SegmentBulkUploadUsersEvent.status:type_name -> bucketeer.feature.Segment.Status
	176, // 39: bucketeer.event.domain.SegmentBulkUploadUsersEvent.state:type_name -> bucketeer.feature.SegmentUser.State
	177, // 40: bucketeer.event.domain.SegmentBulkUploadUsersStatusChangedEvent.status:type_name -> bucketeer.feature.Segment.Status
	176, // 41: bucketeer.event.domain.SegmentBulkUploadUsersStatusChangedEvent.state:type_name -> bucketeer.feature.SegmentUser.State
	178, // 42: bucketeer.event.domain.AutoOpsRuleCreatedEvent.ops_type:type_name -> bucketeer.autoops.OpsType
	179, // 43: bucketeer.event.domain.AutoOpsRuleCreatedEvent.clauses:type_name -> bucketeer.autoops.Clause
	180, // 44: bucketeer.event.domain.AutoOpsRuleCreatedEvent.ops_status:type_name -> bucketeer.autoops.AutoOpsStatus
	178, // 45: bucketeer.event.domain.AutoOpsRuleOpsTypeChangedEvent.ops_type:type_name -> bucketeer.autoops.OpsType
	180, // 46: bucketeer.event.domain.AutoOpsRuleOpsStatusChangedEvent.ops_status:type_name -> bucketeer.autoops.AutoOpsStatus
	181, // 47: bucketeer.event.domain.OpsEventRateClauseAddedEvent.ops_event_rate_clause:type_name -> bucketeer.autoops.OpsEventRateClause
	181, // 48: bucketeer.event.domain.OpsEventRateClauseChangedEvent.ops_event_rate_clause:type_name -> bucketeer.autoops.OpsEventRateClause
	182, // 49: bucketeer.event.domain.DatetimeClauseAddedEvent.datetime_clause:type_name -> bucketeer.autoops.DatetimeClause
	182, // 50: bucketeer.event.domain.DatetimeClauseChangedEvent.datetime_clause:type_name -> bucketeer.autoops.DatetimeClause
	183, // 51: bucketeer.event.domain.SubscriptionCreatedEvent.source_types:type_name -> bucketeer.notification.Subscription.SourceType
	184, // 52: bucketeer.event.domain.SubscriptionCreatedEvent.recipient:type_name -> bucketeer.notification.Recipient
	183, // 53: bucketeer.event.domain.SubscriptionSourceTypesAddedEvent.source_types:type_name -> bucketeer.notification.Subscription.SourceType
	183, // 54: bucketeer.event.domain.SubscriptionSourceTypesDeletedEvent.source_types:type_name -> bucketeer.notification.Subscription.SourceType
	183, // 55: bucketeer.event.domain.AdminSubscriptionCreatedEvent.source_types:type_name -> bucketeer.notification.Subscription.SourceType
	184, // 56: bucketeer.event.domain.AdminSubscriptionCreatedEvent.recipient:type_name -> bucketeer.notification.Recipient
	183, // 57: bucketeer.event.domain.AdminSubscriptionSourceTypesAddedEvent.source_types:type_name -> bucketeer.notification.Subscription.SourceType
	183, // 58: bucketeer.event.domain.AdminSubscriptionSourceTypesDeletedEvent.source_types:type_name -> bucketeer.notification.Subscription.SourceType
	164, // 59: bucketeer.event.domain.PrerequisiteAddedEvent.prerequisite:type_name -> bucketeer.feature.Prerequisite
	164, // 60: bucketeer.event.domain.PrerequisiteVariationChangedEvent.prerequisite:type_name -> bucketeer.feature.Prerequisite
	160, // 61: bucketeer.event.domain.ProgressiveRolloutCreatedEvent.clause:type_name -> google.protobuf.Any
	185, // 62: bucketeer.event.domain.ProgressiveRolloutCreatedEvent.type:type_name -> bucketeer.autoops.ProgressiveRollout.Type
	186, // 63: bucketeer.event.domain.ProgressiveRolloutStoppedEvent.status:type_name -> bucketeer.autoops.ProgressiveRollout.Status
	187, // 64: bucketeer.event.domain.ProgressiveRolloutStoppedEvent.stopped_by:type_name -> bucketeer.autoops.ProgressiveRollout.StoppedBy
	188, // 65: bucketeer.event.domain.FlagTriggerCreatedEvent.type:type_name -> bucketeer.feature.FlagTrigger.Type
	189, // 66: bucketeer.event.domain.FlagTriggerCreatedEvent.action:type_name -> bucketeer.feature.FlagTrigger.Action
