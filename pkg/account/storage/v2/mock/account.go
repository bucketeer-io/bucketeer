...
//
//	mockgen -source=account.go -package=mock -destination=./mock/account.go
//
...
func (m *MockAccountStorage) GetAvatarAccountsV2(ctx context.Context, params v2.GetAvatarAccountsV2Params) ([]*account.AccountV2, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetAvatarAccountsV2", ctx, params)
...
func (mr *MockAccountStorageMockRecorder) GetAvatarAccountsV2(ctx, params any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetAvatarAccountsV2", reflect.TypeOf((*MockAccountStorage)(nil).GetAvatarAccountsV2), ctx, params)
}
...
func (m *MockAccountStorage) ListAPIKeys(ctx context.Context, params v2.ListAPIKeysParams) ([]*account.APIKey, int, int64, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "ListAPIKeys", ctx, params)
...
func (mr *MockAccountStorageMockRecorder) ListAPIKeys(ctx, params any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ListAPIKeys", reflect.TypeOf((*MockAccountStorage)(nil).ListAPIKeys), ctx, params)
}

// ListAccountsV2 mocks base method.
func (m *MockAccountStorage) ListAccountsV2(ctx context.Context, params v2.ListAccountsV2Params) ([]*account.AccountV2, int, int64, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "ListAccountsV2", ctx, params)
	ret0, _ := ret[0].([]*account.AccountV2)
	ret1, _ := ret[1].(int)
	ret2, _ := ret[2].(int64)
	ret3, _ := ret[3].(error)
...
func (mr *MockAccountStorageMockRecorder) ListAccountsV2(ctx, params any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ListAccountsV2", reflect.TypeOf((*MockAccountStorage)(nil).ListAccountsV2), ctx, params)
}
