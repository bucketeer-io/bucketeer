...
export class ListAuditLogsRequest extends jspb.Message {
  ...
  setOrderDirection(
    value: ListAuditLogsRequest.OrderDirectionMap[keyof ListAuditLogsRequest.OrderDirectionMap]
  ): void;
  ...
  static toObject(
    ...
    msg: ListAuditLogsRequest
  ): ListAuditLogsRequest.AsObject;
...
export class ListAuditLogsResponse extends jspb.Message {
  ...
  addAuditLogs(
    value?: proto_auditlog_auditlog_pb.AuditLog,
    index?: number
  ): proto_auditlog_auditlog_pb.AuditLog;
...
export class ListAdminAuditLogsRequest extends jspb.Message {
  ...
  setOrderBy(
    value: ListAdminAuditLogsRequest.OrderByMap[keyof ListAdminAuditLogsRequest.OrderByMap]
  ): void;

  getOrderDirection(): ListAdminAuditLogsRequest.OrderDirectionMap[keyof ListAdminAuditLogsRequest.OrderDirectionMap];
  setOrderDirection(
    value: ListAdminAuditLogsRequest.OrderDirectionMap[keyof ListAdminAuditLogsRequest.OrderDirectionMap]
  ): void;
  ...
  static toObject(
    includeInstance: boolean,
    msg: ListAdminAuditLogsRequest
  ): ListAdminAuditLogsRequest.AsObject;
  static extensions: { [key: number]: jspb.ExtensionFieldInfo<jspb.Message> };
  static extensionsBinary: {
    [key: number]: jspb.ExtensionFieldBinaryInfo<jspb.Message>;
  };
...
export class ListAdminAuditLogsResponse extends jspb.Message {
  ...
  static toObject(
    includeInstance: boolean,
    msg: ListAdminAuditLogsResponse
...
export class ListFeatureHistoryRequest extends jspb.Message {
  ...
  setOrderDirection(
    value: ListFeatureHistoryRequest.OrderDirectionMap[keyof ListFeatureHistoryRequest.OrderDirectionMap]
  ): void;
  ...
  static toObject(
    includeInstance: boolean,
    msg: ListFeatureHistoryRequest
  ): ListFeatureHistoryRequest.AsObject;
  static extensions: { [key: number]: jspb.ExtensionFieldInfo<jspb.Message> };
  static extensionsBinary: {
    [key: number]: jspb.ExtensionFieldBinaryInfo<jspb.Message>;
  };
...
export class ListFeatureHistoryResponse extends jspb.Message {
  ...
  static toObject(
    includeInstance: boolean,
    msg: ListFeatureHistoryResponse
