...
func TestArchiveEnvironmentV2(t *testing.T) {
	...
	patterns := []struct {
	...
	}{
		{
			...
			req:         &proto.ArchiveEnvironmentV2Request{Id: "id01"},
			expectedErr: statusEnvironmentNotFound.Err(),
		},
		{
			desc: "err: ErrInternal",
			...
			req:         &proto.ArchiveEnvironmentV2Request{Id: "id02"},
			expectedErr: api.NewGRPCStatus(pkgErr.NewErrorInternal(pkgErr.EnvironmentPackageName, "error")).Err(),
		},
		{
			desc: "success",
...
func TestUnarchiveEnvironmentV2(t *testing.T) {
	...
	patterns := []struct {
	...
	}{
		{
			...
			req:         &proto.UnarchiveEnvironmentV2Request{Id: "id01"},
			expectedErr: statusEnvironmentNotFound.Err(),
		},
		{
			desc: "err: ErrInternal",
			...
			req:         &proto.UnarchiveEnvironmentV2Request{Id: "id02"},
			expectedErr: api.NewGRPCStatus(pkgErr.NewErrorInternal(pkgErr.EnvironmentPackageName, "error")).Err(),
		},
		{
			desc: "success",
