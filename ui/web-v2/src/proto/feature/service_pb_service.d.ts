...
export class FeatureServiceClient {
  ...
  getFeature(
    ...
    callback: (
      ...
      responseMessage: proto_feature_service_pb.GetFeatureResponse | null
    ) => void
  ): UnaryResponse;
  getFeature(
    requestMessage: proto_feature_service_pb.GetFeatureRequest,
  ...
  getFeatures(
    ...
    callback: (
      error: ServiceError | null,
      responseMessage: proto_feature_service_pb.GetFeaturesResponse | null
    ) => void
  ): UnaryResponse;
  getFeatures(
    requestMessage: proto_feature_service_pb.GetFeaturesRequest,
  ...
  listFeatures(
    ...
    callback: (
      error: ServiceError | null,
      responseMessage: proto_feature_service_pb.ListFeaturesResponse | null
    ) => void
  ): UnaryResponse;
  listFeatures(
    requestMessage: proto_feature_service_pb.ListFeaturesRequest,
  ...
  listEnabledFeatures(
    ...
    callback: (
      error: ServiceError | null,
      responseMessage: proto_feature_service_pb.ListEnabledFeaturesResponse | null
    ) => void
  ): UnaryResponse;
  listEnabledFeatures(
    requestMessage: proto_feature_service_pb.ListEnabledFeaturesRequest,
  ...
  createFeature(
    ...
    callback: (
      error: ServiceError | null,
      responseMessage: proto_feature_service_pb.CreateFeatureResponse | null
    ) => void
  ): UnaryResponse;
  createFeature(
    requestMessage: proto_feature_service_pb.CreateFeatureRequest,
  ...
  enableFeature(
    ...
    callback: (
      error: ServiceError | null,
      responseMessage: proto_feature_service_pb.EnableFeatureResponse | null
    ) => void
  ): UnaryResponse;
  enableFeature(
    requestMessage: proto_feature_service_pb.EnableFeatureRequest,
  ...
  disableFeature(
    ...
    callback: (
      error: ServiceError | null,
      responseMessage: proto_feature_service_pb.DisableFeatureResponse | null
    ) => void
  ): UnaryResponse;
  disableFeature(
    requestMessage: proto_feature_service_pb.DisableFeatureRequest,
  ...
  archiveFeature(
    ...
    callback: (
      error: ServiceError | null,
      responseMessage: proto_feature_service_pb.ArchiveFeatureResponse | null
    ) => void
  ): UnaryResponse;
  archiveFeature(
    requestMessage: proto_feature_service_pb.ArchiveFeatureRequest,
  ...
  unarchiveFeature(
    ...
    callback: (
      error: ServiceError | null,
      responseMessage: proto_feature_service_pb.UnarchiveFeatureResponse | null
    ) => void
  ): UnaryResponse;
  unarchiveFeature(
    requestMessage: proto_feature_service_pb.UnarchiveFeatureRequest,
  ...
  deleteFeature(
    ...
    callback: (
      error: ServiceError | null,
      responseMessage: proto_feature_service_pb.DeleteFeatureResponse | null
    ) => void
  ): UnaryResponse;
  deleteFeature(
    requestMessage: proto_feature_service_pb.DeleteFeatureRequest,
  ...
  updateFeatureDetails(
    ...
    callback: (
      error: ServiceError | null,
      responseMessage: proto_feature_service_pb.UpdateFeatureDetailsResponse | null
    ) => void
  ): UnaryResponse;
  updateFeatureDetails(
    requestMessage: proto_feature_service_pb.UpdateFeatureDetailsRequest,
  ...
  updateFeatureVariations(
    ...
    callback: (
      error: ServiceError | null,
      responseMessage: proto_feature_service_pb.UpdateFeatureVariationsResponse | null
    ) => void
  ): UnaryResponse;
  updateFeatureVariations(
    requestMessage: proto_feature_service_pb.UpdateFeatureVariationsRequest,
  ...
  updateFeatureTargeting(
    ...
    callback: (
      error: ServiceError | null,
      responseMessage: proto_feature_service_pb.UpdateFeatureTargetingResponse | null
    ) => void
  ): UnaryResponse;
  updateFeatureTargeting(
    requestMessage: proto_feature_service_pb.UpdateFeatureTargetingRequest,
  ...
  cloneFeature(
    ...
    callback: (
      error: ServiceError | null,
      responseMessage: proto_feature_service_pb.CloneFeatureResponse | null
    ) => void
  ): UnaryResponse;
  cloneFeature(
    requestMessage: proto_feature_service_pb.CloneFeatureRequest,
  ...
  createSegment(
    ...
    callback: (
      error: ServiceError | null,
      responseMessage: proto_feature_service_pb.CreateSegmentResponse | null
    ) => void
  ): UnaryResponse;
  createSegment(
    requestMessage: proto_feature_service_pb.CreateSegmentRequest,
  ...
  getSegment(
    ...
    callback: (
      error: ServiceError | null,
      responseMessage: proto_feature_service_pb.GetSegmentResponse | null
    ) => void
  ): UnaryResponse;
  getSegment(
    requestMessage: proto_feature_service_pb.GetSegmentRequest,
  ...
  listSegments(
    ...
    callback: (
      error: ServiceError | null,
      responseMessage: proto_feature_service_pb.ListSegmentsResponse | null
    ) => void
  ): UnaryResponse;
  listSegments(
    requestMessage: proto_feature_service_pb.ListSegmentsRequest,
  ...
  deleteSegment(
    ...
    callback: (
      error: ServiceError | null,
      responseMessage: proto_feature_service_pb.DeleteSegmentResponse | null
    ) => void
  ): UnaryResponse;
  deleteSegment(
    requestMessage: proto_feature_service_pb.DeleteSegmentRequest,
  ...
  updateSegment(
    ...
    callback: (
      error: ServiceError | null,
      responseMessage: proto_feature_service_pb.UpdateSegmentResponse | null
    ) => void
  ): UnaryResponse;
  updateSegment(
    requestMessage: proto_feature_service_pb.UpdateSegmentRequest,
  ...
  addSegmentUser(
    ...
    callback: (
      error: ServiceError | null,
      responseMessage: proto_feature_service_pb.AddSegmentUserResponse | null
    ) => void
  ): UnaryResponse;
  addSegmentUser(
    requestMessage: proto_feature_service_pb.AddSegmentUserRequest,
  ...
  deleteSegmentUser(
    ...
    callback: (
      error: ServiceError | null,
      responseMessage: proto_feature_service_pb.DeleteSegmentUserResponse | null
    ) => void
  ): UnaryResponse;
  deleteSegmentUser(
    requestMessage: proto_feature_service_pb.DeleteSegmentUserRequest,
  ...
  getSegmentUser(
    ...
    callback: (
      error: ServiceError | null,
      responseMessage: proto_feature_service_pb.GetSegmentUserResponse | null
    ) => void
  ): UnaryResponse;
  getSegmentUser(
    requestMessage: proto_feature_service_pb.GetSegmentUserRequest,
  ...
  listSegmentUsers(
    ...
    callback: (
      error: ServiceError | null,
      responseMessage: proto_feature_service_pb.ListSegmentUsersResponse | null
    ) => void
  ): UnaryResponse;
  listSegmentUsers(
    requestMessage: proto_feature_service_pb.ListSegmentUsersRequest,
  ...
  bulkUploadSegmentUsers(
    ...
    callback: (
      error: ServiceError | null,
      responseMessage: proto_feature_service_pb.BulkUploadSegmentUsersResponse | null
    ) => void
  ): UnaryResponse;
  bulkUploadSegmentUsers(
    requestMessage: proto_feature_service_pb.BulkUploadSegmentUsersRequest,
  ...
  bulkDownloadSegmentUsers(
    ...
    callback: (
      error: ServiceError | null,
      responseMessage: proto_feature_service_pb.BulkDownloadSegmentUsersResponse | null
    ) => void
  ): UnaryResponse;
  bulkDownloadSegmentUsers(
    requestMessage: proto_feature_service_pb.BulkDownloadSegmentUsersRequest,
  ...
  listTags(
    ...
    callback: (
      error: ServiceError | null,
      responseMessage: proto_feature_service_pb.ListTagsResponse | null
    ) => void
  ): UnaryResponse;
  listTags(
    requestMessage: proto_feature_service_pb.ListTagsRequest,
  ...
  createFlagTrigger(
    ...
    callback: (
      error: ServiceError | null,
      responseMessage: proto_feature_service_pb.CreateFlagTriggerResponse | null
    ) => void
  ): UnaryResponse;
  createFlagTrigger(
    requestMessage: proto_feature_service_pb.CreateFlagTriggerRequest,
  ...
  updateFlagTrigger(
    ...
    callback: (
      error: ServiceError | null,
      responseMessage: proto_feature_service_pb.UpdateFlagTriggerResponse | null
    ) => void
  ): UnaryResponse;
  updateFlagTrigger(
    requestMessage: proto_feature_service_pb.UpdateFlagTriggerRequest,
  ...
  enableFlagTrigger(
    ...
    callback: (
      error: ServiceError | null,
      responseMessage: proto_feature_service_pb.EnableFlagTriggerResponse | null
    ) => void
  ): UnaryResponse;
  enableFlagTrigger(
    requestMessage: proto_feature_service_pb.EnableFlagTriggerRequest,
  ...
  disableFlagTrigger(
    ...
    callback: (
      error: ServiceError | null,
      responseMessage: proto_feature_service_pb.DisableFlagTriggerResponse | null
    ) => void
  ): UnaryResponse;
  disableFlagTrigger(
    requestMessage: proto_feature_service_pb.DisableFlagTriggerRequest,
  ...
  resetFlagTrigger(
    ...
    callback: (
      error: ServiceError | null,
      responseMessage: proto_feature_service_pb.ResetFlagTriggerResponse | null
    ) => void
  ): UnaryResponse;
  resetFlagTrigger(
    requestMessage: proto_feature_service_pb.ResetFlagTriggerRequest,
  ...
  deleteFlagTrigger(
    ...
    callback: (
      error: ServiceError | null,
      responseMessage: proto_feature_service_pb.DeleteFlagTriggerResponse | null
    ) => void
  ): UnaryResponse;
  deleteFlagTrigger(
    requestMessage: proto_feature_service_pb.DeleteFlagTriggerRequest,
  ...
  getFlagTrigger(
    ...
    callback: (
      error: ServiceError | null,
      responseMessage: proto_feature_service_pb.GetFlagTriggerResponse | null
    ) => void
  ): UnaryResponse;
  getFlagTrigger(
    requestMessage: proto_feature_service_pb.GetFlagTriggerRequest,
  ...
  flagTriggerWebhook(
    ...
    callback: (
      error: ServiceError | null,
      responseMessage: proto_feature_service_pb.FlagTriggerWebhookResponse | null
    ) => void
  ): UnaryResponse;
  flagTriggerWebhook(
    requestMessage: proto_feature_service_pb.FlagTriggerWebhookRequest,
