...
var file_proto_account_account_proto_goTypes = []interface{}{
	...
	(*environment.Environment)(nil), // 3: bucketeer.environment.Environment
}
var file_proto_account_account_proto_depIdxs = []int32{
	...
	3, // 1: bucketeer.account.EnvironmentRole.environment:type_name -> bucketeer.environment.Environment
