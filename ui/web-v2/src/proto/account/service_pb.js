...
goog.exportSymbol(
  'proto.bucketeer.account.GetMyOrganizationsByGoogleTokenRequest',
  null,
  global
);
goog.exportSymbol(
 ...
 * @constructor
 */
proto.bucketeer.account.GetMyOrganizationsByGoogleTokenRequest = function (
  opt_data
) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
...
if (goog.DEBUG && !COMPILED) {
   ...
   * @override
   */
  proto.bucketeer.account.GetMyOrganizationsByGoogleTokenRequest.displayName =
    'proto.bucketeer.account.GetMyOrganizationsByGoogleTokenRequest';
}
/**
 * Generated by JsPbCodeGenerator.
...
if (jspb.Message.GENERATE_TO_OBJECT) {
   ...
   * @return {!Object}
   */
  proto.bucketeer.account.GetMyOrganizationsByGoogleTokenRequest.prototype.toObject =
    function (opt_includeInstance) {
      return proto.bucketeer.account.GetMyOrganizationsByGoogleTokenRequest.toObject(
        opt_includeInstance,
        this
      );
    };
   ...
   *     the JSPB instance for transitional soy proto support:
   *     http://goto/soy-param-migration
   * @param {!proto.bucketeer.account.GetMyOrganizationsByGoogleTokenRequest} msg The msg instance to transform.
   * @return {!Object}
   * @suppress {unusedLocalVariables} f is only used for nested messages
   */
  proto.bucketeer.account.GetMyOrganizationsByGoogleTokenRequest.toObject =
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.bucketeer.account.GetMyOrganizationsByGoogleTokenRequest}
 */
proto.bucketeer.account.GetMyOrganizationsByGoogleTokenRequest.deserializeBinary =
  function (bytes) {
    var reader = new jspb.BinaryReader(bytes);
    var msg =
      new proto.bucketeer.account.GetMyOrganizationsByGoogleTokenRequest();
    return proto.bucketeer.account.GetMyOrganizationsByGoogleTokenRequest.deserializeBinaryFromReader(
      msg,
      reader
    );
  };
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.bucketeer.account.GetMyOrganizationsByGoogleTokenRequest} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.bucketeer.account.GetMyOrganizationsByGoogleTokenRequest}
 */
proto.bucketeer.account.GetMyOrganizationsByGoogleTokenRequest.deserializeBinaryFromReader =
  function (msg, reader) {
    while (reader.nextField()) {
      if (reader.isEndGroup()) {
        break;
 ...
 * @return {!Uint8Array}
 */
proto.bucketeer.account.GetMyOrganizationsByGoogleTokenRequest.prototype.serializeBinary =
  function () {
    var writer = new jspb.BinaryWriter();
    proto.bucketeer.account.GetMyOrganizationsByGoogleTokenRequest.serializeBinaryToWriter(
      this,
      writer
    );
    return writer.getResultBuffer();
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.bucketeer.account.GetMyOrganizationsByGoogleTokenRequest} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.bucketeer.account.GetMyOrganizationsByGoogleTokenRequest.serializeBinaryToWriter =
 ...
 * @return {string}
 */
proto.bucketeer.account.GetMyOrganizationsByGoogleTokenRequest.prototype.getAccessToken =
  function () {
    return /** @type {string} */ (
      jspb.Message.getFieldWithDefault(this, 1, '')
    );
...
/**
 * @param {string} value
 * @return {!proto.bucketeer.account.GetMyOrganizationsByGoogleTokenRequest} returns this
 */
proto.bucketeer.account.GetMyOrganizationsByGoogleTokenRequest.prototype.setAccessToken =
  function (value) {
    return jspb.Message.setProto3StringField(this, 1, value);
  };
