...
import (
	...
	"github.com/bucketeer-io/bucketeer/pkg/notification/api"
...
func (s *server) Run(ctx context.Context, metrics metrics.Metrics, logger *zap.Logger) error {
	...
	*s.certPath = s.insertTelepresenceMoutRoot(*s.certPath)
	...
	domainEventPublisher, err := s.createDomainEventPublisher(ctx, registerer, logger)
	if err != nil {
		return err
	}
	defer domainEventPublisher.Stop()
	...
	service := api.NewNotificationService(
		mysqlClient,
		accountClient,
