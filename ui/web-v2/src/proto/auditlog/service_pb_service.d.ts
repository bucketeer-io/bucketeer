...
export class AuditLogServiceClient {
  ...
  listAuditLogs(
    ...
    callback: (
      error: ServiceError | null,
      responseMessage: proto_auditlog_service_pb.ListAuditLogsResponse | null
    ) => void
  ): UnaryResponse;
  listAuditLogs(
    requestMessage: proto_auditlog_service_pb.ListAuditLogsRequest,
  ...
  listAdminAuditLogs(
    ...
    callback: (
      error: ServiceError | null,
      responseMessage: proto_auditlog_service_pb.ListAdminAuditLogsResponse | null
    ) => void
  ): UnaryResponse;
  listAdminAuditLogs(
    requestMessage: proto_auditlog_service_pb.ListAdminAuditLogsRequest,
  ...
  listFeatureHistory(
    ...
    callback: (
      error: ServiceError | null,
      responseMessage: proto_auditlog_service_pb.ListFeatureHistoryResponse | null
    ) => void
  ): UnaryResponse;
  listFeatureHistory(
    requestMessage: proto_auditlog_service_pb.ListFeatureHistoryRequest,
