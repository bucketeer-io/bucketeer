...
export class WebhookClause extends jspb.Message {
  ...
  static toObject(
    includeInstance: boolean,
    msg: WebhookClause
  ): WebhookClause.AsObject;
  static extensions: { [key: number]: jspb.ExtensionFieldInfo<jspb.Message> };
  static extensionsBinary: {
    [key: number]: jspb.ExtensionFieldBinaryInfo<jspb.Message>;
  };
  static serializeBinaryToWriter(
    message: WebhookClause,
    writer: jspb.BinaryWriter
  ): void;
...
export namespace WebhookClause {
  ...
  export class Condition extends jspb.Message {
    ...
    setOperator(
      value: WebhookClause.Condition.OperatorMap[keyof WebhookClause.Condition.OperatorMap]
    ): void;
