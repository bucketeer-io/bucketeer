...
//
//	mockgen -source=project.go -package=mock -destination=./mock/project.go
//
...
func (mr *MockProjectStorageMockRecorder) CreateProject(ctx, p any) *gomock.Call {
...
func (mr *MockProjectStorageMockRecorder) GetProject(ctx, id any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockProjectStorageMockRecorder) GetTrialProjectByEmail(ctx, email, disabled, trial any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockProjectStorageMockRecorder) UpdateProject(ctx, p any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
