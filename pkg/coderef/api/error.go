...
var (
	...
	statusInvalidOrderDirection = status.New(codes.InvalidArgument, "coderef: invalid order_direction")
	statusMissingCommand        = status.New(codes.InvalidArgument, "coderef: missing command")
	...
	statusAlreadyExists         = status.New(codes.AlreadyExists, "coderef: already exists")
	statusFailedPrecondition    = status.New(codes.FailedPrecondition, "coderef: failed precondition")
)
