...
goog.exportSymbol('proto.bucketeer.autoops.ControlFlagTriggerCommand', null, global);
 ...
 * @constructor
 */
proto.bucketeer.autoops.ControlFlagTriggerCommand = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.bucketeer.autoops.ControlFlagTriggerCommand, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.bucketeer.autoops.ControlFlagTriggerCommand.displayName = 'proto.bucketeer.autoops.ControlFlagTriggerCommand';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @return {!Object}
 */
proto.bucketeer.autoops.ControlFlagTriggerCommand.prototype.toObject = function(opt_includeInstance) {
  return proto.bucketeer.autoops.ControlFlagTriggerCommand.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.bucketeer.autoops.ControlFlagTriggerCommand} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.bucketeer.autoops.ControlFlagTriggerCommand.toObject = function(includeInstance, msg) {
  var f, obj = {
    id: jspb.Message.getFieldWithDefault(msg, 1, ""),
 ...
 */
proto.bucketeer.autoops.ControlFlagTriggerCommand.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.bucketeer.autoops.ControlFlagTriggerCommand;
  return proto.bucketeer.autoops.ControlFlagTriggerCommand.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.bucketeer.autoops.ControlFlagTriggerCommand} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.bucketeer.autoops.ControlFlagTriggerCommand}
 */
proto.bucketeer.autoops.ControlFlagTriggerCommand.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.bucketeer.autoops.ControlFlagTriggerCommand.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.bucketeer.autoops.ControlFlagTriggerCommand.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.bucketeer.autoops.ControlFlagTriggerCommand} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.bucketeer.autoops.ControlFlagTriggerCommand.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getId();
  if (f.length > 0) {
    writer.writeString(
 ...
 * @return {string}
 */
proto.bucketeer.autoops.ControlFlagTriggerCommand.prototype.getId = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 1, ""));
};
...
/**
 * @param {string} value
 * @return {!proto.bucketeer.autoops.ControlFlagTriggerCommand} returns this
 */
proto.bucketeer.autoops.ControlFlagTriggerCommand.prototype.setId = function(value) {
  return jspb.Message.setProto3StringField(this, 1, value);
};
 ...
 * @return {boolean}
 */
proto.bucketeer.autoops.ControlFlagTriggerCommand.prototype.getDisabled = function() {
 ...
 * @return {!proto.bucketeer.autoops.ControlFlagTriggerCommand} returns this
 */
proto.bucketeer.autoops.ControlFlagTriggerCommand.prototype.setDisabled = function(value) {
