...
//
//	mockgen -source=rate_limited_puller.go -package=mock -destination=./mock/rate_limited_puller.go
//
...
func (mr *MockRateLimitedPullerMockRecorder) Run(arg0 any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
