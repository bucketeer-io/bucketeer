...
goog.exportSymbol('proto.bucketeer.environment.CreateTrialOrganizationRequest', null, global);
goog.exportSymbol('proto.bucketeer.environment.CreateTrialOrganizationResponse', null, global);
 ...
 * @constructor
 */
proto.bucketeer.environment.CreateTrialOrganizationRequest = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.bucketeer.environment.CreateTrialOrganizationRequest, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.bucketeer.environment.CreateTrialOrganizationRequest.displayName = 'proto.bucketeer.environment.CreateTrialOrganizationRequest';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @constructor
 */
proto.bucketeer.environment.CreateTrialOrganizationResponse = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.bucketeer.environment.CreateTrialOrganizationResponse, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.bucketeer.environment.CreateTrialOrganizationResponse.displayName = 'proto.bucketeer.environment.CreateTrialOrganizationResponse';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @return {!Object}
 */
proto.bucketeer.environment.CreateTrialOrganizationRequest.prototype.toObject = function(opt_includeInstance) {
  return proto.bucketeer.environment.CreateTrialOrganizationRequest.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.bucketeer.environment.CreateTrialOrganizationRequest} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.bucketeer.environment.CreateTrialOrganizationRequest.toObject = function(includeInstance, msg) {
  var f, obj = {
    command: (f = msg.getCommand()) && proto_environment_command_pb.CreateTrialOrganizationCommand.toObject(includeInstance, f)
  };
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.bucketeer.environment.CreateTrialOrganizationRequest}
 */
proto.bucketeer.environment.CreateTrialOrganizationRequest.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.bucketeer.environment.CreateTrialOrganizationRequest;
  return proto.bucketeer.environment.CreateTrialOrganizationRequest.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.bucketeer.environment.CreateTrialOrganizationRequest} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.bucketeer.environment.CreateTrialOrganizationRequest}
 */
proto.bucketeer.environment.CreateTrialOrganizationRequest.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
    ...
    switch (field) {
    case 1:
      var value = new proto_environment_command_pb.CreateTrialOrganizationCommand;
      reader.readMessage(value,proto_environment_command_pb.CreateTrialOrganizationCommand.deserializeBinaryFromReader);
      msg.setCommand(value);
      break;
    default:
      reader.skipField();
 ...
 * @return {!Uint8Array}
 */
proto.bucketeer.environment.CreateTrialOrganizationRequest.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.bucketeer.environment.CreateTrialOrganizationRequest.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.bucketeer.environment.CreateTrialOrganizationRequest} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.bucketeer.environment.CreateTrialOrganizationRequest.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getCommand();
  if (f != null) {
    writer.writeMessage(
      1,
      f,
      proto_environment_command_pb.CreateTrialOrganizationCommand.serializeBinaryToWriter
    );
  }
};
...
/**
 * optional CreateTrialOrganizationCommand command = 1;
 * @return {?proto.bucketeer.environment.CreateTrialOrganizationCommand}
 */
proto.bucketeer.environment.CreateTrialOrganizationRequest.prototype.getCommand = function() {
  return /** @type{?proto.bucketeer.environment.CreateTrialOrganizationCommand} */ (
    jspb.Message.getWrapperField(this, proto_environment_command_pb.CreateTrialOrganizationCommand, 1));
};


/**
 * @param {?proto.bucketeer.environment.CreateTrialOrganizationCommand|undefined} value
 * @return {!proto.bucketeer.environment.CreateTrialOrganizationRequest} returns this
*/
proto.bucketeer.environment.CreateTrialOrganizationRequest.prototype.setCommand = function(value) {
  return jspb.Message.setWrapperField(this, 1, value);
};
 ...
 * @return {!proto.bucketeer.environment.CreateTrialOrganizationRequest} returns this
 */
proto.bucketeer.environment.CreateTrialOrganizationRequest.prototype.clearCommand = function() {
  return this.setCommand(undefined);
};
 ...
 * @return {boolean}
 */
proto.bucketeer.environment.CreateTrialOrganizationRequest.prototype.hasCommand = function() {
  return jspb.Message.getField(this, 1) != null;
};
 ...
 * @return {!Object}
 */
proto.bucketeer.environment.CreateTrialOrganizationResponse.prototype.toObject = function(opt_includeInstance) {
  return proto.bucketeer.environment.CreateTrialOrganizationResponse.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.bucketeer.environment.CreateTrialOrganizationResponse} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.bucketeer.environment.CreateTrialOrganizationResponse.toObject = function(includeInstance, msg) {
  var f, obj = {
    organization: (f = msg.getOrganization()) && proto_environment_organization_pb.Organization.toObject(includeInstance, f)
  };
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.bucketeer.environment.CreateTrialOrganizationResponse}
 */
proto.bucketeer.environment.CreateTrialOrganizationResponse.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.bucketeer.environment.CreateTrialOrganizationResponse;
  return proto.bucketeer.environment.CreateTrialOrganizationResponse.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.bucketeer.environment.CreateTrialOrganizationResponse} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.bucketeer.environment.CreateTrialOrganizationResponse}
 */
proto.bucketeer.environment.CreateTrialOrganizationResponse.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.bucketeer.environment.CreateTrialOrganizationResponse.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.bucketeer.environment.CreateTrialOrganizationResponse.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.bucketeer.environment.CreateTrialOrganizationResponse} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.bucketeer.environment.CreateTrialOrganizationResponse.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getOrganization();
  if (f != null) {
    writer.writeMessage(
 ...
 * @return {?proto.bucketeer.environment.Organization}
 */
proto.bucketeer.environment.CreateTrialOrganizationResponse.prototype.getOrganization = function() {
  return /** @type{?proto.bucketeer.environment.Organization} */ (
    jspb.Message.getWrapperField(this, proto_environment_organization_pb.Organization, 1));
};
...
/**
 * @param {?proto.bucketeer.environment.Organization|undefined} value
 * @return {!proto.bucketeer.environment.CreateTrialOrganizationResponse} returns this
*/
proto.bucketeer.environment.CreateTrialOrganizationResponse.prototype.setOrganization = function(value) {
  return jspb.Message.setWrapperField(this, 1, value);
};
 ...
 * @return {!proto.bucketeer.environment.CreateTrialOrganizationResponse} returns this
 */
proto.bucketeer.environment.CreateTrialOrganizationResponse.prototype.clearOrganization = function() {
  return this.setOrganization(undefined);
};
 ...
 * @return {boolean}
 */
proto.bucketeer.environment.CreateTrialOrganizationResponse.prototype.hasOrganization = function() {
  return jspb.Message.getField(this, 1) != null;
};
...
proto.bucketeer.environment.UpdateOrganizationRequest.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    renameCommand: (f = msg.getRenameCommand()) && proto_environment_command_pb.RenameOrganizationCommand.toObject(includeInstance, f)
  };
...
proto.bucketeer.environment.UpdateOrganizationRequest.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 2:
      ...
      break;
    case 3:
      var value = new proto_environment_command_pb.RenameOrganizationCommand;
      reader.readMessage(value,proto_environment_command_pb.RenameOrganizationCommand.deserializeBinaryFromReader);
      msg.setRenameCommand(value);
      break;
    default:
      reader.skipField();
...
proto.bucketeer.environment.UpdateOrganizationRequest.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f != null) {
    writer.writeMessage(
      3,
      f,
      proto_environment_command_pb.RenameOrganizationCommand.serializeBinaryToWriter
    );
  }
};
...
/**
 * optional ChangeDescriptionOrganizationCommand change_description_command = 2;
...
proto.bucketeer.environment.UpdateOrganizationRequest.prototype.getChangeDescriptionCommand = function() {
  return /** @type{?proto.bucketeer.environment.ChangeDescriptionOrganizationCommand} */ (
    jspb.Message.getWrapperField(this, proto_environment_command_pb.ChangeDescriptionOrganizationCommand, 2));
};
...
/**
 * optional RenameOrganizationCommand rename_command = 3;
 * @return {?proto.bucketeer.environment.RenameOrganizationCommand}
 */
proto.bucketeer.environment.UpdateOrganizationRequest.prototype.getRenameCommand = function() {
  return /** @type{?proto.bucketeer.environment.RenameOrganizationCommand} */ (
    jspb.Message.getWrapperField(this, proto_environment_command_pb.RenameOrganizationCommand, 3));
};


/**
 * @param {?proto.bucketeer.environment.RenameOrganizationCommand|undefined} value
 * @return {!proto.bucketeer.environment.UpdateOrganizationRequest} returns this
*/
