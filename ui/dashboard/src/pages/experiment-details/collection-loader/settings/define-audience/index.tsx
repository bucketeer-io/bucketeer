...
const DefineAudience = ({ field }: DefineAudienceProps) => {
  ...
  return (
    <div className="flex flex-col gap-y-5 mt-2.5">
      ...
      <div className="flex flex-col w-full gap-y-4 typo-para-small leading-[14px] text-gray-600 dark:text-dark-gray-200">
        <p className="text-gray-800 dark:text-dark-gray-400 typo-head-bold-small leading-4">
          Default Rule
        </p>
        <p className="typo-para-medium leading-5 text-gray-500 dark:text-dark-gray-200">
          {t('experiments.define-audience.any-traffic')}
        </p>
      </div>
      <div className="w-full p-4 bg-gray-100 dark:bg-dark-black-700 rounded-lg">
        <div className="flex flex-col w-full gap-y-4 typo-para-small leading-[14px] text-gray-600 dark:text-dark-gray-200">
          <p className="uppercase">{t('experiments.audience-included')}</p>
          <div className="w-full h-3 p-[1px] border border-gray-400 dark:border-dark-black-800 rounded-full bg-gray-100 dark:bg-dark-black-800">
            <div
          ...
          <div className="flex items-center w-full gap-x-4">
            ...
            <div className="flex items-center gap-x-2">
              <div className="flex-center size-5 m-0.5 border border-gray-400 dark:border-dark-black-800 rounded bg-gray-100 dark:bg-dark-black-800" />
        ...
        <div className="flex items-center w-full gap-x-2 mt-4 typo-para-medium leading-5 text-gray-600 dark:text-dark-gray-200 whitespace-nowrap">
          <Trans
            ...
            components={{
              highlight: (
                <div className="flex-center size-fit p-3 rounded-lg typo-para-medium leading-5 text-gray-700 dark:text-dark-gray-300 bg-gray-200 dark:bg-dark-black-800" />
              )
            }}
          />
        </div>
