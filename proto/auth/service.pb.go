...
func (x *RefreshTokenRequest) GetType() AuthType {
	if x != nil {
		return x.Type
	}
	return AuthType_AUTH_TYPE_UNSPECIFIED
...
var file_proto_auth_service_proto_rawDesc = []byte{
	...
	0x68, 0x2e, 0x54, 0x6f, 0x6b, 0x65, 0x6e, 0x52, 0x05, 0x74, 0x6f, 0x6b, 0x65, 0x6e, 0x22, 0x8b,
	...
	0x65, 0x66, 0x72, 0x65, 0x73, 0x68, 0x54, 0x6f, 0x6b, 0x65, 0x6e, 0x12, 0x21, 0x0a, 0x0c, 0x72,
	...
	0x74, 0x68, 0x54, 0x79, 0x70, 0x65, 0x52, 0x04, 0x74, 0x79, 0x70, 0x65, 0x22, 0x43, 0x0a, 0x14,
	...
	0x6e, 0x2a, 0x6e, 0x0a, 0x08, 0x41, 0x75, 0x74, 0x68, 0x54, 0x79, 0x70, 0x65, 0x12, 0x19, 0x0a,
	0x15, 0x41, 0x55, 0x54, 0x48, 0x5f, 0x54, 0x59, 0x50, 0x45, 0x5f, 0x55, 0x4e, 0x53, 0x50, 0x45,
	0x43, 0x49, 0x46, 0x49, 0x45, 0x44, 0x10, 0x00, 0x12, 0x1b, 0x0a, 0x17, 0x41, 0x55, 0x54, 0x48,
	0x5f, 0x54, 0x59, 0x50, 0x45, 0x5f, 0x55, 0x53, 0x45, 0x52, 0x5f, 0x50, 0x41, 0x53, 0x53, 0x57,
	0x4f, 0x52, 0x44, 0x10, 0x01, 0x12, 0x14, 0x0a, 0x10, 0x41, 0x55, 0x54, 0x48, 0x5f, 0x54, 0x59,
	...
	0x03, 0x32, 0xb9, 0x02, 0x0a, 0x0b, 0x41, 0x75, 0x74, 0x68, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63,
	0x65, 0x12, 0x71, 0x0a, 0x14, 0x47, 0x65, 0x74, 0x41, 0x75, 0x74, 0x68, 0x65, 0x6e, 0x74, 0x69,
	0x63, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x55, 0x52, 0x4c, 0x12, 0x2b, 0x2e, 0x62, 0x75, 0x63, 0x6b,
	...
	0x6e, 0x74, 0x69, 0x63, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x55, 0x52, 0x4c, 0x52, 0x65, 0x73, 0x70,
	0x6f, 0x6e, 0x73, 0x65, 0x12, 0x5c, 0x0a, 0x0d, 0x45, 0x78, 0x63, 0x68, 0x61, 0x6e, 0x67, 0x65,
	...
	0x73, 0x65, 0x12, 0x59, 0x0a, 0x0c, 0x52, 0x65, 0x66, 0x72, 0x65, 0x73, 0x68, 0x54, 0x6f, 0x6b,
	...
	0x54, 0x6f, 0x6b, 0x65, 0x6e, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x42, 0x2e, 0x5a,
...
var file_proto_auth_service_proto_goTypes = []interface{}{
	...
	(*Token)(nil),                        // 7: bucketeer.auth.Token
}
var file_proto_auth_service_proto_depIdxs = []int32{
	...
	7, // 2: bucketeer.auth.ExchangeTokenResponse.token:type_name -> bucketeer.auth.Token
	0, // 3: bucketeer.auth.RefreshTokenRequest.type:type_name -> bucketeer.auth.AuthType
	7, // 4: bucketeer.auth.RefreshTokenResponse.token:type_name -> bucketeer.auth.Token
	...
	2, // 8: bucketeer.auth.AuthService.GetAuthenticationURL:output_type -> bucketeer.auth.GetAuthenticationURLResponse
	4, // 9: bucketeer.auth.AuthService.ExchangeToken:output_type -> bucketeer.auth.ExchangeTokenResponse
	6, // 10: bucketeer.auth.AuthService.RefreshToken:output_type -> bucketeer.auth.RefreshTokenResponse
