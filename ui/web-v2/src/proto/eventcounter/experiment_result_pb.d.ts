...
export class ExperimentResult extends jspb.Message {
  ...
  setGoalResultsList(
    value: Array<proto_eventcounter_goal_result_pb.GoalResult>
  ): void;
  addGoalResults(
    value?: proto_eventcounter_goal_result_pb.GoalResult,
    index?: number
  ...
  static toObject(
    ...
    msg: ExperimentResult
  ): ExperimentResult.AsObject;
