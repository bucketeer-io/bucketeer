...
if (goog.DEBUG && !COMPILED) {
   ...
   * @override
   */
  proto.bucketeer.event.service.UserEvent.displayName =
    'proto.bucketeer.event.service.UserEvent';
}
...
if (jspb.Message.GENERATE_TO_OBJECT) {
   ...
   * @return {!Object}
   */
  proto.bucketeer.event.service.UserEvent.prototype.toObject = function (
    opt_includeInstance
  ) {
    return proto.bucketeer.event.service.UserEvent.toObject(
      opt_includeInstance,
      this
    );
  };
   ...
   */
  proto.bucketeer.event.service.UserEvent.toObject = function (
    includeInstance,
    msg
  ) {
    var f,
...
proto.bucketeer.event.service.UserEvent.deserializeBinary = function (bytes) {
  ...
  return proto.bucketeer.event.service.UserEvent.deserializeBinaryFromReader(
    msg,
    reader
  );
};
 ...
 * @return {!proto.bucketeer.event.service.UserEvent}
 */
proto.bucketeer.event.service.UserEvent.deserializeBinaryFromReader = function (
  msg,
  reader
) {
 ...
 * @return {!Uint8Array}
 */
proto.bucketeer.event.service.UserEvent.prototype.serializeBinary =
  function () {
    var writer = new jspb.BinaryWriter();
    proto.bucketeer.event.service.UserEvent.serializeBinaryToWriter(
      this,
      writer
    );
 ...
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.bucketeer.event.service.UserEvent.serializeBinaryToWriter = function (
  message,
  writer
) {
  var f = undefined;
 ...
 * @return {string}
 */
proto.bucketeer.event.service.UserEvent.prototype.getEnvironmentNamespace =
  function () {
    return /** @type {string} */ (
 ...
 * @return {!proto.bucketeer.event.service.UserEvent} returns this
 */
proto.bucketeer.event.service.UserEvent.prototype.setEnvironmentNamespace =
  function (value) {
 ...
 * @return {!proto.bucketeer.event.service.UserEvent} returns this
 */
proto.bucketeer.event.service.UserEvent.prototype.setLastSeen = function (
  value
) {
 ...
 */
proto.bucketeer.event.service.UserEvent.prototype.getDataMap = function (
  opt_noLazyCreate
) {
 ...
 * @return {!proto.bucketeer.event.service.UserEvent} returns this
 */
proto.bucketeer.event.service.UserEvent.prototype.setSourceId = function (
  value
) {
