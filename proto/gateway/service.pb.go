...
var file_proto_gateway_service_proto_rawDesc = []byte{
	...
	0x73, 0x68, 0x52, 0x04, 0x70, 0x75, 0x73, 0x68, 0x32, 0x92, 0x27, 0x0a, 0x07, 0x47, 0x61, 0x74,
...
var file_proto_gateway_service_proto_depIdxs = []int32{
	...
	45, // 38: bucketeer.gateway.UpdatePushRequest.name:type_name -> google.protobuf.StringValue
	46, // 39: bucketeer.gateway.UpdatePushRequest.deleted:type_name -> google.protobuf.BoolValue
	53, // 40: bucketeer.gateway.UpdatePushResponse.push:type_name -> bucketeer.push.Push
	31, // 41: bucketeer.gateway.RegisterEventsResponse.ErrorsEntry.value:type_name -> bucketeer.gateway.RegisterEventsResponse.Error
	6,  // 42: bucketeer.gateway.Gateway.GetEvaluations:input_type -> bucketeer.gateway.GetEvaluationsRequest
	8,  // 43: bucketeer.gateway.Gateway.GetEvaluation:input_type -> bucketeer.gateway.GetEvaluationRequest
	2,  // 44: bucketeer.gateway.Gateway.GetFeatureFlags:input_type -> bucketeer.gateway.GetFeatureFlagsRequest
	4,  // 45: bucketeer.gateway.Gateway.GetSegmentUsers:input_type -> bucketeer.gateway.GetSegmentUsersRequest
	10, // 46: bucketeer.gateway.Gateway.RegisterEvents:input_type -> bucketeer.gateway.RegisterEventsRequest
	12, // 47: bucketeer.gateway.Gateway.Track:input_type -> bucketeer.gateway.TrackRequest
	14, // 48: bucketeer.gateway.Gateway.CreateFeature:input_type -> bucketeer.gateway.CreateFeatureRequest
	16, // 49: bucketeer.gateway.Gateway.GetFeature:input_type -> bucketeer.gateway.GetFeatureRequest
	18, // 50: bucketeer.gateway.Gateway.ListFeatures:input_type -> bucketeer.gateway.ListFeaturesRequest
	20, // 51: bucketeer.gateway.Gateway.UpdateFeature:input_type -> bucketeer.gateway.UpdateFeatureRequest
	0,  // 52: bucketeer.gateway.Gateway.Ping:input_type -> bucketeer.gateway.PingRequest
	22, // 53: bucketeer.gateway.Gateway.ListPushes:input_type -> bucketeer.gateway.ListPushesRequest
	24, // 54: bucketeer.gateway.Gateway.CreatePush:input_type -> bucketeer.gateway.CreatePushRequest
	26, // 55: bucketeer.gateway.Gateway.GetPush:input_type -> bucketeer.gateway.GetPushRequest
	28, // 56: bucketeer.gateway.Gateway.UpdatePush:input_type -> bucketeer.gateway.UpdatePushRequest
	7,  // 57: bucketeer.gateway.Gateway.GetEvaluations:output_type -> bucketeer.gateway.GetEvaluationsResponse
	9,  // 58: bucketeer.gateway.Gateway.GetEvaluation:output_type -> bucketeer.gateway.GetEvaluationResponse
	3,  // 59: bucketeer.gateway.Gateway.GetFeatureFlags:output_type -> bucketeer.gateway.GetFeatureFlagsResponse
	5,  // 60: bucketeer.gateway.Gateway.GetSegmentUsers:output_type -> bucketeer.gateway.GetSegmentUsersResponse
	11, // 61: bucketeer.gateway.Gateway.RegisterEvents:output_type -> bucketeer.gateway.RegisterEventsResponse
	13, // 62: bucketeer.gateway.Gateway.Track:output_type -> bucketeer.gateway.TrackResponse
	15, // 63: bucketeer.gateway.Gateway.CreateFeature:output_type -> bucketeer.gateway.CreateFeatureResponse
	17, // 64: bucketeer.gateway.Gateway.GetFeature:output_type -> bucketeer.gateway.GetFeatureResponse
	19, // 65: bucketeer.gateway.Gateway.ListFeatures:output_type -> bucketeer.gateway.ListFeaturesResponse
	21, // 66: bucketeer.gateway.Gateway.UpdateFeature:output_type -> bucketeer.gateway.UpdateFeatureResponse
	1,  // 67: bucketeer.gateway.Gateway.Ping:output_type -> bucketeer.gateway.PingResponse
	23, // 68: bucketeer.gateway.Gateway.ListPushes:output_type -> bucketeer.gateway.ListPushesResponse
	25, // 69: bucketeer.gateway.Gateway.CreatePush:output_type -> bucketeer.gateway.CreatePushResponse
	27, // 70: bucketeer.gateway.Gateway.GetPush:output_type -> bucketeer.gateway.GetPushResponse
	29, // 71: bucketeer.gateway.Gateway.UpdatePush:output_type -> bucketeer.gateway.UpdatePushResponse
