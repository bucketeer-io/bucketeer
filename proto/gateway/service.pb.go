...
var file_proto_gateway_service_proto_depIdxs = []int32{
	...
	14, // 9: bucketeer.gateway.RegisterEventsRequest.source_id:type_name -> bucketeer.event.client.SourceId
	12, // 10: bucketeer.gateway.RegisterEventsResponse.errors:type_name -> bucketeer.gateway.RegisterEventsResponse.ErrorsEntry
	11, // 11: bucketeer.gateway.RegisterEventsResponse.ErrorsEntry.value:type_name -> bucketeer.gateway.RegisterEventsResponse.Error
	0,  // 12: bucketeer.gateway.Gateway.Ping:input_type -> bucketeer.gateway.PingRequest
	2,  // 13: bucketeer.gateway.Gateway.GetEvaluations:input_type -> bucketeer.gateway.GetEvaluationsRequest
	4,  // 14: bucketeer.gateway.Gateway.GetEvaluation:input_type -> bucketeer.gateway.GetEvaluationRequest
	6,  // 15: bucketeer.gateway.Gateway.RegisterEvents:input_type -> bucketeer.gateway.RegisterEventsRequest
	8,  // 16: bucketeer.gateway.Gateway.Track:input_type -> bucketeer.gateway.TrackRequest
	1,  // 17: bucketeer.gateway.Gateway.Ping:output_type -> bucketeer.gateway.PingResponse
	3,  // 18: bucketeer.gateway.Gateway.GetEvaluations:output_type -> bucketeer.gateway.GetEvaluationsResponse
	5,  // 19: bucketeer.gateway.Gateway.GetEvaluation:output_type -> bucketeer.gateway.GetEvaluationResponse
	7,  // 20: bucketeer.gateway.Gateway.RegisterEvents:output_type -> bucketeer.gateway.RegisterEventsResponse
	9,  // 21: bucketeer.gateway.Gateway.Track:output_type -> bucketeer.gateway.TrackResponse
