...
export class ExperimentServiceClient {
  ...
  getGoal(
    ...
    callback: (
      ...
      responseMessage: proto_experiment_service_pb.GetGoalResponse | null
    ) => void
  ): UnaryResponse;
  getGoal(
    requestMessage: proto_experiment_service_pb.GetGoalRequest,
  ...
  listGoals(
    ...
    callback: (
      error: ServiceError | null,
      responseMessage: proto_experiment_service_pb.ListGoalsResponse | null
    ) => void
  ): UnaryResponse;
  listGoals(
    requestMessage: proto_experiment_service_pb.ListGoalsRequest,
  ...
  createGoal(
    ...
    callback: (
      error: ServiceError | null,
      responseMessage: proto_experiment_service_pb.CreateGoalResponse | null
    ) => void
  ): UnaryResponse;
  createGoal(
    requestMessage: proto_experiment_service_pb.CreateGoalRequest,
  ...
  updateGoal(
    ...
    callback: (
      error: ServiceError | null,
      responseMessage: proto_experiment_service_pb.UpdateGoalResponse | null
    ) => void
  ): UnaryResponse;
  updateGoal(
    requestMessage: proto_experiment_service_pb.UpdateGoalRequest,
  ...
  archiveGoal(
    ...
    callback: (
      error: ServiceError | null,
      responseMessage: proto_experiment_service_pb.ArchiveGoalResponse | null
    ) => void
  ): UnaryResponse;
  archiveGoal(
    requestMessage: proto_experiment_service_pb.ArchiveGoalRequest,
  ...
  deleteGoal(
    ...
    callback: (
      error: ServiceError | null,
      responseMessage: proto_experiment_service_pb.DeleteGoalResponse | null
    ) => void
  ): UnaryResponse;
  deleteGoal(
    requestMessage: proto_experiment_service_pb.DeleteGoalRequest,
  ...
  getExperiment(
    ...
    callback: (
      error: ServiceError | null,
      responseMessage: proto_experiment_service_pb.GetExperimentResponse | null
    ) => void
  ): UnaryResponse;
  getExperiment(
    requestMessage: proto_experiment_service_pb.GetExperimentRequest,
  ...
  listExperiments(
    ...
    callback: (
      error: ServiceError | null,
      responseMessage: proto_experiment_service_pb.ListExperimentsResponse | null
    ) => void
  ): UnaryResponse;
  listExperiments(
    requestMessage: proto_experiment_service_pb.ListExperimentsRequest,
  ...
  createExperiment(
    ...
    callback: (
      error: ServiceError | null,
      responseMessage: proto_experiment_service_pb.CreateExperimentResponse | null
    ) => void
  ): UnaryResponse;
  createExperiment(
    requestMessage: proto_experiment_service_pb.CreateExperimentRequest,
  ...
  updateExperiment(
    ...
    callback: (
      error: ServiceError | null,
      responseMessage: proto_experiment_service_pb.UpdateExperimentResponse | null
    ) => void
  ): UnaryResponse;
  updateExperiment(
    requestMessage: proto_experiment_service_pb.UpdateExperimentRequest,
  ...
  startExperiment(
    ...
    callback: (
      error: ServiceError | null,
      responseMessage: proto_experiment_service_pb.StartExperimentResponse | null
    ) => void
  ): UnaryResponse;
  startExperiment(
    requestMessage: proto_experiment_service_pb.StartExperimentRequest,
  ...
  finishExperiment(
    ...
    callback: (
      error: ServiceError | null,
      responseMessage: proto_experiment_service_pb.FinishExperimentResponse | null
    ) => void
  ): UnaryResponse;
  finishExperiment(
    requestMessage: proto_experiment_service_pb.FinishExperimentRequest,
  ...
  stopExperiment(
    ...
    callback: (
      error: ServiceError | null,
      responseMessage: proto_experiment_service_pb.StopExperimentResponse | null
    ) => void
  ): UnaryResponse;
  stopExperiment(
    requestMessage: proto_experiment_service_pb.StopExperimentRequest,
  ...
  archiveExperiment(
    ...
    callback: (
      error: ServiceError | null,
      responseMessage: proto_experiment_service_pb.ArchiveExperimentResponse | null
    ) => void
  ): UnaryResponse;
  archiveExperiment(
    requestMessage: proto_experiment_service_pb.ArchiveExperimentRequest,
  ...
  deleteExperiment(
    ...
    callback: (
      error: ServiceError | null,
      responseMessage: proto_experiment_service_pb.DeleteExperimentResponse | null
    ) => void
  ): UnaryResponse;
  deleteExperiment(
    requestMessage: proto_experiment_service_pb.DeleteExperimentRequest,
