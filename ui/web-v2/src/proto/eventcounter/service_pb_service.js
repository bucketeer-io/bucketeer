...
var EventCounterService = (function () {
  ...
  EventCounterService.serviceName =
...
EventCounterServiceClient.prototype.getExperimentEvaluationCount =
  function getExperimentEvaluationCount(requestMessage, metadata, callback) {
...
EventCounterServiceClient.prototype.getEvaluationTimeseriesCount =
  function getEvaluationTimeseriesCount(requestMessage, metadata, callback) {
    if (arguments.length === 2) {
      callback = arguments[1];
    }
...
EventCounterServiceClient.prototype.getExperimentResult =
  function getExperimentResult(requestMessage, metadata, callback) {
    if (arguments.length === 2) {
      callback = arguments[1];
    }
...
EventCounterServiceClient.prototype.listExperimentResults =
  function listExperimentResults(requestMessage, metadata, callback) {
    if (arguments.length === 2) {
      callback = arguments[1];
    }
...
EventCounterServiceClient.prototype.getExperimentGoalCount =
  function getExperimentGoalCount(requestMessage, metadata, callback) {
    if (arguments.length === 2) {
      callback = arguments[1];
    }
...
EventCounterServiceClient.prototype.getMAUCount = function getMAUCount(
  requestMessage,
  metadata,
  callback
) {
...
EventCounterServiceClient.prototype.summarizeMAUCounts =
  function summarizeMAUCounts(requestMessage, metadata, callback) {
    if (arguments.length === 2) {
      callback = arguments[1];
    }
...
EventCounterServiceClient.prototype.getOpsEvaluationUserCount =
  function getOpsEvaluationUserCount(requestMessage, metadata, callback) {
    if (arguments.length === 2) {
      callback = arguments[1];
    }
...
EventCounterServiceClient.prototype.getOpsGoalUserCount =
  function getOpsGoalUserCount(requestMessage, metadata, callback) {
    if (arguments.length === 2) {
      callback = arguments[1];
    }
