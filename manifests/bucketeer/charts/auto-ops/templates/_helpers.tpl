...
{{- else -}}
{{ template "auto-ops.fullname" . }}-service-cert
{{- end -}}
{{- end -}}
...
{{- else -}}
{{ template "auto-ops.fullname" . }}-oauth-key
{{- end -}}
{{- end -}}
...
{{- else -}}
{{ template "auto-ops.fullname" . }}-service-token
{{- end -}}
{{- end -}}