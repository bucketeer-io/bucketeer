...
// 	protoc        v4.23.4
// source: proto/subscription/recipient.proto
...
func (Recipient_Type) Descriptor() protoreflect.EnumDescriptor {
	return file_proto_subscription_recipient_proto_enumTypes[0].Descriptor()
}

func (Recipient_Type) Type() protoreflect.EnumType {
	return &file_proto_subscription_recipient_proto_enumTypes[0]
}
...
func (Recipient_Type) EnumDescriptor() ([]byte, []int) {
	return file_proto_subscription_recipient_proto_rawDescGZIP(), []int{0, 0}
}
...
func (Recipient_Language) Descriptor() protoreflect.EnumDescriptor {
	return file_proto_subscription_recipient_proto_enumTypes[1].Descriptor()
}

func (Recipient_Language) Type() protoreflect.EnumType {
	return &file_proto_subscription_recipient_proto_enumTypes[1]
}
...
func (Recipient_Language) EnumDescriptor() ([]byte, []int) {
	return file_proto_subscription_recipient_proto_rawDescGZIP(), []int{0, 1}
}
...
type Recipient struct {
	...
	Type                  Recipient_Type         `protobuf:"varint,1,opt,name=type,proto3,enum=bucketeer.subscription.Recipient_Type" json:"type"`
	...
	Language              Recipient_Language     `protobuf:"varint,3,opt,name=language,proto3,enum=bucketeer.subscription.Recipient_Language" json:"language"`
}

func (x *Recipient) Reset() {
	*x = Recipient{}
	if protoimpl.UnsafeEnabled {
		mi := &file_proto_subscription_recipient_proto_msgTypes[0]
...
func (*Recipient) Descriptor() ([]byte, []int) {
	return file_proto_subscription_recipient_proto_rawDescGZIP(), []int{0}
}
...
func (x *SlackChannelRecipient) Reset() {
	*x = SlackChannelRecipient{}
	if protoimpl.UnsafeEnabled {
		mi := &file_proto_subscription_recipient_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*SlackChannelRecipient) Descriptor() ([]byte, []int) {
	return file_proto_subscription_recipient_proto_rawDescGZIP(), []int{1}
}
...
var File_proto_subscription_recipient_proto protoreflect.FileDescriptor

var file_proto_subscription_recipient_proto_rawDesc = []byte{
	0x0a, 0x22, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2f, 0x73, 0x75, 0x62, 0x73, 0x63, 0x72, 0x69, 0x70,
	...
	0x73, 0x75, 0x62, 0x73, 0x63, 0x72, 0x69, 0x70, 0x74, 0x69, 0x6f, 0x6e, 0x22, 0xb7, 0x02, 0x0a,
	...
	0x2a, 0x2e, 0x62, 0x75, 0x63, 0x6b, 0x65, 0x74, 0x65, 0x65, 0x72, 0x2e, 0x73, 0x75, 0x62, 0x73,
	...
	0x65, 0x74, 0x65, 0x65, 0x72, 0x2f, 0x76, 0x32, 0x2f, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2f, 0x73,
	0x75, 0x62, 0x73, 0x63, 0x72, 0x69, 0x70, 0x74, 0x69, 0x6f, 0x6e, 0x62, 0x06, 0x70, 0x72, 0x6f,
	0x74, 0x6f, 0x33,
}

var (
	file_proto_subscription_recipient_proto_rawDescOnce sync.Once
	file_proto_subscription_recipient_proto_rawDescData = file_proto_subscription_recipient_proto_rawDesc
)

func file_proto_subscription_recipient_proto_rawDescGZIP() []byte {
	file_proto_subscription_recipient_proto_rawDescOnce.Do(func() {
		file_proto_subscription_recipient_proto_rawDescData = protoimpl.X.CompressGZIP(file_proto_subscription_recipient_proto_rawDescData)
	})
	return file_proto_subscription_recipient_proto_rawDescData
}

var file_proto_subscription_recipient_proto_enumTypes = make([]protoimpl.EnumInfo, 2)
var file_proto_subscription_recipient_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_proto_subscription_recipient_proto_goTypes = []interface{}{
	(Recipient_Type)(0),           // 0: bucketeer.subscription.Recipient.Type
	(Recipient_Language)(0),       // 1: bucketeer.subscription.Recipient.Language
	(*Recipient)(nil),             // 2: bucketeer.subscription.Recipient
	(*SlackChannelRecipient)(nil), // 3: bucketeer.subscription.SlackChannelRecipient
}
var file_proto_subscription_recipient_proto_depIdxs = []int32{
	0, // 0: bucketeer.subscription.Recipient.type:type_name -> bucketeer.subscription.Recipient.Type
	3, // 1: bucketeer.subscription.Recipient.slack_channel_recipient:type_name -> bucketeer.subscription.SlackChannelRecipient
	1, // 2: bucketeer.subscription.Recipient.language:type_name -> bucketeer.subscription.Recipient.Language
...
func init() { file_proto_subscription_recipient_proto_init() }
func file_proto_subscription_recipient_proto_init() {
	if File_proto_subscription_recipient_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_proto_subscription_recipient_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_proto_subscription_recipient_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_proto_subscription_recipient_proto_rawDesc,
			NumEnums:      2,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_proto_subscription_recipient_proto_goTypes,
		DependencyIndexes: file_proto_subscription_recipient_proto_depIdxs,
		EnumInfos:         file_proto_subscription_recipient_proto_enumTypes,
		MessageInfos:      file_proto_subscription_recipient_proto_msgTypes,
	}.Build()
	File_proto_subscription_recipient_proto = out.File
	file_proto_subscription_recipient_proto_rawDesc = nil
	file_proto_subscription_recipient_proto_goTypes = nil
	file_proto_subscription_recipient_proto_depIdxs = nil
}
