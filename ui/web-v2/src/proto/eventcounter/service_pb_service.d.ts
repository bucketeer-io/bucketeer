...
import * as proto_eventcounter_service_pb from './service_pb';
...
export class EventCounterServiceClient {
  ...
  getExperimentEvaluationCount(
    ...
    callback: (
      ...
      responseMessage: proto_eventcounter_service_pb.GetExperimentEvaluationCountResponse | null
    ) => void
  ): UnaryResponse;
  getExperimentEvaluationCount(
    requestMessage: proto_eventcounter_service_pb.GetExperimentEvaluationCountRequest,
  ...
  getEvaluationTimeseriesCount(
    ...
    callback: (
      error: ServiceError | null,
      responseMessage: proto_eventcounter_service_pb.GetEvaluationTimeseriesCountResponse | null
    ) => void
  ): UnaryResponse;
  getEvaluationTimeseriesCount(
    requestMessage: proto_eventcounter_service_pb.GetEvaluationTimeseriesCountRequest,
  ...
  getExperimentResult(
    ...
    callback: (
      error: ServiceError | null,
      responseMessage: proto_eventcounter_service_pb.GetExperimentResultResponse | null
    ) => void
  ): UnaryResponse;
  getExperimentResult(
    requestMessage: proto_eventcounter_service_pb.GetExperimentResultRequest,
  ...
  listExperimentResults(
    ...
    callback: (
      error: ServiceError | null,
      responseMessage: proto_eventcounter_service_pb.ListExperimentResultsResponse | null
    ) => void
  ): UnaryResponse;
  listExperimentResults(
    requestMessage: proto_eventcounter_service_pb.ListExperimentResultsRequest,
  ...
  getExperimentGoalCount(
    ...
    callback: (
      error: ServiceError | null,
      responseMessage: proto_eventcounter_service_pb.GetExperimentGoalCountResponse | null
    ) => void
  ): UnaryResponse;
  getExperimentGoalCount(
    requestMessage: proto_eventcounter_service_pb.GetExperimentGoalCountRequest,
  ...
  getMAUCount(
    ...
    callback: (
      error: ServiceError | null,
      responseMessage: proto_eventcounter_service_pb.GetMAUCountResponse | null
    ) => void
  ): UnaryResponse;
  getMAUCount(
    requestMessage: proto_eventcounter_service_pb.GetMAUCountRequest,
  ...
  summarizeMAUCounts(
    ...
    callback: (
      error: ServiceError | null,
      responseMessage: proto_eventcounter_service_pb.SummarizeMAUCountsResponse | null
    ) => void
  ): UnaryResponse;
  summarizeMAUCounts(
    requestMessage: proto_eventcounter_service_pb.SummarizeMAUCountsRequest,
  ...
  getOpsEvaluationUserCount(
    ...
    callback: (
      error: ServiceError | null,
      responseMessage: proto_eventcounter_service_pb.GetOpsEvaluationUserCountResponse | null
    ) => void
  ): UnaryResponse;
  getOpsEvaluationUserCount(
    requestMessage: proto_eventcounter_service_pb.GetOpsEvaluationUserCountRequest,
  ...
  getOpsGoalUserCount(
    ...
    callback: (
      error: ServiceError | null,
      responseMessage: proto_eventcounter_service_pb.GetOpsGoalUserCountResponse | null
    ) => void
  ): UnaryResponse;
  getOpsGoalUserCount(
    requestMessage: proto_eventcounter_service_pb.GetOpsGoalUserCountRequest,
