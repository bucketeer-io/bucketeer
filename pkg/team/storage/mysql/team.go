...
func NewTeamStorage(qe mysqlstorage.QueryExecer) teamstorage.TeamStorage {
...
func (t *teamStorage) ListTeams(
	...
	query, whereArgs := mysqlstorage.ConstructQueryAndWhereArgs(selectTeamsSQL, options)
	...
	countQuery, countWhereArgs := mysqlstorage.ConstructCountQuery(countTeamsSQL, options)
