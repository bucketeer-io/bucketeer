...
export class StopAutoOpsRuleCommand extends jspb.Message {
  ...
  static toObject(includeInstance: boolean, msg: StopAutoOpsRuleCommand): StopAutoOpsRuleCommand.AsObject;
  static extensions: {[key: number]: jspb.ExtensionFieldInfo<jspb.Message>};
  static extensionsBinary: {[key: number]: jspb.ExtensionFieldBinaryInfo<jspb.Message>};
  static serializeBinaryToWriter(message: StopAutoOpsRuleCommand, writer: jspb.BinaryWriter): void;
  static deserializeBinary(bytes: Uint8Array): StopAutoOpsRuleCommand;
  static deserializeBinaryFromReader(message: StopAutoOpsRuleCommand, reader: jspb.BinaryReader): StopAutoOpsRuleCommand;
}
...
export class ChangeAutoOpsStatusCommand extends jspb.Message {
  ...
  setStatus(value: proto_autoops_auto_ops_rule_pb.AutoOpsStatusMap[keyof proto_autoops_auto_ops_rule_pb.AutoOpsStatusMap]): void;

  serializeBinary(): Uint8Array;
  toObject(includeInstance?: boolean): ChangeAutoOpsStatusCommand.AsObject;
  static toObject(includeInstance: boolean, msg: ChangeAutoOpsStatusCommand): ChangeAutoOpsStatusCommand.AsObject;
  static extensions: {[key: number]: jspb.ExtensionFieldInfo<jspb.Message>};
  static extensionsBinary: {[key: number]: jspb.ExtensionFieldBinaryInfo<jspb.Message>};
  static serializeBinaryToWriter(message: ChangeAutoOpsStatusCommand, writer: jspb.BinaryWriter): void;
  static deserializeBinary(bytes: Uint8Array): ChangeAutoOpsStatusCommand;
  static deserializeBinaryFromReader(message: ChangeAutoOpsStatusCommand, reader: jspb.BinaryReader): ChangeAutoOpsStatusCommand;
}
...
export class ExecuteAutoOpsRuleCommand extends jspb.Message {
  hasClause(): boolean;
  clearClause(): void;
  getClause(): proto_autoops_clause_pb.Clause | undefined;
  setClause(value?: proto_autoops_clause_pb.Clause): void;

  serializeBinary(): Uint8Array;
  toObject(includeInstance?: boolean): ExecuteAutoOpsRuleCommand.AsObject;
  static toObject(includeInstance: boolean, msg: ExecuteAutoOpsRuleCommand): ExecuteAutoOpsRuleCommand.AsObject;
  static extensions: {[key: number]: jspb.ExtensionFieldInfo<jspb.Message>};
  static extensionsBinary: {[key: number]: jspb.ExtensionFieldBinaryInfo<jspb.Message>};
  static serializeBinaryToWriter(message: ExecuteAutoOpsRuleCommand, writer: jspb.BinaryWriter): void;
  static deserializeBinary(bytes: Uint8Array): ExecuteAutoOpsRuleCommand;
  static deserializeBinaryFromReader(message: ExecuteAutoOpsRuleCommand, reader: jspb.BinaryReader): ExecuteAutoOpsRuleCommand;
}

export namespace ExecuteAutoOpsRuleCommand {
  export type AsObject = {
    clause?: proto_autoops_clause_pb.Clause.AsObject,
  }
}
