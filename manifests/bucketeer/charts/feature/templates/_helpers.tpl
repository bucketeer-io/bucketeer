...
{{- else -}}
{{ template "feature.fullname" . }}-service-cert
{{- end -}}
{{- end -}}
...
{{- else -}}
{{ template "feature.fullname" . }}-oauth-key
{{- end -}}
{{- end -}}
...
{{- else -}}
{{ template "feature.fullname" . }}-service-token
{{- end -}}
{{- end -}}