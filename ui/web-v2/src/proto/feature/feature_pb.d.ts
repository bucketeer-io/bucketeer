...
export class Feature extends jspb.Message {
  ...
  getLastUsedInfo():
    | proto_feature_feature_last_used_info_pb.FeatureLastUsedInfo
    | undefined;
  setLastUsedInfo(
    value?: proto_feature_feature_last_used_info_pb.FeatureLastUsedInfo
  ): void;
  ...
  setVariationType(
    value: Feature.VariationTypeMap[keyof Feature.VariationTypeMap]
  ): void;
