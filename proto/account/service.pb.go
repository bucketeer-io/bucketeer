...
var file_proto_account_service_proto_rawDesc = []byte{
	...
	0x73, 0x65, 0x32, 0xe8, 0x67, 0x0a, 0x0e, 0x41, 0x63, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x53, 0x65,
	...
	0x20, 0x22, 0x6d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x22, 0x3a, 0x20, 0x22, 0x6e, 0x6f, 0x74,
	0x20, 0x61, 0x75, 0x74, 0x68, 0x6f, 0x72, 0x69, 0x7a, 0x65, 0x64, 0x22, 0x2c, 0x20, 0x22, 0x64,
	0x65, 0x74, 0x61, 0x69, 0x6c, 0x73, 0x22, 0x3a, 0x20, 0x5b, 0x5d, 0x20, 0x7d, 0x42, 0xd7, 0x01,
	...
	0x74, 0x92, 0x41, 0xa2, 0x01, 0x52, 0x89, 0x01, 0x0a, 0x03, 0x35, 0x30, 0x33, 0x12, 0x81, 0x01,
	0x0a, 0x1d, 0x52, 0x65, 0x74, 0x75, 0x72, 0x6e, 0x65, 0x64, 0x20, 0x66, 0x6f, 0x72, 0x20, 0x69,
	0x6e, 0x74, 0x65, 0x72, 0x6e, 0x61, 0x6c, 0x20, 0x65, 0x72, 0x72, 0x6f, 0x72, 0x73, 0x2e, 0x12,
	0x16, 0x0a, 0x14, 0x1a, 0x12, 0x2e, 0x67, 0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x2e, 0x72, 0x70, 0x63,
	...
	0x61, 0x67, 0x65, 0x22, 0x3a, 0x20, 0x22, 0x69, 0x6e, 0x74, 0x65, 0x72, 0x6e, 0x61, 0x6c, 0x22,
	0x2c, 0x20, 0x22, 0x64, 0x65, 0x74, 0x61, 0x69, 0x6c, 0x73, 0x22, 0x3a, 0x20, 0x5b, 0x5d, 0x20,
	0x7d, 0x6a, 0x09, 0x0a, 0x07, 0x41, 0x63, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x6a, 0x09, 0x0a, 0x07,
	0x41, 0x50, 0x49, 0x20, 0x4b, 0x65, 0x79, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x33,
}
...
var file_proto_account_service_proto_msgTypes = make([]protoimpl.MessageInfo, 37)
var file_proto_account_service_proto_goTypes = []interface{}{
	...
	(*ConsoleAccount)(nil),                              // 41: bucketeer.account.ConsoleAccount
	(*environment.Organization)(nil),                    // 42: bucketeer.environment.Organization
	(*CreateAccountV2Command)(nil),                      // 43: bucketeer.account.CreateAccountV2Command
	(*AccountV2)(nil),                                   // 44: bucketeer.account.AccountV2
	(*EnableAccountV2Command)(nil),                      // 45: bucketeer.account.EnableAccountV2Command
	(*DisableAccountV2Command)(nil),                     // 46: bucketeer.account.DisableAccountV2Command
	(*DeleteAccountV2Command)(nil),                      // 47: bucketeer.account.DeleteAccountV2Command
	(*ChangeAccountV2NameCommand)(nil),                  // 48: bucketeer.account.ChangeAccountV2NameCommand
	(*ChangeAccountV2AvatarImageUrlCommand)(nil),        // 49: bucketeer.account.ChangeAccountV2AvatarImageUrlCommand
	(*ChangeAccountV2OrganizationRoleCommand)(nil),      // 50: bucketeer.account.ChangeAccountV2OrganizationRoleCommand
	(*ChangeAccountV2EnvironmentRolesCommand)(nil),      // 51: bucketeer.account.ChangeAccountV2EnvironmentRolesCommand
	...
	(*CreateAPIKeyCommand)(nil),                         // 55: bucketeer.account.CreateAPIKeyCommand
	(*APIKey)(nil),                                      // 56: bucketeer.account.APIKey
	(*ChangeAPIKeyNameCommand)(nil),                     // 57: bucketeer.account.ChangeAPIKeyNameCommand
	(*EnableAPIKeyCommand)(nil),                         // 58: bucketeer.account.EnableAPIKeyCommand
	(*DisableAPIKeyCommand)(nil),                        // 59: bucketeer.account.DisableAPIKeyCommand
	(*EnvironmentAPIKey)(nil),                           // 60: bucketeer.account.EnvironmentAPIKey
	(*CreateSearchFilterCommand)(nil),                   // 61: bucketeer.account.CreateSearchFilterCommand
}
var file_proto_account_service_proto_depIdxs = []int32{
	41, // 0: bucketeer.account.GetMeResponse.account:type_name -> bucketeer.account.ConsoleAccount
	42, // 1: bucketeer.account.GetMyOrganizationsResponse.organizations:type_name -> bucketeer.environment.Organization
	43, // 2: bucketeer.account.CreateAccountV2Request.command:type_name -> bucketeer.account.CreateAccountV2Command
	44, // 3: bucketeer.account.CreateAccountV2Response.account:type_name -> bucketeer.account.AccountV2
	45, // 4: bucketeer.account.EnableAccountV2Request.command:type_name -> bucketeer.account.EnableAccountV2Command
	46, // 5: bucketeer.account.DisableAccountV2Request.command:type_name -> bucketeer.account.DisableAccountV2Command
	47, // 6: bucketeer.account.DeleteAccountV2Request.command:type_name -> bucketeer.account.DeleteAccountV2Command
	48, // 7: bucketeer.account.UpdateAccountV2Request.change_name_command:type_name -> bucketeer.account.ChangeAccountV2NameCommand
	49, // 8: bucketeer.account.UpdateAccountV2Request.change_avatar_url_command:type_name -> bucketeer.account.ChangeAccountV2AvatarImageUrlCommand
	50, // 9: bucketeer.account.UpdateAccountV2Request.change_organization_role_command:type_name -> bucketeer.account.ChangeAccountV2OrganizationRoleCommand
	51, // 10: bucketeer.account.UpdateAccountV2Request.change_environment_roles_command:type_name -> bucketeer.account.ChangeAccountV2EnvironmentRolesCommand
	44, // 11: bucketeer.account.GetAccountV2Response.account:type_name -> bucketeer.account.AccountV2
	44, // 12: bucketeer.account.GetAccountV2ByEnvironmentIDResponse.account:type_name -> bucketeer.account.AccountV2
	...
	52, // 15: bucketeer.account.ListAccountsV2Request.disabled:type_name -> google.protobuf.BoolValue
	53, // 16: bucketeer.account.ListAccountsV2Request.organization_role:type_name -> google.protobuf.Int32Value
	54, // 17: bucketeer.account.ListAccountsV2Request.environment_id:type_name -> google.protobuf.StringValue
	53, // 18: bucketeer.account.ListAccountsV2Request.environment_role:type_name -> google.protobuf.Int32Value
	44, // 19: bucketeer.account.ListAccountsV2Response.accounts:type_name -> bucketeer.account.AccountV2
	55, // 20: bucketeer.account.CreateAPIKeyRequest.command:type_name -> bucketeer.account.CreateAPIKeyCommand
	56, // 21: bucketeer.account.CreateAPIKeyResponse.api_key:type_name -> bucketeer.account.APIKey
	57, // 22: bucketeer.account.ChangeAPIKeyNameRequest.command:type_name -> bucketeer.account.ChangeAPIKeyNameCommand
	58, // 23: bucketeer.account.EnableAPIKeyRequest.command:type_name -> bucketeer.account.EnableAPIKeyCommand
	59, // 24: bucketeer.account.DisableAPIKeyRequest.command:type_name -> bucketeer.account.DisableAPIKeyCommand
	56, // 25: bucketeer.account.GetAPIKeyResponse.api_key:type_name -> bucketeer.account.APIKey
	...
	56, // 29: bucketeer.account.ListAPIKeysResponse.api_keys:type_name -> bucketeer.account.APIKey
	60, // 30: bucketeer.account.GetAPIKeyBySearchingAllEnvironmentsResponse.environment_api_key:type_name -> bucketeer.account.EnvironmentAPIKey
	61, // 31: bucketeer.account.CreateSearchFilterRequest.command:type_name -> bucketeer.account.CreateSearchFilterCommand
	4,  // 32: bucketeer.account.AccountService.GetMe:input_type -> bucketeer.account.GetMeRequest
	6,  // 33: bucketeer.account.AccountService.GetMyOrganizations:input_type -> bucketeer.account.GetMyOrganizationsRequest
	7,  // 34: bucketeer.account.AccountService.GetMyOrganizationsByEmail:input_type -> bucketeer.account.GetMyOrganizationsByEmailRequest
	9,  // 35: bucketeer.account.AccountService.CreateAccountV2:input_type -> bucketeer.account.CreateAccountV2Request
	11, // 36: bucketeer.account.AccountService.EnableAccountV2:input_type -> bucketeer.account.EnableAccountV2Request
	13, // 37: bucketeer.account.AccountService.DisableAccountV2:input_type -> bucketeer.account.DisableAccountV2Request
	17, // 38: bucketeer.account.AccountService.UpdateAccountV2:input_type -> bucketeer.account.UpdateAccountV2Request
	15, // 39: bucketeer.account.AccountService.DeleteAccountV2:input_type -> bucketeer.account.DeleteAccountV2Request
	19, // 40: bucketeer.account.AccountService.GetAccountV2:input_type -> bucketeer.account.GetAccountV2Request
	21, // 41: bucketeer.account.AccountService.GetAccountV2ByEnvironmentID:input_type -> bucketeer.account.GetAccountV2ByEnvironmentIDRequest
	23, // 42: bucketeer.account.AccountService.ListAccountsV2:input_type -> bucketeer.account.ListAccountsV2Request
	25, // 43: bucketeer.account.AccountService.CreateAPIKey:input_type -> bucketeer.account.CreateAPIKeyRequest
	27, // 44: bucketeer.account.AccountService.ChangeAPIKeyName:input_type -> bucketeer.account.ChangeAPIKeyNameRequest
	29, // 45: bucketeer.account.AccountService.EnableAPIKey:input_type -> bucketeer.account.EnableAPIKeyRequest
	31, // 46: bucketeer.account.AccountService.DisableAPIKey:input_type -> bucketeer.account.DisableAPIKeyRequest
