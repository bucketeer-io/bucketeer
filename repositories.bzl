...
def go_repositories():
    ...
    go_repository(
        name = "com_github_ca_dp_godruid",
        importpath = "github.com/ca-dp/godruid",
        sum = "h1:aWiNqopVwXEC1+HzANRIMYWXVsiU5LDAVDL6XMpkJJ0=",
        version = "v0.0.0-20210401093507-918893fdd0d7",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:9SpNVG76gr6InJGxoZ6IuuxaCOQwDAhzyXg+Bs+0Sb4=",
        version = "v6.15.2+incompatible",
    )
    ...
    go_repository(
        name = "com_github_mna_redisc",
        importpath = "github.com/mna/redisc",
        sum = "h1:cup2P6113vVbzNCuYOQtIctHFBGlvGvJi8+GGFPYobU=",
        version = "v1.1.2",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:MNXbyPvd141JJqlU6gJKrczThxJy+kdCNivxZpBQFkw=",
        version = "v2.2.0",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:7ELV9kd3xWoNnXRvGWOMrPiBz/6W47lSwikPlnvMTV8=",
        version = "v0.0.0-20171101201047-2315d5715e36",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:tqo2zmyzPf1+gwTTwhI6W+EXDw4PVSczynpHKFtVAmo=",
        version = "v1.27.0",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:cxOqFgM5RW6mdEyDqAJutFk3qiORK9oHRKi5bPqkY9o=",
        version = "v0.6.4",
    )
    go_repository(
    ...
    go_repository(
        name = "com_google_cloud_go_alloydbconn",
        importpath = "cloud.google.com/go/alloydbconn",
        sum = "h1:p46IfIof8huGKXzQXKqI/11M36EAbrt7DjxMh3yNNvE=",
        version = "v0.2.1",
    )
    ...
    go_repository(
        ...
        sum = "h1:2DCxzxiuoWubL6J0yl4rUtFtIJAX566mcefQS3xy6us=",
        version = "v1.0.0",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:D2Dn0PslpK7Z3B2AvuUHyIC762bDbGJdlmQlCBR71os=",
        version = "v1.25.0",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:0kXPskUMGAXXWJlP05ktEMOV0vmzFQUWw6d+aZJQU8A=",
        version = "v2.4.0",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:HBofEuVSbRgTTAQmE8y9skbElwGgBs1ecH7fxJE7Nrg=",
        version = "v0.8.0",
    )
    go_repository(
