...
var file_proto_account_service_proto_rawDesc = []byte{
	...
	0x65, 0x79, 0x22, 0xe5, 0x03, 0x0a, 0x12, 0x4c, 0x69, 0x73, 0x74, 0x41, 0x50, 0x49, 0x4b, 0x65,
	...
	0x73, 0x61, 0x62, 0x6c, 0x65, 0x64, 0x12, 0x25, 0x0a, 0x0e, 0x65, 0x6e, 0x76, 0x69, 0x72, 0x6f,
	...
	0x74, 0x22, 0x3c, 0x0a, 0x2a, 0x47, 0x65, 0x74, 0x41, 0x50, 0x49, 0x4b, 0x65, 0x79, 0x42, 0x79,
	...
	0x65, 0x72, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x32, 0xf8, 0x74, 0x0a, 0x0e, 0x41,
...
var file_proto_account_service_proto_msgTypes = make([]protoimpl.MessageInfo, 43)
var file_proto_account_service_proto_goTypes = []interface{}{
	...
	(*UpdateAccountV2Request_AccountV2Avatar)(nil),       // 45: bucketeer.account.UpdateAccountV2Request.AccountV2Avatar
	(*UpdateAccountV2Request_OrganizationRoleValue)(nil), // 46: bucketeer.account.UpdateAccountV2Request.OrganizationRoleValue
	(*ConsoleAccount)(nil),                               // 47: bucketeer.account.ConsoleAccount
	(*environment.Organization)(nil),                     // 48: bucketeer.environment.Organization
	(*CreateAccountV2Command)(nil),                       // 49: bucketeer.account.CreateAccountV2Command
	(AccountV2_Role_Organization)(0),                     // 50: bucketeer.account.AccountV2.Role.Organization
	(*AccountV2_EnvironmentRole)(nil),                    // 51: bucketeer.account.AccountV2.EnvironmentRole
	(*AccountV2)(nil),                                    // 52: bucketeer.account.AccountV2
	(*EnableAccountV2Command)(nil),                       // 53: bucketeer.account.EnableAccountV2Command
	(*DisableAccountV2Command)(nil),                      // 54: bucketeer.account.DisableAccountV2Command
	(*DeleteAccountV2Command)(nil),                       // 55: bucketeer.account.DeleteAccountV2Command
	(*ChangeAccountV2NameCommand)(nil),                   // 56: bucketeer.account.ChangeAccountV2NameCommand
	(*ChangeAccountV2AvatarImageUrlCommand)(nil),         // 57: bucketeer.account.ChangeAccountV2AvatarImageUrlCommand
	(*ChangeAccountV2OrganizationRoleCommand)(nil),       // 58: bucketeer.account.ChangeAccountV2OrganizationRoleCommand
	(*ChangeAccountV2EnvironmentRolesCommand)(nil),       // 59: bucketeer.account.ChangeAccountV2EnvironmentRolesCommand
	(*ChangeAccountV2FirstNameCommand)(nil),              // 60: bucketeer.account.ChangeAccountV2FirstNameCommand
	(*ChangeAccountV2LastNameCommand)(nil),               // 61: bucketeer.account.ChangeAccountV2LastNameCommand
	(*ChangeAccountV2LanguageCommand)(nil),               // 62: bucketeer.account.ChangeAccountV2LanguageCommand
	(*ChangeAccountV2LastSeenCommand)(nil),               // 63: bucketeer.account.ChangeAccountV2LastSeenCommand
	(*ChangeAccountV2AvatarCommand)(nil),                 // 64: bucketeer.account.ChangeAccountV2AvatarCommand
	...
	(*CreateAPIKeyCommand)(nil),                          // 69: bucketeer.account.CreateAPIKeyCommand
	(APIKey_Role)(0),                                     // 70: bucketeer.account.APIKey.Role
	(*APIKey)(nil),                                       // 71: bucketeer.account.APIKey
	(*ChangeAPIKeyNameCommand)(nil),                      // 72: bucketeer.account.ChangeAPIKeyNameCommand
	(*EnableAPIKeyCommand)(nil),                          // 73: bucketeer.account.EnableAPIKeyCommand
	(*DisableAPIKeyCommand)(nil),                         // 74: bucketeer.account.DisableAPIKeyCommand
	(*EnvironmentAPIKey)(nil),                            // 75: bucketeer.account.EnvironmentAPIKey
	(*CreateSearchFilterCommand)(nil),                    // 76: bucketeer.account.CreateSearchFilterCommand
	(*ChangeSearchFilterNameCommand)(nil),                // 77: bucketeer.account.ChangeSearchFilterNameCommand
	(*ChangeSearchFilterQueryCommand)(nil),               // 78: bucketeer.account.ChangeSearchFilterQueryCommand
	(*ChangeDefaultSearchFilterCommand)(nil),             // 79: bucketeer.account.ChangeDefaultSearchFilterCommand
	(*DeleteSearchFilterCommand)(nil),                    // 80: bucketeer.account.DeleteSearchFilterCommand
}
var file_proto_account_service_proto_depIdxs = []int32{
	47, // 0: bucketeer.account.GetMeResponse.account:type_name -> bucketeer.account.ConsoleAccount
	48, // 1: bucketeer.account.GetMyOrganizationsResponse.organizations:type_name -> bucketeer.environment.Organization
	49, // 2: bucketeer.account.CreateAccountV2Request.command:type_name -> bucketeer.account.CreateAccountV2Command
	50, // 3: bucketeer.account.CreateAccountV2Request.organization_role:type_name -> bucketeer.account.AccountV2.Role.Organization
	51, // 4: bucketeer.account.CreateAccountV2Request.environment_roles:type_name -> bucketeer.account.AccountV2.EnvironmentRole
	52, // 5: bucketeer.account.CreateAccountV2Response.account:type_name -> bucketeer.account.AccountV2
	53, // 6: bucketeer.account.EnableAccountV2Request.command:type_name -> bucketeer.account.EnableAccountV2Command
	52, // 7: bucketeer.account.EnableAccountV2Response.account:type_name -> bucketeer.account.AccountV2
	54, // 8: bucketeer.account.DisableAccountV2Request.command:type_name -> bucketeer.account.DisableAccountV2Command
	52, // 9: bucketeer.account.DisableAccountV2Response.account:type_name -> bucketeer.account.AccountV2
	55, // 10: bucketeer.account.DeleteAccountV2Request.command:type_name -> bucketeer.account.DeleteAccountV2Command
	56, // 11: bucketeer.account.UpdateAccountV2Request.change_name_command:type_name -> bucketeer.account.ChangeAccountV2NameCommand
	57, // 12: bucketeer.account.UpdateAccountV2Request.change_avatar_url_command:type_name -> bucketeer.account.ChangeAccountV2AvatarImageUrlCommand
	58, // 13: bucketeer.account.UpdateAccountV2Request.change_organization_role_command:type_name -> bucketeer.account.ChangeAccountV2OrganizationRoleCommand
	59, // 14: bucketeer.account.UpdateAccountV2Request.change_environment_roles_command:type_name -> bucketeer.account.ChangeAccountV2EnvironmentRolesCommand
	60, // 15: bucketeer.account.UpdateAccountV2Request.change_first_name_command:type_name -> bucketeer.account.ChangeAccountV2FirstNameCommand
	61, // 16: bucketeer.account.UpdateAccountV2Request.change_last_name_command:type_name -> bucketeer.account.ChangeAccountV2LastNameCommand
	62, // 17: bucketeer.account.UpdateAccountV2Request.change_language_command:type_name -> bucketeer.account.ChangeAccountV2LanguageCommand
	63, // 18: bucketeer.account.UpdateAccountV2Request.change_last_seen_command:type_name -> bucketeer.account.ChangeAccountV2LastSeenCommand
	64, // 19: bucketeer.account.UpdateAccountV2Request.change_avatar_command:type_name -> bucketeer.account.ChangeAccountV2AvatarCommand
	65, // 20: bucketeer.account.UpdateAccountV2Request.name:type_name -> google.protobuf.StringValue
	65, // 21: bucketeer.account.UpdateAccountV2Request.avatar_image_url:type_name -> google.protobuf.StringValue
	46, // 22: bucketeer.account.UpdateAccountV2Request.organization_role:type_name -> bucketeer.account.UpdateAccountV2Request.OrganizationRoleValue
	51, // 23: bucketeer.account.UpdateAccountV2Request.environment_roles:type_name -> bucketeer.account.AccountV2.EnvironmentRole
	65, // 24: bucketeer.account.UpdateAccountV2Request.first_name:type_name -> google.protobuf.StringValue
	65, // 25: bucketeer.account.UpdateAccountV2Request.last_name:type_name -> google.protobuf.StringValue
	65, // 26: bucketeer.account.UpdateAccountV2Request.language:type_name -> google.protobuf.StringValue
	66, // 27: bucketeer.account.UpdateAccountV2Request.last_seen:type_name -> google.protobuf.Int64Value
	45, // 28: bucketeer.account.UpdateAccountV2Request.avatar:type_name -> bucketeer.account.UpdateAccountV2Request.AccountV2Avatar
	52, // 29: bucketeer.account.UpdateAccountV2Response.account:type_name -> bucketeer.account.AccountV2
	52, // 30: bucketeer.account.GetAccountV2Response.account:type_name -> bucketeer.account.AccountV2
	52, // 31: bucketeer.account.GetAccountV2ByEnvironmentIDResponse.account:type_name -> bucketeer.account.AccountV2
	...
	67, // 34: bucketeer.account.ListAccountsV2Request.disabled:type_name -> google.protobuf.BoolValue
	68, // 35: bucketeer.account.ListAccountsV2Request.organization_role:type_name -> google.protobuf.Int32Value
	65, // 36: bucketeer.account.ListAccountsV2Request.environment_id:type_name -> google.protobuf.StringValue
	68, // 37: bucketeer.account.ListAccountsV2Request.environment_role:type_name -> google.protobuf.Int32Value
	52, // 38: bucketeer.account.ListAccountsV2Response.accounts:type_name -> bucketeer.account.AccountV2
	69, // 39: bucketeer.account.CreateAPIKeyRequest.command:type_name -> bucketeer.account.CreateAPIKeyCommand
	70, // 40: bucketeer.account.CreateAPIKeyRequest.role:type_name -> bucketeer.account.APIKey.Role
	71, // 41: bucketeer.account.CreateAPIKeyResponse.api_key:type_name -> bucketeer.account.APIKey
	72, // 42: bucketeer.account.ChangeAPIKeyNameRequest.command:type_name -> bucketeer.account.ChangeAPIKeyNameCommand
	73, // 43: bucketeer.account.EnableAPIKeyRequest.command:type_name -> bucketeer.account.EnableAPIKeyCommand
	74, // 44: bucketeer.account.DisableAPIKeyRequest.command:type_name -> bucketeer.account.DisableAPIKeyCommand
	71, // 45: bucketeer.account.GetAPIKeyResponse.api_key:type_name -> bucketeer.account.APIKey
	...
	67, // 48: bucketeer.account.ListAPIKeysRequest.disabled:type_name -> google.protobuf.BoolValue
	71, // 49: bucketeer.account.ListAPIKeysResponse.api_keys:type_name -> bucketeer.account.APIKey
	75, // 50: bucketeer.account.GetAPIKeyBySearchingAllEnvironmentsResponse.environment_api_key:type_name -> bucketeer.account.EnvironmentAPIKey
	76, // 51: bucketeer.account.CreateSearchFilterRequest.command:type_name -> bucketeer.account.CreateSearchFilterCommand
	77, // 52: bucketeer.account.UpdateSearchFilterRequest.change_name_command:type_name -> bucketeer.account.ChangeSearchFilterNameCommand
	78, // 53: bucketeer.account.UpdateSearchFilterRequest.change_query_command:type_name -> bucketeer.account.ChangeSearchFilterQueryCommand
	79, // 54: bucketeer.account.UpdateSearchFilterRequest.change_default_filter_command:type_name -> bucketeer.account.ChangeDefaultSearchFilterCommand
	80, // 55: bucketeer.account.DeleteSearchFilterRequest.command:type_name -> bucketeer.account.DeleteSearchFilterCommand
	50, // 56: bucketeer.account.UpdateAccountV2Request.OrganizationRoleValue.role:type_name -> bucketeer.account.AccountV2.Role.Organization
	4,  // 57: bucketeer.account.AccountService.GetMe:input_type -> bucketeer.account.GetMeRequest
	6,  // 58: bucketeer.account.AccountService.GetMyOrganizations:input_type -> bucketeer.account.GetMyOrganizationsRequest
	7,  // 59: bucketeer.account.AccountService.GetMyOrganizationsByEmail:input_type -> bucketeer.account.GetMyOrganizationsByEmailRequest
	9,  // 60: bucketeer.account.AccountService.CreateAccountV2:input_type -> bucketeer.account.CreateAccountV2Request
	11, // 61: bucketeer.account.AccountService.EnableAccountV2:input_type -> bucketeer.account.EnableAccountV2Request
	13, // 62: bucketeer.account.AccountService.DisableAccountV2:input_type -> bucketeer.account.DisableAccountV2Request
	17, // 63: bucketeer.account.AccountService.UpdateAccountV2:input_type -> bucketeer.account.UpdateAccountV2Request
	15, // 64: bucketeer.account.AccountService.DeleteAccountV2:input_type -> bucketeer.account.DeleteAccountV2Request
	19, // 65: bucketeer.account.AccountService.GetAccountV2:input_type -> bucketeer.account.GetAccountV2Request
	21, // 66: bucketeer.account.AccountService.GetAccountV2ByEnvironmentID:input_type -> bucketeer.account.GetAccountV2ByEnvironmentIDRequest
	23, // 67: bucketeer.account.AccountService.ListAccountsV2:input_type -> bucketeer.account.ListAccountsV2Request
	25, // 68: bucketeer.account.AccountService.CreateAPIKey:input_type -> bucketeer.account.CreateAPIKeyRequest
	27, // 69: bucketeer.account.AccountService.ChangeAPIKeyName:input_type -> bucketeer.account.ChangeAPIKeyNameRequest
	29, // 70: bucketeer.account.AccountService.EnableAPIKey:input_type -> bucketeer.account.EnableAPIKeyRequest
	31, // 71: bucketeer.account.AccountService.DisableAPIKey:input_type -> bucketeer.account.DisableAPIKeyRequest
	33, // 72: bucketeer.account.AccountService.GetAPIKey:input_type -> bucketeer.account.GetAPIKeyRequest
	35, // 73: bucketeer.account.AccountService.ListAPIKeys:input_type -> bucketeer.account.ListAPIKeysRequest
	37, // 74: bucketeer.account.AccountService.GetAPIKeyBySearchingAllEnvironments:input_type -> bucketeer.account.GetAPIKeyBySearchingAllEnvironmentsRequest
	39, // 75: bucketeer.account.AccountService.CreateSearchFilter:input_type -> bucketeer.account.CreateSearchFilterRequest
	41, // 76: bucketeer.account.AccountService.UpdateSearchFilter:input_type -> bucketeer.account.UpdateSearchFilterRequest
	43, // 77: bucketeer.account.AccountService.DeleteSearchFilter:input_type -> bucketeer.account.DeleteSearchFilterRequest
	5,  // 78: bucketeer.account.AccountService.GetMe:output_type -> bucketeer.account.GetMeResponse
	8,  // 79: bucketeer.account.AccountService.GetMyOrganizations:output_type -> bucketeer.account.GetMyOrganizationsResponse
	8,  // 80: bucketeer.account.AccountService.GetMyOrganizationsByEmail:output_type -> bucketeer.account.GetMyOrganizationsResponse
	10, // 81: bucketeer.account.AccountService.CreateAccountV2:output_type -> bucketeer.account.CreateAccountV2Response
	12, // 82: bucketeer.account.AccountService.EnableAccountV2:output_type -> bucketeer.account.EnableAccountV2Response
	14, // 83: bucketeer.account.AccountService.DisableAccountV2:output_type -> bucketeer.account.DisableAccountV2Response
	18, // 84: bucketeer.account.AccountService.UpdateAccountV2:output_type -> bucketeer.account.UpdateAccountV2Response
	16, // 85: bucketeer.account.AccountService.DeleteAccountV2:output_type -> bucketeer.account.DeleteAccountV2Response
	20, // 86: bucketeer.account.AccountService.GetAccountV2:output_type -> bucketeer.account.GetAccountV2Response
	22, // 87: bucketeer.account.AccountService.GetAccountV2ByEnvironmentID:output_type -> bucketeer.account.GetAccountV2ByEnvironmentIDResponse
	24, // 88: bucketeer.account.AccountService.ListAccountsV2:output_type -> bucketeer.account.ListAccountsV2Response
	26, // 89: bucketeer.account.AccountService.CreateAPIKey:output_type -> bucketeer.account.CreateAPIKeyResponse
	28, // 90: bucketeer.account.AccountService.ChangeAPIKeyName:output_type -> bucketeer.account.ChangeAPIKeyNameResponse
	30, // 91: bucketeer.account.AccountService.EnableAPIKey:output_type -> bucketeer.account.EnableAPIKeyResponse
	32, // 92: bucketeer.account.AccountService.DisableAPIKey:output_type -> bucketeer.account.DisableAPIKeyResponse
	34, // 93: bucketeer.account.AccountService.GetAPIKey:output_type -> bucketeer.account.GetAPIKeyResponse
	36, // 94: bucketeer.account.AccountService.ListAPIKeys:output_type -> bucketeer.account.ListAPIKeysResponse
	38, // 95: bucketeer.account.AccountService.GetAPIKeyBySearchingAllEnvironments:output_type -> bucketeer.account.GetAPIKeyBySearchingAllEnvironmentsResponse
	40, // 96: bucketeer.account.AccountService.CreateSearchFilter:output_type -> bucketeer.account.CreateSearchFilterResponse
	42, // 97: bucketeer.account.AccountService.UpdateSearchFilter:output_type -> bucketeer.account.UpdateSearchFilterResponse
	44, // 98: bucketeer.account.AccountService.DeleteSearchFilter:output_type -> bucketeer.account.DeleteSearchFilterResponse
