...
import (
	...
	postgres "github.com/bucketeer-io/bucketeer/v2/pkg/storage/v2/postgres"
)
...
func (m *MockExecer) ExecContext(ctx context.Context, query string, args ...any) (postgres.Result, error) {
	m.ctrl.T.Helper()
...
func (m *MockQueryer) QueryContext(ctx context.Context, query string, args ...any) (postgres.Rows, error) {
	m.ctrl.T.Helper()
	varargs := []any{ctx, query}
	for _, a := range args {
		varargs = append(varargs, a)
...
func (m *MockQueryer) QueryRowContext(ctx context.Context, query string, args ...any) postgres.Row {
	m.ctrl.T.Helper()
	varargs := []any{ctx, query}
	for _, a := range args {
		varargs = append(varargs, a)
...
// ExecContext mocks base method.
func (m *MockQueryExecer) ExecContext(ctx context.Context, query string, args ...any) (postgres.Result, error) {
	m.ctrl.T.Helper()
	varargs := []any{ctx, query}
	for _, a := range args {
		varargs = append(varargs, a)
...
// QueryContext mocks base method.
func (m *MockQueryExecer) QueryContext(ctx context.Context, query string, args ...any) (postgres.Rows, error) {
	m.ctrl.T.Helper()
	varargs := []any{ctx, query}
	for _, a := range args {
		varargs = append(varargs, a)
...
// QueryRowContext mocks base method.
func (m *MockQueryExecer) QueryRowContext(ctx context.Context, query string, args ...any) postgres.Row {
	m.ctrl.T.Helper()
	varargs := []any{ctx, query}
	for _, a := range args {
		varargs = append(varargs, a)
...
// ExecContext mocks base method.
func (m *MockClient) ExecContext(ctx context.Context, query string, args ...any) (postgres.Result, error) {
	m.ctrl.T.Helper()
	varargs := []any{ctx, query}
	for _, a := range args {
		varargs = append(varargs, a)
...
// QueryContext mocks base method.
func (m *MockClient) QueryContext(ctx context.Context, query string, args ...any) (postgres.Rows, error) {
	m.ctrl.T.Helper()
	varargs := []any{ctx, query}
	for _, a := range args {
		varargs = append(varargs, a)
...
// QueryRowContext mocks base method.
func (m *MockClient) QueryRowContext(ctx context.Context, query string, args ...any) postgres.Row {
	m.ctrl.T.Helper()
	varargs := []any{ctx, query}
	for _, a := range args {
		varargs = append(varargs, a)
...
func (m *MockClient) RunInTransactionV2(ctx context.Context, f func(context.Context, postgres.Transaction) error) error {
	m.ctrl.T.Helper()
