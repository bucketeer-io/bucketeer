...
type AutoOpsExecutor interface {
	ExecuteAutoOps(ctx context.Context, environmentNamespace, ruleID string) error
}
...
func (e *autoOpsExecutor) ExecuteAutoOps(ctx context.Context, environmentNamespace, ruleID string) error {
