...
func (m *MockMultiGetDeleteCountCache) Increment(key string, expire time.Duration) (int64, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Increment", key, expire)
	ret0, _ := ret[0].(int64)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (mr *MockMultiGetDeleteCountCacheMockRecorder) Increment(key, expire interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Increment", reflect.TypeOf((*MockMultiGetDeleteCountCache)(nil).Increment), key, expire)
}
...
// Increment mocks base method.
func (m *MockCounter) Increment(key string, expire time.Duration) (int64, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Increment", key, expire)
	ret0, _ := ret[0].(int64)
	ret1, _ := ret[1].(error)
...
// Increment indicates an expected call of Increment.
func (mr *MockCounterMockRecorder) Increment(key, expire interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Increment", reflect.TypeOf((*MockCounter)(nil).Increment), key, expire)
}
