...
func NewOpsCountStorage(qe pgstorage.QueryExecer) v2os.OpsCountStorage {
...
func (s *opsCountStorage) ListOpsCounts(
	...
	query, whereArgs := pgstorage.ConstructQueryAndWhereArgs(selectOpsCountsSQL, options)
...
func listOpsCountsOptionsFromParams(p v2os.ListOpsCountsParams) (*pgstorage.ListOptions, error) {
