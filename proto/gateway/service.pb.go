...
var file_proto_gateway_service_proto_rawDesc = []byte{
	...
	0x65, 0x32, 0xe8, 0x6e, 0x0a, 0x07, 0x47, 0x61, 0x74, 0x65, 0x77, 0x61, 0x79, 0x12, 0xb0, 0x02,
	...
	0x6f, 0x75, 0x74, 0x73, 0x2e, 0x65, 0x78, 0x65, 0x63, 0x75, 0x74, 0x65, 0x42, 0x84, 0x06, 0x5a,
	...
	0x65, 0x72, 0x2f, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2f, 0x67, 0x61, 0x74, 0x65, 0x77, 0x61, 0x79,
...
var file_proto_gateway_service_proto_msgTypes = make([]protoimpl.MessageInfo, 101)
var file_proto_gateway_service_proto_goTypes = []interface{}{
	...
	(*GetEvaluationsRequest_UserEvaluationCondition)(nil),        // 98: bucketeer.gateway.GetEvaluationsRequest.UserEvaluationCondition
	(*RegisterEventsResponse_Error)(nil),                         // 99: bucketeer.gateway.RegisterEventsResponse.Error
	nil,                                                          // 100: bucketeer.gateway.RegisterEventsResponse.ErrorsEntry
	(client.SourceId)(0),                                         // 101: bucketeer.event.client.SourceId
	(*feature.Feature)(nil),                                      // 102: bucketeer.feature.Feature
	(*feature.SegmentUsers)(nil),                                 // 103: bucketeer.feature.SegmentUsers
	(*user.User)(nil),                                            // 104: bucketeer.user.User
	(feature.UserEvaluations_State)(0),                           // 105: bucketeer.feature.UserEvaluations.State
	(*feature.UserEvaluations)(nil),                              // 106: bucketeer.feature.UserEvaluations
	(*feature.Evaluation)(nil),                                   // 107: bucketeer.feature.Evaluation
	(*client.Event)(nil),                                         // 108: bucketeer.event.client.Event
	(feature.Feature_VariationType)(0),                           // 109: bucketeer.feature.Feature.VariationType
	(*feature.Variation)(nil),                                    // 110: bucketeer.feature.Variation
	(*wrapperspb.Int32Value)(nil),                                // 111: google.protobuf.Int32Value
	(feature.ListFeaturesRequest_OrderBy)(0),                     // 112: bucketeer.feature.ListFeaturesRequest.OrderBy
	(feature.ListFeaturesRequest_OrderDirection)(0),              // 113: bucketeer.feature.ListFeaturesRequest.OrderDirection
	(*wrapperspb.StringValue)(nil),                               // 114: google.protobuf.StringValue
	(*common.StringListValue)(nil),                               // 115: bucketeer.common.StringListValue
	(*wrapperspb.BoolValue)(nil),                                 // 116: google.protobuf.BoolValue
	(*feature.Strategy)(nil),                                     // 117: bucketeer.feature.Strategy
	(*feature.VariationChange)(nil),                              // 118: bucketeer.feature.VariationChange
	(*feature.RuleChange)(nil),                                   // 119: bucketeer.feature.RuleChange
	(*feature.PrerequisiteChange)(nil),                           // 120: bucketeer.feature.PrerequisiteChange
	(*feature.TargetChange)(nil),                                 // 121: bucketeer.feature.TargetChange
	(*feature.TagChange)(nil),                                    // 122: bucketeer.feature.TagChange
	(push.ListPushesRequest_OrderBy)(0),                          // 123: bucketeer.push.ListPushesRequest.OrderBy
	(push.ListPushesRequest_OrderDirection)(0),                   // 124: bucketeer.push.ListPushesRequest.OrderDirection
	(*push.Push)(nil),                                            // 125: bucketeer.push.Push
	(account.AccountV2_Role_Organization)(0),                     // 126: bucketeer.account.AccountV2.Role.Organization
	(*account.AccountV2_EnvironmentRole)(nil),                    // 127: bucketeer.account.AccountV2.EnvironmentRole
	(*account.AccountV2)(nil),                                    // 128: bucketeer.account.AccountV2
	(*account.UpdateAccountV2Request_OrganizationRoleValue)(nil), // 129: bucketeer.account.UpdateAccountV2Request.OrganizationRoleValue
	(*wrapperspb.Int64Value)(nil),                                // 130: google.protobuf.Int64Value
	(*account.UpdateAccountV2Request_AccountV2Avatar)(nil),       // 131: bucketeer.account.UpdateAccountV2Request.AccountV2Avatar
	(*account.ConsoleAccount)(nil),                               // 132: bucketeer.account.ConsoleAccount
	(account.ListAccountsV2Request_OrderBy)(0),                   // 133: bucketeer.account.ListAccountsV2Request.OrderBy
	(account.ListAccountsV2Request_OrderDirection)(0),            // 134: bucketeer.account.ListAccountsV2Request.OrderDirection
	(*coderef.CodeReference)(nil),                                // 135: bucketeer.coderef.CodeReference
	(coderef.ListCodeReferencesRequest_OrderBy)(0),               // 136: bucketeer.coderef.ListCodeReferencesRequest.OrderBy
	(coderef.ListCodeReferencesRequest_OrderDirection)(0),        // 137: bucketeer.coderef.ListCodeReferencesRequest.OrderDirection
	(coderef.CodeReference_RepositoryType)(0),                    // 138: bucketeer.coderef.CodeReference.RepositoryType
	(*feature.Segment)(nil),                                      // 139: bucketeer.feature.Segment
	(feature.ListSegmentsRequest_OrderBy)(0),                     // 140: bucketeer.feature.ListSegmentsRequest.OrderBy
	(feature.ListSegmentsRequest_OrderDirection)(0),              // 141: bucketeer.feature.ListSegmentsRequest.OrderDirection
	(feature.SegmentUser_State)(0),                               // 142: bucketeer.feature.SegmentUser.State
	(*auditlog.AuditLog)(nil),                                    // 143: bucketeer.auditlog.AuditLog
	(auditlog.ListAuditLogsRequest_OrderBy)(0),                   // 144: bucketeer.auditlog.ListAuditLogsRequest.OrderBy
	(auditlog.ListAuditLogsRequest_OrderDirection)(0),            // 145: bucketeer.auditlog.ListAuditLogsRequest.OrderDirection
	(auditlog.ListFeatureHistoryRequest_OrderBy)(0),              // 146: bucketeer.auditlog.ListFeatureHistoryRequest.OrderBy
	(auditlog.ListFeatureHistoryRequest_OrderDirection)(0),       // 147: bucketeer.auditlog.ListFeatureHistoryRequest.OrderDirection
	(*autoops.AutoOpsRule)(nil),                                  // 148: bucketeer.autoops.AutoOpsRule
	(autoops.OpsType)(0),                                         // 149: bucketeer.autoops.OpsType
	(*autoops.OpsEventRateClause)(nil),                           // 150: bucketeer.autoops.OpsEventRateClause
	(*autoops.DatetimeClause)(nil),                               // 151: bucketeer.autoops.DatetimeClause
	(*autoops.OpsEventRateClauseChange)(nil),                     // 152: bucketeer.autoops.OpsEventRateClauseChange
	(*autoops.DatetimeClauseChange)(nil),                         // 153: bucketeer.autoops.DatetimeClauseChange
	(*autoops.ProgressiveRolloutManualScheduleClause)(nil),       // 154: bucketeer.autoops.ProgressiveRolloutManualScheduleClause
	(*autoops.ProgressiveRolloutTemplateScheduleClause)(nil),     // 155: bucketeer.autoops.ProgressiveRolloutTemplateScheduleClause
	(*autoops.ProgressiveRollout)(nil),                           // 156: bucketeer.autoops.ProgressiveRollout
	(autoops.ProgressiveRollout_StoppedBy)(0),                    // 157: bucketeer.autoops.ProgressiveRollout.StoppedBy
	(autoops.ListProgressiveRolloutsRequest_OrderBy)(0),          // 158: bucketeer.autoops.ListProgressiveRolloutsRequest.OrderBy
	(autoops.ListProgressiveRolloutsRequest_OrderDirection)(0),   // 159: bucketeer.autoops.ListProgressiveRolloutsRequest.OrderDirection
	(autoops.ProgressiveRollout_Status)(0),                       // 160: bucketeer.autoops.ProgressiveRollout.Status
	(autoops.ProgressiveRollout_Type)(0),                         // 161: bucketeer.autoops.ProgressiveRollout.Type
}
var file_proto_gateway_service_proto_depIdxs = []int32{
	101, // 0: bucketeer.gateway.GetFeatureFlagsRequest.source_id:type_name -> bucketeer.event.client.SourceId
	102, // 1: bucketeer.gateway.GetFeatureFlagsResponse.features:type_name -> bucketeer.feature.Feature
	101, // 2: bucketeer.gateway.GetSegmentUsersRequest.source_id:type_name -> bucketeer.event.client.SourceId
	103, // 3: bucketeer.gateway.GetSegmentUsersResponse.segment_users:type_name -> bucketeer.feature.SegmentUsers
	104, // 4: bucketeer.gateway.GetEvaluationsRequest.user:type_name -> bucketeer.user.User
	101, // 5: bucketeer.gateway.GetEvaluationsRequest.source_id:type_name -> bucketeer.event.client.SourceId
	98,  // 6: bucketeer.gateway.GetEvaluationsRequest.user_evaluation_condition:type_name -> bucketeer.gateway.GetEvaluationsRequest.UserEvaluationCondition
	105, // 7: bucketeer.gateway.GetEvaluationsResponse.state:type_name -> bucketeer.feature.UserEvaluations.State
	106, // 8: bucketeer.gateway.GetEvaluationsResponse.evaluations:type_name -> bucketeer.feature.UserEvaluations
	104, // 9: bucketeer.gateway.GetEvaluationRequest.user:type_name -> bucketeer.user.User
	101, // 10: bucketeer.gateway.GetEvaluationRequest.source_id:type_name -> bucketeer.event.client.SourceId
	107, // 11: bucketeer.gateway.GetEvaluationResponse.evaluation:type_name -> bucketeer.feature.Evaluation
	108, // 12: bucketeer.gateway.RegisterEventsRequest.events:type_name -> bucketeer.event.client.Event
	101, // 13: bucketeer.gateway.RegisterEventsRequest.source_id:type_name -> bucketeer.event.client.SourceId
	100, // 14: bucketeer.gateway.RegisterEventsResponse.errors:type_name -> bucketeer.gateway.RegisterEventsResponse.ErrorsEntry
	104, // 15: bucketeer.gateway.DebugEvaluateFeaturesRequest.users:type_name -> bucketeer.user.User
	107, // 16: bucketeer.gateway.DebugEvaluateFeaturesResponse.evaluations:type_name -> bucketeer.feature.Evaluation
	109, // 17: bucketeer.gateway.CreateFeatureRequest.variation_type:type_name -> bucketeer.feature.Feature.VariationType
	110, // 18: bucketeer.gateway.CreateFeatureRequest.variations:type_name -> bucketeer.feature.Variation
	102, // 19: bucketeer.gateway.CreateFeatureResponse.feature:type_name -> bucketeer.feature.Feature
	111, // 20: bucketeer.gateway.GetFeatureRequest.feature_version:type_name -> google.protobuf.Int32Value
	102, // 21: bucketeer.gateway.GetFeatureResponse.feature:type_name -> bucketeer.feature.Feature
	112, // 22: bucketeer.gateway.ListFeaturesRequest.order_by:type_name -> bucketeer.feature.ListFeaturesRequest.OrderBy
	113, // 23: bucketeer.gateway.ListFeaturesRequest.order_direction:type_name -> bucketeer.feature.ListFeaturesRequest.OrderDirection
	102, // 24: bucketeer.gateway.ListFeaturesResponse.features:type_name -> bucketeer.feature.Feature
	114, // 25: bucketeer.gateway.UpdateFeatureRequest.name:type_name -> google.protobuf.StringValue
	114, // 26: bucketeer.gateway.UpdateFeatureRequest.description:type_name -> google.protobuf.StringValue
	115, // 27: bucketeer.gateway.UpdateFeatureRequest.tags:type_name -> bucketeer.common.StringListValue
	116, // 28: bucketeer.gateway.UpdateFeatureRequest.enabled:type_name -> google.protobuf.BoolValue
	116, // 29: bucketeer.gateway.UpdateFeatureRequest.archived:type_name -> google.protobuf.BoolValue
	117, // 30: bucketeer.gateway.UpdateFeatureRequest.default_strategy:type_name -> bucketeer.feature.Strategy
	114, // 31: bucketeer.gateway.UpdateFeatureRequest.off_variation:type_name -> google.protobuf.StringValue
	118, // 32: bucketeer.gateway.UpdateFeatureRequest.variation_changes:type_name -> bucketeer.feature.VariationChange
	119, // 33: bucketeer.gateway.UpdateFeatureRequest.rule_changes:type_name -> bucketeer.feature.RuleChange
	120, // 34: bucketeer.gateway.UpdateFeatureRequest.prerequisite_changes:type_name -> bucketeer.feature.PrerequisiteChange
	121, // 35: bucketeer.gateway.UpdateFeatureRequest.target_changes:type_name -> bucketeer.feature.TargetChange
	122, // 36: bucketeer.gateway.UpdateFeatureRequest.tag_changes:type_name -> bucketeer.feature.TagChange
	102, // 37: bucketeer.gateway.UpdateFeatureResponse.feature:type_name -> bucketeer.feature.Feature
	123, // 38: bucketeer.gateway.ListPushesRequest.order_by:type_name -> bucketeer.push.ListPushesRequest.OrderBy
	124, // 39: bucketeer.gateway.ListPushesRequest.order_direction:type_name -> bucketeer.push.ListPushesRequest.OrderDirection
	125, // 40: bucketeer.gateway.ListPushesResponse.pushes:type_name -> bucketeer.push.Push
	125, // 41: bucketeer.gateway.CreatePushResponse.push:type_name -> bucketeer.push.Push
	125, // 42: bucketeer.gateway.GetPushResponse.push:type_name -> bucketeer.push.Push
	114, // 43: bucketeer.gateway.UpdatePushRequest.name:type_name -> google.protobuf.StringValue
	116, // 44: bucketeer.gateway.UpdatePushRequest.deleted:type_name -> google.protobuf.BoolValue
	125, // 45: bucketeer.gateway.UpdatePushResponse.push:type_name -> bucketeer.push.Push
	126, // 46: bucketeer.gateway.CreateAccountV2Request.organization_role:type_name -> bucketeer.account.AccountV2.Role.Organization
	127, // 47: bucketeer.gateway.CreateAccountV2Request.environment_roles:type_name -> bucketeer.account.AccountV2.EnvironmentRole
	128, // 48: bucketeer.gateway.CreateAccountV2Response.account:type_name -> bucketeer.account.AccountV2
	114, // 49: bucketeer.gateway.UpdateAccountV2Request.name:type_name -> google.protobuf.StringValue
	114, // 50: bucketeer.gateway.UpdateAccountV2Request.avatar_image_url:type_name -> google.protobuf.StringValue
	129, // 51: bucketeer.gateway.UpdateAccountV2Request.organization_role:type_name -> bucketeer.account.UpdateAccountV2Request.OrganizationRoleValue
	127, // 52: bucketeer.gateway.UpdateAccountV2Request.environment_roles:type_name -> bucketeer.account.AccountV2.EnvironmentRole
	114, // 53: bucketeer.gateway.UpdateAccountV2Request.first_name:type_name -> google.protobuf.StringValue
	114, // 54: bucketeer.gateway.UpdateAccountV2Request.last_name:type_name -> google.protobuf.StringValue
	114, // 55: bucketeer.gateway.UpdateAccountV2Request.language:type_name -> google.protobuf.StringValue
	130, // 56: bucketeer.gateway.UpdateAccountV2Request.last_seen:type_name -> google.protobuf.Int64Value
	131, // 57: bucketeer.gateway.UpdateAccountV2Request.avatar:type_name -> bucketeer.account.UpdateAccountV2Request.AccountV2Avatar
	116, // 58: bucketeer.gateway.UpdateAccountV2Request.disabled:type_name -> google.protobuf.BoolValue
	116, // 59: bucketeer.gateway.UpdateAccountV2Request.deleted:type_name -> google.protobuf.BoolValue
	128, // 60: bucketeer.gateway.UpdateAccountV2Response.account:type_name -> bucketeer.account.AccountV2
	128, // 61: bucketeer.gateway.GetAccountV2Response.account:type_name -> bucketeer.account.AccountV2
	128, // 62: bucketeer.gateway.GetAccountV2ByEnvironmentIDResponse.account:type_name -> bucketeer.account.AccountV2
	132, // 63: bucketeer.gateway.GetMeResponse.account:type_name -> bucketeer.account.ConsoleAccount
	133, // 64: bucketeer.gateway.ListAccountsV2Request.order_by:type_name -> bucketeer.account.ListAccountsV2Request.OrderBy
	134, // 65: bucketeer.gateway.ListAccountsV2Request.order_direction:type_name -> bucketeer.account.ListAccountsV2Request.OrderDirection
	116, // 66: bucketeer.gateway.ListAccountsV2Request.disabled:type_name -> google.protobuf.BoolValue
	111, // 67: bucketeer.gateway.ListAccountsV2Request.organization_role:type_name -> google.protobuf.Int32Value
	114, // 68: bucketeer.gateway.ListAccountsV2Request.environment_id:type_name -> google.protobuf.StringValue
	111, // 69: bucketeer.gateway.ListAccountsV2Request.environment_role:type_name -> google.protobuf.Int32Value
	128, // 70: bucketeer.gateway.ListAccountsV2Response.accounts:type_name -> bucketeer.account.AccountV2
	135, // 71: bucketeer.gateway.GetCodeReferenceResponse.code_reference:type_name -> bucketeer.coderef.CodeReference
	136, // 72: bucketeer.gateway.ListCodeReferencesRequest.order_by:type_name -> bucketeer.coderef.ListCodeReferencesRequest.OrderBy
	137, // 73: bucketeer.gateway.ListCodeReferencesRequest.order_direction:type_name -> bucketeer.coderef.ListCodeReferencesRequest.OrderDirection
	135, // 74: bucketeer.gateway.ListCodeReferencesResponse.code_references:type_name -> bucketeer.coderef.CodeReference
	138, // 75: bucketeer.gateway.CreateCodeReferenceRequest.repository_type:type_name -> bucketeer.coderef.CodeReference.RepositoryType
	135, // 76: bucketeer.gateway.CreateCodeReferenceResponse.code_reference:type_name -> bucketeer.coderef.CodeReference
	135, // 77: bucketeer.gateway.UpdateCodeReferenceResponse.code_reference:type_name -> bucketeer.coderef.CodeReference
	139, // 78: bucketeer.gateway.CreateSegmentResponse.segment:type_name -> bucketeer.feature.Segment
	139, // 79: bucketeer.gateway.GetSegmentResponse.segment:type_name -> bucketeer.feature.Segment
	140, // 80: bucketeer.gateway.ListSegmentsRequest.order_by:type_name -> bucketeer.feature.ListSegmentsRequest.OrderBy
	141, // 81: bucketeer.gateway.ListSegmentsRequest.order_direction:type_name -> bucketeer.feature.ListSegmentsRequest.OrderDirection
	111, // 82: bucketeer.gateway.ListSegmentsRequest.status:type_name -> google.protobuf.Int32Value
	116, // 83: bucketeer.gateway.ListSegmentsRequest.is_in_use_status:type_name -> google.protobuf.BoolValue
	139, // 84: bucketeer.gateway.ListSegmentsResponse.segments:type_name -> bucketeer.feature.Segment
	114, // 85: bucketeer.gateway.UpdateSegmentRequest.name:type_name -> google.protobuf.StringValue
	114, // 86: bucketeer.gateway.UpdateSegmentRequest.description:type_name -> google.protobuf.StringValue
	139, // 87: bucketeer.gateway.UpdateSegmentResponse.segment:type_name -> bucketeer.feature.Segment
	142, // 88: bucketeer.gateway.BulkUploadSegmentUsersRequest.state:type_name -> bucketeer.feature.SegmentUser.State
	143, // 89: bucketeer.gateway.GetAuditLogResponse.audit_log:type_name -> bucketeer.auditlog.AuditLog
	144, // 90: bucketeer.gateway.ListAuditLogsRequest.order_by:type_name -> bucketeer.auditlog.ListAuditLogsRequest.OrderBy
	145, // 91: bucketeer.gateway.ListAuditLogsRequest.order_direction:type_name -> bucketeer.auditlog.ListAuditLogsRequest.OrderDirection
	111, // 92: bucketeer.gateway.ListAuditLogsRequest.entity_type:type_name -> google.protobuf.Int32Value
	143, // 93: bucketeer.gateway.ListAuditLogsResponse.audit_logs:type_name -> bucketeer.auditlog.AuditLog
	146, // 94: bucketeer.gateway.ListFeatureHistoryRequest.order_by:type_name -> bucketeer.auditlog.ListFeatureHistoryRequest.OrderBy
	147, // 95: bucketeer.gateway.ListFeatureHistoryRequest.order_direction:type_name -> bucketeer.auditlog.ListFeatureHistoryRequest.OrderDirection
	143, // 96: bucketeer.gateway.ListFeatureHistoryResponse.audit_logs:type_name -> bucketeer.auditlog.AuditLog
	148, // 97: bucketeer.gateway.GetAutoOpsRuleResponse.auto_ops_rule:type_name -> bucketeer.autoops.AutoOpsRule
	149, // 98: bucketeer.gateway.CreateAutoOpsRuleRequest.ops_type:type_name -> bucketeer.autoops.OpsType
	150, // 99: bucketeer.gateway.CreateAutoOpsRuleRequest.ops_event_rate_clauses:type_name -> bucketeer.autoops.OpsEventRateClause
	151, // 100: bucketeer.gateway.CreateAutoOpsRuleRequest.datetime_clauses:type_name -> bucketeer.autoops.DatetimeClause
	148, // 101: bucketeer.gateway.CreateAutoOpsRuleResponse.auto_ops_rule:type_name -> bucketeer.autoops.AutoOpsRule
	148, // 102: bucketeer.gateway.ListAutoOpsRulesResponse.auto_ops_rules:type_name -> bucketeer.autoops.AutoOpsRule
	152, // 103: bucketeer.gateway.UpdateAutoOpsRuleRequest.ops_event_rate_clause_changes:type_name -> bucketeer.autoops.OpsEventRateClauseChange
	153, // 104: bucketeer.gateway.UpdateAutoOpsRuleRequest.datetime_clause_changes:type_name -> bucketeer.autoops.DatetimeClauseChange
	154, // 105: bucketeer.gateway.CreateProgressiveRolloutRequest.progressive_rollout_manual_schedule_clause:type_name -> bucketeer.autoops.ProgressiveRolloutManualScheduleClause
	155, // 106: bucketeer.gateway.CreateProgressiveRolloutRequest.progressive_rollout_template_schedule_clause:type_name -> bucketeer.autoops.ProgressiveRolloutTemplateScheduleClause
	156, // 107: bucketeer.gateway.CreateProgressiveRolloutResponse.progressive_rollout:type_name -> bucketeer.autoops.ProgressiveRollout
	156, // 108: bucketeer.gateway.GetProgressiveRolloutResponse.progressive_rollout:type_name -> bucketeer.autoops.ProgressiveRollout
	157, // 109: bucketeer.gateway.StopProgressiveRolloutRequest.stopped_by:type_name -> bucketeer.autoops.ProgressiveRollout.StoppedBy
	158, // 110: bucketeer.gateway.ListProgressiveRolloutsRequest.order_by:type_name -> bucketeer.autoops.ListProgressiveRolloutsRequest.OrderBy
	159, // 111: bucketeer.gateway.ListProgressiveRolloutsRequest.order_direction:type_name -> bucketeer.autoops.ListProgressiveRolloutsRequest.OrderDirection
	160, // 112: bucketeer.gateway.ListProgressiveRolloutsRequest.status:type_name -> bucketeer.autoops.ProgressiveRollout.Status
	161, // 113: bucketeer.gateway.ListProgressiveRolloutsRequest.type:type_name -> bucketeer.autoops.ProgressiveRollout.Type
	156, // 114: bucketeer.gateway.ListProgressiveRolloutsResponse.progressive_rollouts:type_name -> bucketeer.autoops.ProgressiveRollout
	99,  // 115: bucketeer.gateway.RegisterEventsResponse.ErrorsEntry.value:type_name -> bucketeer.gateway.RegisterEventsResponse.Error
	6,   // 116: bucketeer.gateway.Gateway.GetEvaluations:input_type -> bucketeer.gateway.GetEvaluationsRequest
	8,   // 117: bucketeer.gateway.Gateway.GetEvaluation:input_type -> bucketeer.gateway.GetEvaluationRequest
	2,   // 118: bucketeer.gateway.Gateway.GetFeatureFlags:input_type -> bucketeer.gateway.GetFeatureFlagsRequest
	4,   // 119: bucketeer.gateway.Gateway.GetSegmentUsers:input_type -> bucketeer.gateway.GetSegmentUsersRequest
	10,  // 120: bucketeer.gateway.Gateway.RegisterEvents:input_type -> bucketeer.gateway.RegisterEventsRequest
	12,  // 121: bucketeer.gateway.Gateway.Track:input_type -> bucketeer.gateway.TrackRequest
	14,  // 122: bucketeer.gateway.Gateway.DebugEvaluateFeatures:input_type -> bucketeer.gateway.DebugEvaluateFeaturesRequest
	16,  // 123: bucketeer.gateway.Gateway.CreateFeature:input_type -> bucketeer.gateway.CreateFeatureRequest
	18,  // 124: bucketeer.gateway.Gateway.GetFeature:input_type -> bucketeer.gateway.GetFeatureRequest
	20,  // 125: bucketeer.gateway.Gateway.ListFeatures:input_type -> bucketeer.gateway.ListFeaturesRequest
	22,  // 126: bucketeer.gateway.Gateway.UpdateFeature:input_type -> bucketeer.gateway.UpdateFeatureRequest
	0,   // 127: bucketeer.gateway.Gateway.Ping:input_type -> bucketeer.gateway.PingRequest
	24,  // 128: bucketeer.gateway.Gateway.ListPushes:input_type -> bucketeer.gateway.ListPushesRequest
	26,  // 129: bucketeer.gateway.Gateway.CreatePush:input_type -> bucketeer.gateway.CreatePushRequest
	28,  // 130: bucketeer.gateway.Gateway.GetPush:input_type -> bucketeer.gateway.GetPushRequest
	30,  // 131: bucketeer.gateway.Gateway.UpdatePush:input_type -> bucketeer.gateway.UpdatePushRequest
	32,  // 132: bucketeer.gateway.Gateway.CreateAccountV2:input_type -> bucketeer.gateway.CreateAccountV2Request
	34,  // 133: bucketeer.gateway.Gateway.UpdateAccountV2:input_type -> bucketeer.gateway.UpdateAccountV2Request
	36,  // 134: bucketeer.gateway.Gateway.GetAccountV2:input_type -> bucketeer.gateway.GetAccountV2Request
	38,  // 135: bucketeer.gateway.Gateway.GetAccountV2ByEnvironmentID:input_type -> bucketeer.gateway.GetAccountV2ByEnvironmentIDRequest
	40,  // 136: bucketeer.gateway.Gateway.GetMe:input_type -> bucketeer.gateway.GetMeRequest
	42,  // 137: bucketeer.gateway.Gateway.ListAccountsV2:input_type -> bucketeer.gateway.ListAccountsV2Request
	44,  // 138: bucketeer.gateway.Gateway.GetCodeReference:input_type -> bucketeer.gateway.GetCodeReferenceRequest
	46,  // 139: bucketeer.gateway.Gateway.ListCodeReferences:input_type -> bucketeer.gateway.ListCodeReferencesRequest
	48,  // 140: bucketeer.gateway.Gateway.CreateCodeReference:input_type -> bucketeer.gateway.CreateCodeReferenceRequest
	50,  // 141: bucketeer.gateway.Gateway.UpdateCodeReference:input_type -> bucketeer.gateway.UpdateCodeReferenceRequest
	52,  // 142: bucketeer.gateway.Gateway.DeleteCodeReference:input_type -> bucketeer.gateway.DeleteCodeReferenceRequest
	54,  // 143: bucketeer.gateway.Gateway.CreateSegment:input_type -> bucketeer.gateway.CreateSegmentRequest
	56,  // 144: bucketeer.gateway.Gateway.GetSegment:input_type -> bucketeer.gateway.GetSegmentRequest
	58,  // 145: bucketeer.gateway.Gateway.ListSegments:input_type -> bucketeer.gateway.ListSegmentsRequest
	60,  // 146: bucketeer.gateway.Gateway.DeleteSegment:input_type -> bucketeer.gateway.DeleteSegmentRequest
	62,  // 147: bucketeer.gateway.Gateway.UpdateSegment:input_type -> bucketeer.gateway.UpdateSegmentRequest
	64,  // 148: bucketeer.gateway.Gateway.BulkUploadSegmentUsers:input_type -> bucketeer.gateway.BulkUploadSegmentUsersRequest
	66,  // 149: bucketeer.gateway.Gateway.GetAuditLog:input_type -> bucketeer.gateway.GetAuditLogRequest
	68,  // 150: bucketeer.gateway.Gateway.ListAuditLogs:input_type -> bucketeer.gateway.ListAuditLogsRequest
	70,  // 151: bucketeer.gateway.Gateway.ListFeatureHistory:input_type -> bucketeer.gateway.ListFeatureHistoryRequest
	72,  // 152: bucketeer.gateway.Gateway.GetAutoOpsRule:input_type -> bucketeer.gateway.GetAutoOpsRuleRequest
	74,  // 153: bucketeer.gateway.Gateway.CreateAutoOpsRule:input_type -> bucketeer.gateway.CreateAutoOpsRuleRequest
	76,  // 154: bucketeer.gateway.Gateway.ListAutoOpsRules:input_type -> bucketeer.gateway.ListAutoOpsRulesRequest
	78,  // 155: bucketeer.gateway.Gateway.StopAutoOpsRule:input_type -> bucketeer.gateway.StopAutoOpsRuleRequest
	80,  // 156: bucketeer.gateway.Gateway.DeleteAutoOpsRule:input_type -> bucketeer.gateway.DeleteAutoOpsRuleRequest
	82,  // 157: bucketeer.gateway.Gateway.UpdateAutoOpsRule:input_type -> bucketeer.gateway.UpdateAutoOpsRuleRequest
	84,  // 158: bucketeer.gateway.Gateway.ExecuteAutoOps:input_type -> bucketeer.gateway.ExecuteAutoOpsRequest
	86,  // 159: bucketeer.gateway.Gateway.CreateProgressiveRollout:input_type -> bucketeer.gateway.CreateProgressiveRolloutRequest
	88,  // 160: bucketeer.gateway.Gateway.GetProgressiveRollout:input_type -> bucketeer.gateway.GetProgressiveRolloutRequest
	90,  // 161: bucketeer.gateway.Gateway.StopProgressiveRollout:input_type -> bucketeer.gateway.StopProgressiveRolloutRequest
	92,  // 162: bucketeer.gateway.Gateway.DeleteProgressiveRollout:input_type -> bucketeer.gateway.DeleteProgressiveRolloutRequest
	94,  // 163: bucketeer.gateway.Gateway.ListProgressiveRollouts:input_type -> bucketeer.gateway.ListProgressiveRolloutsRequest
	96,  // 164: bucketeer.gateway.Gateway.ExecuteProgressiveRollout:input_type -> bucketeer.gateway.ExecuteProgressiveRolloutRequest
	7,   // 165: bucketeer.gateway.Gateway.GetEvaluations:output_type -> bucketeer.gateway.GetEvaluationsResponse
	9,   // 166: bucketeer.gateway.Gateway.GetEvaluation:output_type -> bucketeer.gateway.GetEvaluationResponse
	3,   // 167: bucketeer.gateway.Gateway.GetFeatureFlags:output_type -> bucketeer.gateway.GetFeatureFlagsResponse
	5,   // 168: bucketeer.gateway.Gateway.GetSegmentUsers:output_type -> bucketeer.gateway.GetSegmentUsersResponse
	11,  // 169: bucketeer.gateway.Gateway.RegisterEvents:output_type -> bucketeer.gateway.RegisterEventsResponse
	13,  // 170: bucketeer.gateway.Gateway.Track:output_type -> bucketeer.gateway.TrackResponse
	15,  // 171: bucketeer.gateway.Gateway.DebugEvaluateFeatures:output_type -> bucketeer.gateway.DebugEvaluateFeaturesResponse
	17,  // 172: bucketeer.gateway.Gateway.CreateFeature:output_type -> bucketeer.gateway.CreateFeatureResponse
	19,  // 173: bucketeer.gateway.Gateway.GetFeature:output_type -> bucketeer.gateway.GetFeatureResponse
	21,  // 174: bucketeer.gateway.Gateway.ListFeatures:output_type -> bucketeer.gateway.ListFeaturesResponse
	23,  // 175: bucketeer.gateway.Gateway.UpdateFeature:output_type -> bucketeer.gateway.UpdateFeatureResponse
	1,   // 176: bucketeer.gateway.Gateway.Ping:output_type -> bucketeer.gateway.PingResponse
	25,  // 177: bucketeer.gateway.Gateway.ListPushes:output_type -> bucketeer.gateway.ListPushesResponse
	27,  // 178: bucketeer.gateway.Gateway.CreatePush:output_type -> bucketeer.gateway.CreatePushResponse
	29,  // 179: bucketeer.gateway.Gateway.GetPush:output_type -> bucketeer.gateway.GetPushResponse
	31,  // 180: bucketeer.gateway.Gateway.UpdatePush:output_type -> bucketeer.gateway.UpdatePushResponse
	33,  // 181: bucketeer.gateway.Gateway.CreateAccountV2:output_type -> bucketeer.gateway.CreateAccountV2Response
	35,  // 182: bucketeer.gateway.Gateway.UpdateAccountV2:output_type -> bucketeer.gateway.UpdateAccountV2Response
	37,  // 183: bucketeer.gateway.Gateway.GetAccountV2:output_type -> bucketeer.gateway.GetAccountV2Response
	39,  // 184: bucketeer.gateway.Gateway.GetAccountV2ByEnvironmentID:output_type -> bucketeer.gateway.GetAccountV2ByEnvironmentIDResponse
	41,  // 185: bucketeer.gateway.Gateway.GetMe:output_type -> bucketeer.gateway.GetMeResponse
	43,  // 186: bucketeer.gateway.Gateway.ListAccountsV2:output_type -> bucketeer.gateway.ListAccountsV2Response
	45,  // 187: bucketeer.gateway.Gateway.GetCodeReference:output_type -> bucketeer.gateway.GetCodeReferenceResponse
	47,  // 188: bucketeer.gateway.Gateway.ListCodeReferences:output_type -> bucketeer.gateway.ListCodeReferencesResponse
	49,  // 189: bucketeer.gateway.Gateway.CreateCodeReference:output_type -> bucketeer.gateway.CreateCodeReferenceResponse
	51,  // 190: bucketeer.gateway.Gateway.UpdateCodeReference:output_type -> bucketeer.gateway.UpdateCodeReferenceResponse
	53,  // 191: bucketeer.gateway.Gateway.DeleteCodeReference:output_type -> bucketeer.gateway.DeleteCodeReferenceResponse
	55,  // 192: bucketeer.gateway.Gateway.CreateSegment:output_type -> bucketeer.gateway.CreateSegmentResponse
	57,  // 193: bucketeer.gateway.Gateway.GetSegment:output_type -> bucketeer.gateway.GetSegmentResponse
	59,  // 194: bucketeer.gateway.Gateway.ListSegments:output_type -> bucketeer.gateway.ListSegmentsResponse
	61,  // 195: bucketeer.gateway.Gateway.DeleteSegment:output_type -> bucketeer.gateway.DeleteSegmentResponse
	63,  // 196: bucketeer.gateway.Gateway.UpdateSegment:output_type -> bucketeer.gateway.UpdateSegmentResponse
	65,  // 197: bucketeer.gateway.Gateway.BulkUploadSegmentUsers:output_type -> bucketeer.gateway.BulkUploadSegmentUsersResponse
	67,  // 198: bucketeer.gateway.Gateway.GetAuditLog:output_type -> bucketeer.gateway.GetAuditLogResponse
	69,  // 199: bucketeer.gateway.Gateway.ListAuditLogs:output_type -> bucketeer.gateway.ListAuditLogsResponse
	71,  // 200: bucketeer.gateway.Gateway.ListFeatureHistory:output_type -> bucketeer.gateway.ListFeatureHistoryResponse
	73,  // 201: bucketeer.gateway.Gateway.GetAutoOpsRule:output_type -> bucketeer.gateway.GetAutoOpsRuleResponse
	75,  // 202: bucketeer.gateway.Gateway.CreateAutoOpsRule:output_type -> bucketeer.gateway.CreateAutoOpsRuleResponse
	77,  // 203: bucketeer.gateway.Gateway.ListAutoOpsRules:output_type -> bucketeer.gateway.ListAutoOpsRulesResponse
	79,  // 204: bucketeer.gateway.Gateway.StopAutoOpsRule:output_type -> bucketeer.gateway.StopAutoOpsRuleResponse
	81,  // 205: bucketeer.gateway.Gateway.DeleteAutoOpsRule:output_type -> bucketeer.gateway.DeleteAutoOpsRuleResponse
	83,  // 206: bucketeer.gateway.Gateway.UpdateAutoOpsRule:output_type -> bucketeer.gateway.UpdateAutoOpsRuleResponse
	85,  // 207: bucketeer.gateway.Gateway.ExecuteAutoOps:output_type -> bucketeer.gateway.ExecuteAutoOpsResponse
	87,  // 208: bucketeer.gateway.Gateway.CreateProgressiveRollout:output_type -> bucketeer.gateway.CreateProgressiveRolloutResponse
	89,  // 209: bucketeer.gateway.Gateway.GetProgressiveRollout:output_type -> bucketeer.gateway.GetProgressiveRolloutResponse
	91,  // 210: bucketeer.gateway.Gateway.StopProgressiveRollout:output_type -> bucketeer.gateway.StopProgressiveRolloutResponse
	93,  // 211: bucketeer.gateway.Gateway.DeleteProgressiveRollout:output_type -> bucketeer.gateway.DeleteProgressiveRolloutResponse
	95,  // 212: bucketeer.gateway.Gateway.ListProgressiveRollouts:output_type -> bucketeer.gateway.ListProgressiveRolloutsResponse
	97,  // 213: bucketeer.gateway.Gateway.ExecuteProgressiveRollout:output_type -> bucketeer.gateway.ExecuteProgressiveRolloutResponse
	165, // [165:214] is the sub-list for method output_type
	116, // [116:165] is the sub-list for method input_type
