...
var (
	...
	statusAccountNotFound                        = api.NewGRPCStatus(pkgErr.NewErrorNotFound(pkgErr.AccountPackageName, "account not found", "account"))
	statusAPIKeyNotFound                         = api.NewGRPCStatus(pkgErr.NewErrorNotFound(pkgErr.AccountPackageName, "api key not found", "api_key"))
	...
	statusAccountAlreadyExists                   = api.NewGRPCStatus(pkgErr.NewErrorAlreadyExists(pkgErr.AccountPackageName, "account already exists"))
