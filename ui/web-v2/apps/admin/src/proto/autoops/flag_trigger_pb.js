...
goog.exportSymbol('proto.bucketeer.autoops.FlagTrigger.Action', null, global);
goog.exportSymbol('proto.bucketeer.autoops.FlagTrigger.Type', null, global);
/**
 ...
 * @enum {number}
 */
proto.bucketeer.autoops.FlagTrigger.Type = {
  TYPE_UNKNOWN: 0,
  TYPE_WEBHOOK: 1
};
 ...
 * @enum {number}
 */
proto.bucketeer.autoops.FlagTrigger.Action = {
  ACTION_UNKNOWN: 0,
  ACTION_ON: 1,
  ACTION_OFF: 2
};
...
proto.bucketeer.autoops.FlagTrigger.prototype.getType = function() {
  return /** @type {!proto.bucketeer.autoops.FlagTrigger.Type} */ (jspb.Message.getFieldWithDefault(this, 4, 0));
};
...
proto.bucketeer.autoops.FlagTrigger.prototype.getAction = function() {
  return /** @type {!proto.bucketeer.autoops.FlagTrigger.Action} */ (jspb.Message.getFieldWithDefault(this, 5, 0));
};
