...
//
//	mockgen -source=transaction.go -aux_files=github.com/bucketeer-io/bucketeer/v2/pkg/storage/v2/mysql=client.go -package=mock -destination=./mock/transaction.go
//
