...
var file_proto_event_domain_event_proto_rawDesc = []byte{
	...
	0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xe4, 0x2f, 0x0a, 0x05, 0x45, 0x76, 0x65, 0x6e, 0x74,
	...
	0x12, 0x22, 0x04, 0x08, 0x0d, 0x10, 0x0d, 0x22, 0x9d, 0x29, 0x0a, 0x04, 0x54, 0x79, 0x70, 0x65,
	...
	0x45, 0x44, 0x10, 0x68, 0x12, 0x17, 0x0a, 0x12, 0x45, 0x58, 0x50, 0x45, 0x52, 0x49, 0x4d, 0x45,
	...
	0xd2, 0x01, 0x12, 0x18, 0x0a, 0x0f, 0x41, 0x43, 0x43, 0x4f, 0x55, 0x4e, 0x54, 0x5f, 0x43, 0x52,
	...
	0x63, 0x6f, 0x6e, 0x6e, 0x65, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x54, 0x79, 0x70, 0x65, 0x22, 0x36,
	...
	0x64, 0x61, 0x74, 0x65, 0x74, 0x69, 0x6d, 0x65, 0x43, 0x6c, 0x61, 0x75, 0x73, 0x65, 0x22, 0x85,
	...
	0x22, 0xc3, 0x01, 0x0a, 0x18, 0x53, 0x75, 0x62, 0x73, 0x63, 0x72, 0x69, 0x70, 0x74, 0x69, 0x6f,
	...
	0x52, 0x04, 0x6e, 0x61, 0x6d, 0x65, 0x22, 0x1a, 0x0a, 0x18, 0x53, 0x75, 0x62, 0x73, 0x63, 0x72,
	...
	0xe8, 0x01, 0x0a, 0x18, 0x53, 0x75, 0x62, 0x73, 0x63, 0x72, 0x69, 0x70, 0x74, 0x69, 0x6f, 0x6e,
	...
	0x52, 0x08, 0x64, 0x69, 0x73, 0x61, 0x62, 0x6c, 0x65, 0x64, 0x22, 0xc8, 0x01, 0x0a, 0x1d, 0x41,
...
var file_proto_event_domain_event_proto_goTypes = []interface{}{
	...
	(experiment.Goal_ConnectionType)(0),                       // 189: bucketeer.experiment.Goal.ConnectionType
	...
	(account.FilterTargetType)(0),                             // 192: bucketeer.account.FilterTargetType
	(account.APIKey_Role)(0),                                  // 193: bucketeer.account.APIKey.Role
	(*wrapperspb.StringValue)(nil),                            // 194: google.protobuf.StringValue
	(feature.SegmentUser_State)(0),                            // 195: bucketeer.feature.SegmentUser.State
	(feature.Segment_Status)(0),                               // 196: bucketeer.feature.Segment.Status
	(autoops.OpsType)(0),                                      // 197: bucketeer.autoops.OpsType
	(*autoops.Clause)(nil),                                    // 198: bucketeer.autoops.Clause
	(autoops.AutoOpsStatus)(0),                                // 199: bucketeer.autoops.AutoOpsStatus
	...
	(notification.Subscription_SourceType)(0),                 // 202: bucketeer.notification.Subscription.SourceType
	(*notification.Recipient)(nil),                            // 203: bucketeer.notification.Recipient
	(*wrapperspb.BoolValue)(nil),                              // 204: google.protobuf.BoolValue
	(autoops.ProgressiveRollout_Type)(0),                      // 205: bucketeer.autoops.ProgressiveRollout.Type
	(autoops.ProgressiveRollout_Status)(0),                    // 206: bucketeer.autoops.ProgressiveRollout.Status
	(autoops.ProgressiveRollout_StoppedBy)(0),                 // 207: bucketeer.autoops.ProgressiveRollout.StoppedBy
	(feature.FlagTrigger_Type)(0),                             // 208: bucketeer.feature.FlagTrigger.Type
	(feature.FlagTrigger_Action)(0),                           // 209: bucketeer.feature.FlagTrigger.Action
	(tag.Tag_EntityType)(0),                                   // 210: bucketeer.tag.Tag.EntityType
...
var file_proto_event_domain_event_proto_depIdxs = []int32{
	...
	189, // 27: bucketeer.event.domain.GoalCreatedEvent.connection_type:type_name -> bucketeer.experiment.Goal.ConnectionType
	178, // 28: bucketeer.event.domain.ExperimentCreatedEvent.variations:type_name -> bucketeer.feature.Variation
	190, // 29: bucketeer.event.domain.AccountV2CreatedEvent.organization_role:type_name -> bucketeer.account.AccountV2.Role.Organization
	191, // 30: bucketeer.event.domain.AccountV2CreatedEvent.environment_roles:type_name -> bucketeer.account.AccountV2.EnvironmentRole
	190, // 31: bucketeer.event.domain.AccountV2OrganizationRoleChangedEvent.organization_role:type_name -> bucketeer.account.AccountV2.Role.Organization
	191, // 32: bucketeer.event.domain.AccountV2EnvironmentRolesChangedEvent.environment_roles:type_name -> bucketeer.account.AccountV2.EnvironmentRole
	192, // 33: bucketeer.event.domain.SearchFilterCreatedEvent.TargetType:type_name -> bucketeer.account.FilterTargetType
	193, // 34: bucketeer.event.domain.APIKeyCreatedEvent.role:type_name -> bucketeer.account.APIKey.Role
	194, // 35: bucketeer.event.domain.SegmentUpdatedEvent.name:type_name -> google.protobuf.StringValue
	194, // 36: bucketeer.event.domain.SegmentUpdatedEvent.description:type_name -> google.protobuf.StringValue
	182, // 37: bucketeer.event.domain.SegmentRuleAddedEvent.rule:type_name -> bucketeer.feature.Rule
	187, // 38: bucketeer.event.domain.SegmentRuleClauseAddedEvent.clause:type_name -> bucketeer.feature.Clause
	188, // 39: bucketeer.event.domain.SegmentClauseOperatorChangedEvent.operator:type_name -> bucketeer.feature.Clause.Operator
	195, // 40: bucketeer.event.domain.SegmentUserAddedEvent.state:type_name -> bucketeer.feature.SegmentUser.State
	195, // 41: bucketeer.event.domain.SegmentUserDeletedEvent.state:type_name -> bucketeer.feature.SegmentUser.State
	196, // 42: bucketeer.event.domain.SegmentBulkUploadUsersEvent.status:type_name -> bucketeer.feature.Segment.Status
	195, // 43: bucketeer.event.domain.SegmentBulkUploadUsersEvent.state:type_name -> bucketeer.feature.SegmentUser.State
	196, // 44: bucketeer.event.domain.SegmentBulkUploadUsersStatusChangedEvent.status:type_name -> bucketeer.feature.Segment.Status
	195, // 45: bucketeer.event.domain.SegmentBulkUploadUsersStatusChangedEvent.state:type_name -> bucketeer.feature.SegmentUser.State
	197, // 46: bucketeer.event.domain.AutoOpsRuleCreatedEvent.ops_type:type_name -> bucketeer.autoops.OpsType
	198, // 47: bucketeer.event.domain.AutoOpsRuleCreatedEvent.clauses:type_name -> bucketeer.autoops.Clause
	199, // 48: bucketeer.event.domain.AutoOpsRuleCreatedEvent.ops_status:type_name -> bucketeer.autoops.AutoOpsStatus
	197, // 49: bucketeer.event.domain.AutoOpsRuleOpsTypeChangedEvent.ops_type:type_name -> bucketeer.autoops.OpsType
	199, // 50: bucketeer.event.domain.AutoOpsRuleOpsStatusChangedEvent.ops_status:type_name -> bucketeer.autoops.AutoOpsStatus
	200, // 51: bucketeer.event.domain.OpsEventRateClauseAddedEvent.ops_event_rate_clause:type_name -> bucketeer.autoops.OpsEventRateClause
	200, // 52: bucketeer.event.domain.OpsEventRateClauseChangedEvent.ops_event_rate_clause:type_name -> bucketeer.autoops.OpsEventRateClause
	201, // 53: bucketeer.event.domain.DatetimeClauseAddedEvent.datetime_clause:type_name -> bucketeer.autoops.DatetimeClause
	201, // 54: bucketeer.event.domain.DatetimeClauseChangedEvent.datetime_clause:type_name -> bucketeer.autoops.DatetimeClause
	194, // 55: bucketeer.event.domain.PushUpdatedEvent.name:type_name -> google.protobuf.StringValue
	202, // 56: bucketeer.event.domain.SubscriptionCreatedEvent.source_types:type_name -> bucketeer.notification.Subscription.SourceType
	203, // 57: bucketeer.event.domain.SubscriptionCreatedEvent.recipient:type_name -> bucketeer.notification.Recipient
	202, // 58: bucketeer.event.domain.SubscriptionSourceTypesAddedEvent.source_types:type_name -> bucketeer.notification.Subscription.SourceType
	202, // 59: bucketeer.event.domain.SubscriptionSourceTypesDeletedEvent.source_types:type_name -> bucketeer.notification.Subscription.SourceType
	194, // 60: bucketeer.event.domain.SubscriptionUpdatedEvent.name:type_name -> google.protobuf.StringValue
	202, // 61: bucketeer.event.domain.SubscriptionUpdatedEvent.source_types:type_name -> bucketeer.notification.Subscription.SourceType
	204, // 62: bucketeer.event.domain.SubscriptionUpdatedEvent.disabled:type_name -> google.protobuf.BoolValue
	202, // 63: bucketeer.event.domain.AdminSubscriptionCreatedEvent.source_types:type_name -> bucketeer.notification.Subscription.SourceType
	203, // 64: bucketeer.event.domain.AdminSubscriptionCreatedEvent.recipient:type_name -> bucketeer.notification.Recipient
	202, // 65: bucketeer.event.domain.AdminSubscriptionSourceTypesAddedEvent.source_types:type_name -> bucketeer.notification.Subscription.SourceType
	202, // 66: bucketeer.event.domain.AdminSubscriptionSourceTypesDeletedEvent.source_types:type_name -> bucketeer.notification.Subscription.SourceType
	181, // 67: bucketeer.event.domain.PrerequisiteAddedEvent.prerequisite:type_name -> bucketeer.feature.Prerequisite
	181, // 68: bucketeer.event.domain.PrerequisiteVariationChangedEvent.prerequisite:type_name -> bucketeer.feature.Prerequisite
	177, // 69: bucketeer.event.domain.ProgressiveRolloutCreatedEvent.clause:type_name -> google.protobuf.Any
	205, // 70: bucketeer.event.domain.ProgressiveRolloutCreatedEvent.type:type_name -> bucketeer.autoops.ProgressiveRollout.Type
	206, // 71: bucketeer.event.domain.ProgressiveRolloutStoppedEvent.status:type_name -> bucketeer.autoops.ProgressiveRollout.Status
	207, // 72: bucketeer.event.domain.ProgressiveRolloutStoppedEvent.stopped_by:type_name -> bucketeer.autoops.ProgressiveRollout.StoppedBy
	208, // 73: bucketeer.event.domain.FlagTriggerCreatedEvent.type:type_name -> bucketeer.feature.FlagTrigger.Type
	209, // 74: bucketeer.event.domain.FlagTriggerCreatedEvent.action:type_name -> bucketeer.feature.FlagTrigger.Action
	210, // 75: bucketeer.event.domain.TagCreatedEvent.entity_type:type_name -> bucketeer.tag.Tag.EntityType
	211, // 76: bucketeer.event.domain.CodeReferenceCreatedEvent.repository_type:type_name -> bucketeer.coderef.CodeReference.RepositoryType
