...
func NewProgressiveRolloutStorage(qe pgstorage.QueryExecer) v2as.ProgressiveRolloutStorage {
...
func (s *progressiveRolloutStorage) CreateProgressiveRollout(
	...
	_, err := s.qe.ExecContext(
		...
		pgstorage.JSONObject{Val: progressiveRollout.Clause},
...
func (s *progressiveRolloutStorage) ListProgressiveRollouts(
	...
	query, whereArgs := pgstorage.ConstructQueryAndWhereArgs(selectOpsProgressiveRolloutsSQL, options)
	...
	countQuery, countWhereArgs := pgstorage.ConstructCountQuery(countOpsProgressiveRolloutsSQL, options)
