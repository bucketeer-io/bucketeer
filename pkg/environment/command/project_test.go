...
func TestHandleCreateProjectCommand(t *testing.T) {
	...
	project, err := domain.NewProject("project-name", "project desc", "test@example.com", false)
...
func TestHandleCreateTrialProjectCommand(t *testing.T) {
	...
	defer mockController.Finish()
	publisher := publishermock.NewMockPublisher(mockController)
	project, err := domain.NewProject("project-name", "", "test@example.com", true)
	assert.NoError(t, err)
...
func TestHandleConvertTrialProjectCommand(t *testing.T) {
	...
	defer mockController.Finish()
	publisher := publishermock.NewMockPublisher(mockController)
	project, err := domain.NewProject("project-name", "project desc", "test@example.com", true)
	assert.NoError(t, err)
