...
import * as proto_notification_service_pb from './service_pb';
...
export class NotificationServiceClient {
  ...
  getAdminSubscription(
    ...
    callback: (
      ...
      responseMessage: proto_notification_service_pb.GetAdminSubscriptionResponse | null
    ) => void
  ): UnaryResponse;
  getAdminSubscription(
    requestMessage: proto_notification_service_pb.GetAdminSubscriptionRequest,
  ...
  listAdminSubscriptions(
    ...
    callback: (
      error: ServiceError | null,
      responseMessage: proto_notification_service_pb.ListAdminSubscriptionsResponse | null
    ) => void
  ): UnaryResponse;
  listAdminSubscriptions(
    requestMessage: proto_notification_service_pb.ListAdminSubscriptionsRequest,
  ...
  listEnabledAdminSubscriptions(
    ...
    callback: (
      error: ServiceError | null,
      responseMessage: proto_notification_service_pb.ListEnabledAdminSubscriptionsResponse | null
    ) => void
  ): UnaryResponse;
  listEnabledAdminSubscriptions(
    requestMessage: proto_notification_service_pb.ListEnabledAdminSubscriptionsRequest,
  ...
  createAdminSubscription(
    ...
    callback: (
      error: ServiceError | null,
      responseMessage: proto_notification_service_pb.CreateAdminSubscriptionResponse | null
    ) => void
  ): UnaryResponse;
  createAdminSubscription(
    requestMessage: proto_notification_service_pb.CreateAdminSubscriptionRequest,
  ...
  deleteAdminSubscription(
    ...
    callback: (
      error: ServiceError | null,
      responseMessage: proto_notification_service_pb.DeleteAdminSubscriptionResponse | null
    ) => void
  ): UnaryResponse;
  deleteAdminSubscription(
    requestMessage: proto_notification_service_pb.DeleteAdminSubscriptionRequest,
  ...
  enableAdminSubscription(
    ...
    callback: (
      error: ServiceError | null,
      responseMessage: proto_notification_service_pb.EnableAdminSubscriptionResponse | null
    ) => void
  ): UnaryResponse;
  enableAdminSubscription(
    requestMessage: proto_notification_service_pb.EnableAdminSubscriptionRequest,
  ...
  disableAdminSubscription(
    ...
    callback: (
      error: ServiceError | null,
      responseMessage: proto_notification_service_pb.DisableAdminSubscriptionResponse | null
    ) => void
  ): UnaryResponse;
  disableAdminSubscription(
    requestMessage: proto_notification_service_pb.DisableAdminSubscriptionRequest,
  ...
  updateAdminSubscription(
    ...
    callback: (
      error: ServiceError | null,
      responseMessage: proto_notification_service_pb.UpdateAdminSubscriptionResponse | null
    ) => void
  ): UnaryResponse;
  updateAdminSubscription(
    requestMessage: proto_notification_service_pb.UpdateAdminSubscriptionRequest,
  ...
  getSubscription(
    ...
    callback: (
      error: ServiceError | null,
      responseMessage: proto_notification_service_pb.GetSubscriptionResponse | null
    ) => void
  ): UnaryResponse;
  getSubscription(
    requestMessage: proto_notification_service_pb.GetSubscriptionRequest,
  ...
  listSubscriptions(
    ...
    callback: (
      error: ServiceError | null,
      responseMessage: proto_notification_service_pb.ListSubscriptionsResponse | null
    ) => void
  ): UnaryResponse;
  listSubscriptions(
    requestMessage: proto_notification_service_pb.ListSubscriptionsRequest,
  ...
  listEnabledSubscriptions(
    ...
    callback: (
      error: ServiceError | null,
      responseMessage: proto_notification_service_pb.ListEnabledSubscriptionsResponse | null
    ) => void
  ): UnaryResponse;
  listEnabledSubscriptions(
    requestMessage: proto_notification_service_pb.ListEnabledSubscriptionsRequest,
  ...
  createSubscription(
    ...
    callback: (
      error: ServiceError | null,
      responseMessage: proto_notification_service_pb.CreateSubscriptionResponse | null
    ) => void
  ): UnaryResponse;
  createSubscription(
    requestMessage: proto_notification_service_pb.CreateSubscriptionRequest,
  ...
  deleteSubscription(
    ...
    callback: (
      error: ServiceError | null,
      responseMessage: proto_notification_service_pb.DeleteSubscriptionResponse | null
    ) => void
  ): UnaryResponse;
  deleteSubscription(
    requestMessage: proto_notification_service_pb.DeleteSubscriptionRequest,
  ...
  enableSubscription(
    ...
    callback: (
      error: ServiceError | null,
      responseMessage: proto_notification_service_pb.EnableSubscriptionResponse | null
    ) => void
  ): UnaryResponse;
  enableSubscription(
    requestMessage: proto_notification_service_pb.EnableSubscriptionRequest,
  ...
  disableSubscription(
    ...
    callback: (
      error: ServiceError | null,
      responseMessage: proto_notification_service_pb.DisableSubscriptionResponse | null
    ) => void
  ): UnaryResponse;
  disableSubscription(
    requestMessage: proto_notification_service_pb.DisableSubscriptionRequest,
  ...
  updateSubscription(
    ...
    callback: (
      error: ServiceError | null,
      responseMessage: proto_notification_service_pb.UpdateSubscriptionResponse | null
    ) => void
  ): UnaryResponse;
  updateSubscription(
    requestMessage: proto_notification_service_pb.UpdateSubscriptionRequest,
