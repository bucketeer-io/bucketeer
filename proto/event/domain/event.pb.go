...
var file_proto_event_domain_event_proto_rawDesc = []byte{
	...
	0x22, 0xe2, 0x2c, 0x0a, 0x05, 0x45, 0x76, 0x65, 0x6e, 0x74, 0x12, 0x0e, 0x0a, 0x02, 0x69, 0x64,
	...
	0x52, 0x10, 0x10, 0x22, 0x04, 0x08, 0x0d, 0x10, 0x0d, 0x22, 0xa9, 0x26, 0x0a, 0x04, 0x54, 0x79,
	...
	0x45, 0x44, 0x10, 0xbd, 0x02, 0x12, 0x13, 0x0a, 0x0e, 0x41, 0x50, 0x49, 0x4b, 0x45, 0x59, 0x5f,
	...
	0x4e, 0x47, 0x45, 0x44, 0x10, 0xe4, 0x0b, 0x12, 0x19, 0x0a, 0x14, 0x46, 0x4c, 0x41, 0x47, 0x5f,
	...
	0x45, 0x44, 0x10, 0xc7, 0x0c, 0x22, 0x06, 0x08, 0x94, 0x0a, 0x10, 0x94, 0x0a, 0x22, 0x06, 0x08,
	...
	0x99, 0x0a, 0x10, 0x99, 0x0a, 0x22, 0x3f, 0x0a, 0x06, 0x45, 0x64, 0x69, 0x74, 0x6f, 0x72, 0x12,
	...
	0x74, 0x22, 0xa6, 0x03, 0x0a, 0x15, 0x41, 0x63, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x56, 0x32, 0x43,
	...
	0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x02, 0x69, 0x64, 0x22, 0xc6, 0x01, 0x0a, 0x12, 0x41, 0x50,
	...
	0x63, 0x74, 0x49, 0x64, 0x22, 0xa9, 0x02, 0x0a, 0x17, 0x41, 0x75, 0x74, 0x6f, 0x4f, 0x70, 0x73,
	...
	0x72, 0x54, 0x69, 0x6d, 0x65, 0x73, 0x42, 0x36, 0x5a, 0x34, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62,
...
var file_proto_event_domain_event_proto_msgTypes = make([]protoimpl.MessageInfo, 159)
var file_proto_event_domain_event_proto_goTypes = []interface{}{
	...
	(*feature.Variation)(nil),                                 // 162: bucketeer.feature.Variation
	(*wrapperspb.Int32Value)(nil),                             // 163: google.protobuf.Int32Value
	(feature.Feature_VariationType)(0),                        // 164: bucketeer.feature.Feature.VariationType
	(*feature.Prerequisite)(nil),                              // 165: bucketeer.feature.Prerequisite
	(*feature.Rule)(nil),                                      // 166: bucketeer.feature.Rule
	(*feature.Target)(nil),                                    // 167: bucketeer.feature.Target
	(*feature.Strategy)(nil),                                  // 168: bucketeer.feature.Strategy
	(*feature.FixedStrategy)(nil),                             // 169: bucketeer.feature.FixedStrategy
	(*feature.RolloutStrategy)(nil),                           // 170: bucketeer.feature.RolloutStrategy
	(*feature.Clause)(nil),                                    // 171: bucketeer.feature.Clause
	(feature.Clause_Operator)(0),                              // 172: bucketeer.feature.Clause.Operator
	(account.AccountV2_Role_Organization)(0),                  // 173: bucketeer.account.AccountV2.Role.Organization
	(*account.AccountV2_EnvironmentRole)(nil),                 // 174: bucketeer.account.AccountV2.EnvironmentRole
	(account.FilterTargetType)(0),                             // 175: bucketeer.account.FilterTargetType
	(account.APIKey_Role)(0),                                  // 176: bucketeer.account.APIKey.Role
	(feature.SegmentUser_State)(0),                            // 177: bucketeer.feature.SegmentUser.State
	(feature.Segment_Status)(0),                               // 178: bucketeer.feature.Segment.Status
	(autoops.OpsType)(0),                                      // 179: bucketeer.autoops.OpsType
	(*autoops.Clause)(nil),                                    // 180: bucketeer.autoops.Clause
	(autoops.AutoOpsStatus)(0),                                // 181: bucketeer.autoops.AutoOpsStatus
	...
	(notification.Subscription_SourceType)(0),                 // 184: bucketeer.notification.Subscription.SourceType
	(*notification.Recipient)(nil),                            // 185: bucketeer.notification.Recipient
	(autoops.ProgressiveRollout_Type)(0),                      // 186: bucketeer.autoops.ProgressiveRollout.Type
	(autoops.ProgressiveRollout_Status)(0),                    // 187: bucketeer.autoops.ProgressiveRollout.Status
	(autoops.ProgressiveRollout_StoppedBy)(0),                 // 188: bucketeer.autoops.ProgressiveRollout.StoppedBy
...
var file_proto_event_domain_event_proto_depIdxs = []int32{
	...
	161, // 3: bucketeer.event.domain.Event.data:type_name -> google.protobuf.Any
	4,   // 4: bucketeer.event.domain.Event.options:type_name -> bucketeer.event.domain.Options
	162, // 5: bucketeer.event.domain.FeatureCreatedEvent.variations:type_name -> bucketeer.feature.Variation
	163, // 6: bucketeer.event.domain.FeatureCreatedEvent.default_on_variation_index:type_name -> google.protobuf.Int32Value
	163, // 7: bucketeer.event.domain.FeatureCreatedEvent.default_off_variation_index:type_name -> google.protobuf.Int32Value
	164, // 8: bucketeer.event.domain.FeatureCreatedEvent.variation_type:type_name -> bucketeer.feature.Feature.VariationType
	165, // 9: bucketeer.event.domain.FeatureCreatedEvent.prerequisites:type_name -> bucketeer.feature.Prerequisite
	166, // 10: bucketeer.event.domain.FeatureCreatedEvent.rules:type_name -> bucketeer.feature.Rule
	167, // 11: bucketeer.event.domain.FeatureCreatedEvent.targets:type_name -> bucketeer.feature.Target
	162, // 12: bucketeer.event.domain.FeatureVariationAddedEvent.variation:type_name -> bucketeer.feature.Variation
	166, // 13: bucketeer.event.domain.FeatureRuleAddedEvent.rule:type_name -> bucketeer.feature.Rule
	168, // 14: bucketeer.event.domain.FeatureChangeRuleStrategyEvent.strategy:type_name -> bucketeer.feature.Strategy
	169, // 15: bucketeer.event.domain.FeatureFixedStrategyChangedEvent.strategy:type_name -> bucketeer.feature.FixedStrategy
	170, // 16: bucketeer.event.domain.FeatureRolloutStrategyChangedEvent.strategy:type_name -> bucketeer.feature.RolloutStrategy
	171, // 17: bucketeer.event.domain.RuleClauseAddedEvent.clause:type_name -> bucketeer.feature.Clause
	172, // 18: bucketeer.event.domain.ClauseOperatorChangedEvent.operator:type_name -> bucketeer.feature.Clause.Operator
	168, // 19: bucketeer.event.domain.FeatureDefaultStrategyChangedEvent.strategy:type_name -> bucketeer.feature.Strategy
	162, // 20: bucketeer.event.domain.FeatureClonedEvent.variations:type_name -> bucketeer.feature.Variation
	167, // 21: bucketeer.event.domain.FeatureClonedEvent.targets:type_name -> bucketeer.feature.Target
	166, // 22: bucketeer.event.domain.FeatureClonedEvent.rules:type_name -> bucketeer.feature.Rule
	168, // 23: bucketeer.event.domain.FeatureClonedEvent.default_strategy:type_name -> bucketeer.feature.Strategy
	164, // 24: bucketeer.event.domain.FeatureClonedEvent.variation_type:type_name -> bucketeer.feature.Feature.VariationType
	165, // 25: bucketeer.event.domain.FeatureClonedEvent.prerequisites:type_name -> bucketeer.feature.Prerequisite
	162, // 26: bucketeer.event.domain.ExperimentCreatedEvent.variations:type_name -> bucketeer.feature.Variation
	173, // 27: bucketeer.event.domain.AccountV2CreatedEvent.organization_role:type_name -> bucketeer.account.AccountV2.Role.Organization
	174, // 28: bucketeer.event.domain.AccountV2CreatedEvent.environment_roles:type_name -> bucketeer.account.AccountV2.EnvironmentRole
	173, // 29: bucketeer.event.domain.AccountV2OrganizationRoleChangedEvent.organization_role:type_name -> bucketeer.account.AccountV2.Role.Organization
	174, // 30: bucketeer.event.domain.AccountV2EnvironmentRolesChangedEvent.environment_roles:type_name -> bucketeer.account.AccountV2.EnvironmentRole
	175, // 31: bucketeer.event.domain.SearchFilterCreatedEvent.TargetType:type_name -> bucketeer.account.FilterTargetType
	176, // 32: bucketeer.event.domain.APIKeyCreatedEvent.role:type_name -> bucketeer.account.APIKey.Role
	166, // 33: bucketeer.event.domain.SegmentRuleAddedEvent.rule:type_name -> bucketeer.feature.Rule
	171, // 34: bucketeer.event.domain.SegmentRuleClauseAddedEvent.clause:type_name -> bucketeer.feature.Clause
	172, // 35: bucketeer.event.domain.SegmentClauseOperatorChangedEvent.operator:type_name -> bucketeer.feature.Clause.Operator
	177, // 36: bucketeer.event.domain.SegmentUserAddedEvent.state:type_name -> bucketeer.feature.SegmentUser.State
	177, // 37: bucketeer.event.domain.SegmentUserDeletedEvent.state:type_name -> bucketeer.feature.SegmentUser.State
	178, // 38: bucketeer.event.domain.SegmentBulkUploadUsersEvent.status:type_name -> bucketeer.feature.Segment.Status
	177, // 39: bucketeer.event.domain.SegmentBulkUploadUsersEvent.state:type_name -> bucketeer.feature.SegmentUser.State
	178, // 40: bucketeer.event.domain.SegmentBulkUploadUsersStatusChangedEvent.status:type_name -> bucketeer.feature.Segment.Status
	177, // 41: bucketeer.event.domain.SegmentBulkUploadUsersStatusChangedEvent.state:type_name -> bucketeer.feature.SegmentUser.State
	179, // 42: bucketeer.event.domain.AutoOpsRuleCreatedEvent.ops_type:type_name -> bucketeer.autoops.OpsType
	180, // 43: bucketeer.event.domain.AutoOpsRuleCreatedEvent.clauses:type_name -> bucketeer.autoops.Clause
	181, // 44: bucketeer.event.domain.AutoOpsRuleCreatedEvent.ops_status:type_name -> bucketeer.autoops.AutoOpsStatus
	179, // 45: bucketeer.event.domain.AutoOpsRuleOpsTypeChangedEvent.ops_type:type_name -> bucketeer.autoops.OpsType
	181, // 46: bucketeer.event.domain.AutoOpsRuleOpsStatusChangedEvent.ops_status:type_name -> bucketeer.autoops.AutoOpsStatus
	182, // 47: bucketeer.event.domain.OpsEventRateClauseAddedEvent.ops_event_rate_clause:type_name -> bucketeer.autoops.OpsEventRateClause
	182, // 48: bucketeer.event.domain.OpsEventRateClauseChangedEvent.ops_event_rate_clause:type_name -> bucketeer.autoops.OpsEventRateClause
	183, // 49: bucketeer.event.domain.DatetimeClauseAddedEvent.datetime_clause:type_name -> bucketeer.autoops.DatetimeClause
	183, // 50: bucketeer.event.domain.DatetimeClauseChangedEvent.datetime_clause:type_name -> bucketeer.autoops.DatetimeClause
	184, // 51: bucketeer.event.domain.SubscriptionCreatedEvent.source_types:type_name -> bucketeer.notification.Subscription.SourceType
	185, // 52: bucketeer.event.domain.SubscriptionCreatedEvent.recipient:type_name -> bucketeer.notification.Recipient
	184, // 53: bucketeer.event.domain.SubscriptionSourceTypesAddedEvent.source_types:type_name -> bucketeer.notification.Subscription.SourceType
	184, // 54: bucketeer.event.domain.SubscriptionSourceTypesDeletedEvent.source_types:type_name -> bucketeer.notification.Subscription.SourceType
	184, // 55: bucketeer.event.domain.AdminSubscriptionCreatedEvent.source_types:type_name -> bucketeer.notification.Subscription.SourceType
	185, // 56: bucketeer.event.domain.AdminSubscriptionCreatedEvent.recipient:type_name -> bucketeer.notification.Recipient
	184, // 57: bucketeer.event.domain.AdminSubscriptionSourceTypesAddedEvent.source_types:type_name -> bucketeer.notification.Subscription.SourceType
	184, // 58: bucketeer.event.domain.AdminSubscriptionSourceTypesDeletedEvent.source_types:type_name -> bucketeer.notification.Subscription.SourceType
	165, // 59: bucketeer.event.domain.PrerequisiteAddedEvent.prerequisite:type_name -> bucketeer.feature.Prerequisite
	165, // 60: bucketeer.event.domain.PrerequisiteVariationChangedEvent.prerequisite:type_name -> bucketeer.feature.Prerequisite
	161, // 61: bucketeer.event.domain.ProgressiveRolloutCreatedEvent.clause:type_name -> google.protobuf.Any
	186, // 62: bucketeer.event.domain.ProgressiveRolloutCreatedEvent.type:type_name -> bucketeer.autoops.ProgressiveRollout.Type
	187, // 63: bucketeer.event.domain.ProgressiveRolloutStoppedEvent.status:type_name -> bucketeer.autoops.ProgressiveRollout.Status
	188, // 64: bucketeer.event.domain.ProgressiveRolloutStoppedEvent.stopped_by:type_name -> bucketeer.autoops.ProgressiveRollout.StoppedBy
	189, // 65: bucketeer.event.domain.FlagTriggerCreatedEvent.type:type_name -> bucketeer.feature.FlagTrigger.Type
	190, // 66: bucketeer.event.domain.FlagTriggerCreatedEvent.action:type_name -> bucketeer.feature.FlagTrigger.Action
