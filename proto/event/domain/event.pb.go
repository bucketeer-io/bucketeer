...
const (
	...
	Event_ACCOUNT_V2_UPDATED_DEFAULT_SEARCH_FILTER Event_Type = 314
...
var (
	Event_Type_name = map[int32]string{
		...
		314:  "ACCOUNT_V2_UPDATED_DEFAULT_SEARCH_FILTER",
		400:  "APIKEY_CREATED",
...
type DefaultSearchFilterUpdatedEvent struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	DefaultFilter bool `protobuf:"varint,1,opt,name=default_filter,json=defaultFilter,proto3" json:"default_filter"`
}

func (x *DefaultSearchFilterUpdatedEvent) Reset() {
	*x = DefaultSearchFilterUpdatedEvent{}
	if protoimpl.UnsafeEnabled {
...
func (x *DefaultSearchFilterUpdatedEvent) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*DefaultSearchFilterUpdatedEvent) ProtoMessage() {}

func (x *DefaultSearchFilterUpdatedEvent) ProtoReflect() protoreflect.Message {
	mi := &file_proto_event_domain_event_proto_msgTypes[65]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use DefaultSearchFilterUpdatedEvent.ProtoReflect.Descriptor instead.
func (*DefaultSearchFilterUpdatedEvent) Descriptor() ([]byte, []int) {
	return file_proto_event_domain_event_proto_rawDescGZIP(), []int{65}
}

func (x *DefaultSearchFilterUpdatedEvent) GetDefaultFilter() bool {
	if x != nil {
		return x.DefaultFilter
	}
	return false
...
var file_proto_event_domain_event_proto_rawDesc = []byte{
	...
	0x22, 0xbb, 0x2b, 0x0a, 0x05, 0x45, 0x76, 0x65, 0x6e, 0x74, 0x12, 0x0e, 0x0a, 0x02, 0x69, 0x64,
	...
	0x52, 0x10, 0x10, 0x22, 0x04, 0x08, 0x0d, 0x10, 0x0d, 0x22, 0x82, 0x25, 0x0a, 0x04, 0x54, 0x79,
	...
	0x54, 0x45, 0x52, 0x10, 0xb9, 0x02, 0x12, 0x2d, 0x0a, 0x28, 0x41, 0x43, 0x43, 0x4f, 0x55, 0x4e,
	0x54, 0x5f, 0x56, 0x32, 0x5f, 0x55, 0x50, 0x44, 0x41, 0x54, 0x45, 0x44, 0x5f, 0x44, 0x45, 0x46,
	0x41, 0x55, 0x4c, 0x54, 0x5f, 0x53, 0x45, 0x41, 0x52, 0x43, 0x48, 0x5f, 0x46, 0x49, 0x4c, 0x54,
	0x45, 0x52, 0x10, 0xba, 0x02, 0x12, 0x13, 0x0a, 0x0e, 0x41, 0x50, 0x49, 0x4b, 0x45, 0x59, 0x5f,
	...
	0x72, 0x22, 0x48, 0x0a, 0x1f, 0x44, 0x65, 0x66, 0x61, 0x75, 0x6c, 0x74, 0x53, 0x65, 0x61, 0x72,
	0x63, 0x68, 0x46, 0x69, 0x6c, 0x74, 0x65, 0x72, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65, 0x64, 0x45,
	0x76, 0x65, 0x6e, 0x74, 0x12, 0x25, 0x0a, 0x0e, 0x64, 0x65, 0x66, 0x61, 0x75, 0x6c, 0x74, 0x5f,
	0x66, 0x69, 0x6c, 0x74, 0x65, 0x72, 0x18, 0x01, 0x20, 0x01, 0x28, 0x08, 0x52, 0x0d, 0x64, 0x65,
	0x66, 0x61, 0x75, 0x6c, 0x74, 0x46, 0x69, 0x6c, 0x74, 0x65, 0x72, 0x22, 0xc6, 0x01, 0x0a, 0x12,
	...
	0x65, 0x64, 0x41, 0x74, 0x22, 0x3c, 0x0a, 0x16, 0x41, 0x50, 0x49, 0x4b, 0x65, 0x79, 0x4e, 0x61,
...
var file_proto_event_domain_event_proto_goTypes = []interface{}{
	...
	(*DefaultSearchFilterUpdatedEvent)(nil),                   // 67: bucketeer.event.domain.DefaultSearchFilterUpdatedEvent
	...
	(account.FilterTargetType)(0),                             // 171: bucketeer.account.FilterTargetType
...
var file_proto_event_domain_event_proto_depIdxs = []int32{
	...
	171, // 31: bucketeer.event.domain.SearchFilterCreatedEvent.TargetType:type_name -> bucketeer.account.FilterTargetType
	172, // 32: bucketeer.event.domain.APIKeyCreatedEvent.role:type_name -> bucketeer.account.APIKey.Role
	162, // 33: bucketeer.event.domain.SegmentRuleAddedEvent.rule:type_name -> bucketeer.feature.Rule
	167, // 34: bucketeer.event.domain.SegmentRuleClauseAddedEvent.clause:type_name -> bucketeer.feature.Clause
	168, // 35: bucketeer.event.domain.SegmentClauseOperatorChangedEvent.operator:type_name -> bucketeer.feature.Clause.Operator
	173, // 36: bucketeer.event.domain.SegmentUserAddedEvent.state:type_name -> bucketeer.feature.SegmentUser.State
	173, // 37: bucketeer.event.domain.SegmentUserDeletedEvent.state:type_name -> bucketeer.feature.SegmentUser.State
	174, // 38: bucketeer.event.domain.SegmentBulkUploadUsersEvent.status:type_name -> bucketeer.feature.Segment.Status
	173, // 39: bucketeer.event.domain.SegmentBulkUploadUsersEvent.state:type_name -> bucketeer.feature.SegmentUser.State
	174, // 40: bucketeer.event.domain.SegmentBulkUploadUsersStatusChangedEvent.status:type_name -> bucketeer.feature.Segment.Status
	173, // 41: bucketeer.event.domain.SegmentBulkUploadUsersStatusChangedEvent.state:type_name -> bucketeer.feature.SegmentUser.State
	175, // 42: bucketeer.event.domain.AutoOpsRuleCreatedEvent.ops_type:type_name -> bucketeer.autoops.OpsType
	176, // 43: bucketeer.event.domain.AutoOpsRuleCreatedEvent.clauses:type_name -> bucketeer.autoops.Clause
	177, // 44: bucketeer.event.domain.AutoOpsRuleCreatedEvent.ops_status:type_name -> bucketeer.autoops.AutoOpsStatus
	175, // 45: bucketeer.event.domain.AutoOpsRuleOpsTypeChangedEvent.ops_type:type_name -> bucketeer.autoops.OpsType
	177, // 46: bucketeer.event.domain.AutoOpsRuleOpsStatusChangedEvent.ops_status:type_name -> bucketeer.autoops.AutoOpsStatus
	178, // 47: bucketeer.event.domain.OpsEventRateClauseAddedEvent.ops_event_rate_clause:type_name -> bucketeer.autoops.OpsEventRateClause
	178, // 48: bucketeer.event.domain.OpsEventRateClauseChangedEvent.ops_event_rate_clause:type_name -> bucketeer.autoops.OpsEventRateClause
	179, // 49: bucketeer.event.domain.DatetimeClauseAddedEvent.datetime_clause:type_name -> bucketeer.autoops.DatetimeClause
	179, // 50: bucketeer.event.domain.DatetimeClauseChangedEvent.datetime_clause:type_name -> bucketeer.autoops.DatetimeClause
	180, // 51: bucketeer.event.domain.SubscriptionCreatedEvent.source_types:type_name -> bucketeer.notification.Subscription.SourceType
	181, // 52: bucketeer.event.domain.SubscriptionCreatedEvent.recipient:type_name -> bucketeer.notification.Recipient
	180, // 53: bucketeer.event.domain.SubscriptionSourceTypesAddedEvent.source_types:type_name -> bucketeer.notification.Subscription.SourceType
	180, // 54: bucketeer.event.domain.SubscriptionSourceTypesDeletedEvent.source_types:type_name -> bucketeer.notification.Subscription.SourceType
	180, // 55: bucketeer.event.domain.AdminSubscriptionCreatedEvent.source_types:type_name -> bucketeer.notification.Subscription.SourceType
	181, // 56: bucketeer.event.domain.AdminSubscriptionCreatedEvent.recipient:type_name -> bucketeer.notification.Recipient
	180, // 57: bucketeer.event.domain.AdminSubscriptionSourceTypesAddedEvent.source_types:type_name -> bucketeer.notification.Subscription.SourceType
	180, // 58: bucketeer.event.domain.AdminSubscriptionSourceTypesDeletedEvent.source_types:type_name -> bucketeer.notification.Subscription.SourceType
	161, // 59: bucketeer.event.domain.PrerequisiteAddedEvent.prerequisite:type_name -> bucketeer.feature.Prerequisite
	161, // 60: bucketeer.event.domain.PrerequisiteVariationChangedEvent.prerequisite:type_name -> bucketeer.feature.Prerequisite
	157, // 61: bucketeer.event.domain.ProgressiveRolloutCreatedEvent.clause:type_name -> google.protobuf.Any
	182, // 62: bucketeer.event.domain.ProgressiveRolloutCreatedEvent.type:type_name -> bucketeer.autoops.ProgressiveRollout.Type
	183, // 63: bucketeer.event.domain.ProgressiveRolloutStoppedEvent.status:type_name -> bucketeer.autoops.ProgressiveRollout.Status
	184, // 64: bucketeer.event.domain.ProgressiveRolloutStoppedEvent.stopped_by:type_name -> bucketeer.autoops.ProgressiveRollout.StoppedBy
	185, // 65: bucketeer.event.domain.FlagTriggerCreatedEvent.type:type_name -> bucketeer.feature.FlagTrigger.Type
	186, // 66: bucketeer.event.domain.FlagTriggerCreatedEvent.action:type_name -> bucketeer.feature.FlagTrigger.Action
...
func file_proto_event_domain_event_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_proto_event_domain_event_proto_msgTypes[65].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*DefaultSearchFilterUpdatedEvent); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
