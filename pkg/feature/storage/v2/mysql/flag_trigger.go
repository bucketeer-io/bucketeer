...
func NewFlagTriggerStorage(qe mysqlstorage.QueryExecer) v2fs.FlagTriggerStorage {
...
func (f *flagTriggerStorage) ListFlagTriggers(
	...
	query, whereArgs := mysqlstorage.ConstructQueryAndWhereArgs(listFlagTriggersSQL, options)
	...
	countQuery, countWhereArgs := mysqlstorage.ConstructCountQuery(countFlagTriggersSQL, options)
...
func listFlagTriggersOptionsFromParams(p v2fs.ListFlagTriggersParams) (*mysqlstorage.ListOptions, error) {
...
func listFlagTriggersOrders(
	...
	return []*mysqlstorage.Order{
		mysqlstorage.NewOrder(column, direction),
	}, nil
}
