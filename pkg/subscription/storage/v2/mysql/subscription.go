...
func NewSubscriptionStorage(qe mysql.QueryExecer) v2ns.SubscriptionStorage {
...
func (s *subscriptionStorage) ListSubscriptions(
	...
	countQuery, countWhereArgs := mysql.ConstructCountQuery(selectSubscriptionV2CountSQLQuery, options)
...
func listSubscriptionsOptions(params v2ns.ListSubscriptionsParams) (*mysql.ListOptions, error) {
