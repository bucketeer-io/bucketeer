...
if (goog.DEBUG && !COMPILED) {
   ...
   * @override
   */
  proto.bucketeer.test.TestRequest.displayName =
    'proto.bucketeer.test.TestRequest';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
...
if (goog.DEBUG && !COMPILED) {
   ...
   * @override
   */
  proto.bucketeer.test.TestResponse.displayName =
    'proto.bucketeer.test.TestResponse';
}
...
if (jspb.Message.GENERATE_TO_OBJECT) {
   ...
   * @return {!Object}
   */
  proto.bucketeer.test.TestRequest.prototype.toObject = function (
    opt_includeInstance
  ) {
...
proto.bucketeer.test.TestRequest.deserializeBinary = function (bytes) {
  ...
  return proto.bucketeer.test.TestRequest.deserializeBinaryFromReader(
    msg,
    reader
  );
};
 ...
 * @return {!proto.bucketeer.test.TestRequest}
 */
proto.bucketeer.test.TestRequest.deserializeBinaryFromReader = function (
  msg,
  reader
) {
 ...
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.bucketeer.test.TestRequest.serializeBinaryToWriter = function (
  message,
  writer
) {
  var f = undefined;
...
if (jspb.Message.GENERATE_TO_OBJECT) {
   ...
   * @return {!Object}
   */
  proto.bucketeer.test.TestResponse.prototype.toObject = function (
    opt_includeInstance
  ) {
    return proto.bucketeer.test.TestResponse.toObject(
      opt_includeInstance,
      this
    );
  };
...
proto.bucketeer.test.TestResponse.deserializeBinary = function (bytes) {
  ...
  return proto.bucketeer.test.TestResponse.deserializeBinaryFromReader(
    msg,
    reader
  );
};
 ...
 * @return {!proto.bucketeer.test.TestResponse}
 */
proto.bucketeer.test.TestResponse.deserializeBinaryFromReader = function (
  msg,
  reader
) {
  while (reader.nextField()) {
 ...
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.bucketeer.test.TestResponse.serializeBinaryToWriter = function (
  message,
  writer
) {
  var f = undefined;
