...
export class DomainEventNotification extends jspb.Message {
  ...
  setEntityType(
    value: proto_event_domain_event_pb.Event.EntityTypeMap[keyof proto_event_domain_event_pb.Event.EntityTypeMap]
  ): void;
  ...
  setType(
    value: proto_event_domain_event_pb.Event.TypeMap[keyof proto_event_domain_event_pb.Event.TypeMap]
  ): void;
  ...
  static toObject(
    includeInstance: boolean,
    msg: DomainEventNotification
  ): DomainEventNotification.AsObject;
  static extensions: { [key: number]: jspb.ExtensionFieldInfo<jspb.Message> };
  static extensionsBinary: {
    [key: number]: jspb.ExtensionFieldBinaryInfo<jspb.Message>;
  };
...
export class FeatureStaleNotification extends jspb.Message {
  ...
  static toObject(
    includeInstance: boolean,
    msg: FeatureStaleNotification
  ): FeatureStaleNotification.AsObject;
  static extensions: { [key: number]: jspb.ExtensionFieldInfo<jspb.Message> };
  static extensionsBinary: {
    [key: number]: jspb.ExtensionFieldBinaryInfo<jspb.Message>;
  };
...
export class ExperimentRunningNotification extends jspb.Message {
  ...
  static toObject(
    includeInstance: boolean,
    msg: ExperimentRunningNotification
  ): ExperimentRunningNotification.AsObject;
  static extensions: { [key: number]: jspb.ExtensionFieldInfo<jspb.Message> };
  static extensionsBinary: {
    [key: number]: jspb.ExtensionFieldBinaryInfo<jspb.Message>;
  };
...
export class MauCountNotification extends jspb.Message {
  ...
  static toObject(
    includeInstance: boolean,
    msg: MauCountNotification
  ): MauCountNotification.AsObject;
  static extensions: { [key: number]: jspb.ExtensionFieldInfo<jspb.Message> };
  static extensionsBinary: {
    [key: number]: jspb.ExtensionFieldBinaryInfo<jspb.Message>;
  };
