...
//
//	mockgen -source=environment.go -package=mock -destination=./mock/environment.go
//
...
func (mr *MockEnvironmentStorageMockRecorder) GetEnvironmentV2(ctx, id any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockEnvironmentStorageMockRecorder) UpdateEnvironmentV2(ctx, e any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
