...
var (
	...
	statusMissingIDs = api.NewGRPCStatus(
		pkgErr.NewErrorInvalidArgEmpty(pkgErr.FeaturePackageName, "missing ids", "ids"))
	...
	statusMissingUserID = api.NewGRPCStatus(
		pkgErr.NewErrorInvalidArgEmpty(pkgErr.FeaturePackageName, "missing user id", "user_id"))
	statusMissingUserIDs = api.NewGRPCStatus(
		pkgErr.NewErrorInvalidArgEmpty(pkgErr.FeaturePackageName, "missing user ids", "user_ids"))
	statusMissingFeatureIDs = api.NewGRPCStatus(
		pkgErr.NewErrorInvalidArgEmpty(pkgErr.FeaturePackageName, "missing feature ids", "feature_ids"))
	...
	statusMissingDefaultOnVariation = api.NewGRPCStatus(
		pkgErr.NewErrorInvalidArgNil(pkgErr.FeaturePackageName, "missing default on variation", "default_on_variation"))
	statusMissingDefaultOffVariation = api.NewGRPCStatus(
		pkgErr.NewErrorInvalidArgNil(pkgErr.FeaturePackageName, "missing default off variation", "default_off_variation"))
	...
	statusMissingVariationID = api.NewGRPCStatus(
		pkgErr.NewErrorInvalidArgEmpty(pkgErr.FeaturePackageName, "missing variation id", "variation_id"))
	statusInvalidVariationID = api.NewGRPCStatus(
		pkgErr.NewErrorInvalidArgUnknown(pkgErr.FeaturePackageName, "invalid variation id", "variation_id"))
	statusDifferentVariationsSize = api.NewGRPCStatus(
		pkgErr.NewErrorInvalidArgNotMatchFormat(
			pkgErr.FeaturePackageName,
			"feature variations and rollout variations must have the same size",
			"feature_variations_and_rollout_variations",
		))
	statusExceededMaxVariationWeight = api.NewGRPCStatus(
		pkgErr.NewErrorInvalidArgNotMatchFormat(
			pkgErr.FeaturePackageName,
			"the sum of all weights value is %d",
			"feature_variations_and_rollout_variations",
		))
	statusIncorrectVariationWeight = api.NewGRPCStatus(
		pkgErr.NewErrorInvalidArgNotMatchFormat(
			pkgErr.FeaturePackageName,
			"command: variation weight must be between 0 and %d",
			"feature_variations_and_rollout_variations",
		))
	...
	statusInvalidOrderBy = api.NewGRPCStatus(
		pkgErr.NewErrorInvalidArgNotMatchFormat(pkgErr.FeaturePackageName, "order_by is invalid", "order_by"))
	...
	statusMissingFeatureTags = api.NewGRPCStatus(
		pkgErr.NewErrorInvalidArgEmpty(pkgErr.FeaturePackageName, "feature must contain one or more tags", "feature_tags"))
	...
	statusMissingRuleID = api.NewGRPCStatus(
		pkgErr.NewErrorInvalidArgEmpty(pkgErr.FeaturePackageName, "missing rule id", "rule_id"))
	statusMissingRuleClause = api.NewGRPCStatus(
		pkgErr.NewErrorInvalidArgEmpty(pkgErr.FeaturePackageName, "missing rule clause", "rule_clause"))
	statusMissingClauseID = api.NewGRPCStatus(
		pkgErr.NewErrorInvalidArgEmpty(pkgErr.FeaturePackageName, "missing clause id", "clause_id"))
	statusMissingClauseAttribute = api.NewGRPCStatus(
		pkgErr.NewErrorInvalidArgEmpty(pkgErr.FeaturePackageName, "missing clause attribute", "clause_attribute"))
	statusMissingClauseValues = api.NewGRPCStatus(
		pkgErr.NewErrorInvalidArgEmpty(pkgErr.FeaturePackageName, "missing clause values", "clause_values"))
	statusMissingClauseValue = api.NewGRPCStatus(
		pkgErr.NewErrorInvalidArgEmpty(pkgErr.FeaturePackageName, "missing clause value", "clause_value"))
	statusMissingSegmentID = api.NewGRPCStatus(
		pkgErr.NewErrorInvalidArgEmpty(pkgErr.FeaturePackageName, "missing segment id", "segment_id"))
	statusMissingSegmentUsersData = api.NewGRPCStatus(
		pkgErr.NewErrorInvalidArgEmpty(pkgErr.FeaturePackageName, "missing segment users data", "segment_users_data"))
	statusMissingRuleStrategy = api.NewGRPCStatus(
		pkgErr.NewErrorInvalidArgNil(pkgErr.FeaturePackageName, "missing rule strategy", "rule_strategy"))
	...
	statusMissingFixedStrategy = api.NewGRPCStatus(
		pkgErr.NewErrorInvalidArgNil(pkgErr.FeaturePackageName, "missing fixed strategy", "fixed_strategy"))
	statusMissingRolloutStrategy = api.NewGRPCStatus(
		pkgErr.NewErrorInvalidArgNil(pkgErr.FeaturePackageName, "missing rollout strategy", "rollout_strategy"))
	statusExceededMaxSegmentUsersDataSize = api.NewGRPCStatus(
		pkgErr.NewErrorInvalidArgNotMatchFormat(
			pkgErr.FeaturePackageName,
			"max segment users data size allowed is %d bytes",
			"segment_users_data",
		))
	statusUnknownSegmentUserState = api.NewGRPCStatus(
		pkgErr.NewErrorInvalidArgUnknown(pkgErr.FeaturePackageName, "unknown segment user state", "segment_user_state"))
	...
	statusExceededMaxUserIDsLength = api.NewGRPCStatus(
		pkgErr.NewErrorInvalidArgNotMatchFormat(pkgErr.FeaturePackageName, "max user ids length allowed is %d", "user_ids"))
	...
	statusExceededMaxPageSizePerRequest = api.NewGRPCStatus(
		pkgErr.NewErrorInvalidArgNotMatchFormat(pkgErr.FeaturePackageName, "max page size allowed is %d", "page_size"))
	statusNotFound = api.NewGRPCStatus(
		pkgErr.NewErrorNotFound(pkgErr.FeaturePackageName, "not found", "feature"))
	...
	statusMissingTriggerFeatureID = api.NewGRPCStatus(
		pkgErr.NewErrorInvalidArgEmpty(pkgErr.FeaturePackageName, "missing trigger feature id", "trigger_feature_id"))
	statusMissingTriggerType = api.NewGRPCStatus(
		pkgErr.NewErrorInvalidArgEmpty(pkgErr.FeaturePackageName, "missing trigger type", "trigger_type"))
	statusMissingTriggerAction = api.NewGRPCStatus(
		pkgErr.NewErrorInvalidArgEmpty(pkgErr.FeaturePackageName, "missing trigger action", "trigger_action"))
	statusMissingTriggerID = api.NewGRPCStatus(
		pkgErr.NewErrorInvalidArgEmpty(pkgErr.FeaturePackageName, "missing trigger id", "trigger_id"))
	statusSecretRequired = api.NewGRPCStatus(
		pkgErr.NewErrorInvalidArgEmpty(pkgErr.FeaturePackageName, "trigger secret is required", "trigger_secret"))
	...
	statusTriggerNotFound = api.NewGRPCStatus(
		pkgErr.NewErrorNotFound(pkgErr.FeaturePackageName, "trigger not found", "trigger"))
	...
	statusTriggerActionInvalid = api.NewGRPCStatus(
		pkgErr.NewErrorInvalidArgUnknown(pkgErr.FeaturePackageName, "trigger action is invalid", "trigger_action"))
