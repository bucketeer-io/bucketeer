...
var file_proto_event_domain_event_proto_rawDesc = []byte{
	...
	0x22, 0xb5, 0x2e, 0x0a, 0x05, 0x45, 0x76, 0x65, 0x6e, 0x74, 0x12, 0x0e, 0x0a, 0x02, 0x69, 0x64,
	...
	0x47, 0x45, 0x52, 0x10, 0x10, 0x22, 0x04, 0x08, 0x0d, 0x10, 0x0d, 0x22, 0x84, 0x28, 0x0a, 0x04,
	...
	0x55, 0x53, 0x5f, 0x43, 0x48, 0x41, 0x4e, 0x47, 0x45, 0x44, 0x10, 0xaa, 0x06, 0x12, 0x11, 0x0a,
	...
	0x54, 0x45, 0x44, 0x10, 0xef, 0x07, 0x12, 0x1f, 0x0a, 0x1a, 0x41, 0x44, 0x4d, 0x49, 0x4e, 0x5f,
	...
	0x6e, 0x74, 0x22, 0xfe, 0x03, 0x0a, 0x15, 0x41, 0x63, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x56, 0x32,
	...
	0x61, 0x67, 0x65, 0x22, 0x56, 0x0a, 0x15, 0x41, 0x63, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x56, 0x32,
...
var file_proto_event_domain_event_proto_msgTypes = make([]protoimpl.MessageInfo, 169)
var file_proto_event_domain_event_proto_goTypes = []interface{}{
	...
	(*Editor_PublicAPIEditor)(nil),                            // 170: bucketeer.event.domain.Editor.PublicAPIEditor
	(*anypb.Any)(nil),                                         // 171: google.protobuf.Any
	(*feature.Variation)(nil),                                 // 172: bucketeer.feature.Variation
	(*wrapperspb.Int32Value)(nil),                             // 173: google.protobuf.Int32Value
	(feature.Feature_VariationType)(0),                        // 174: bucketeer.feature.Feature.VariationType
	(*feature.Prerequisite)(nil),                              // 175: bucketeer.feature.Prerequisite
	(*feature.Rule)(nil),                                      // 176: bucketeer.feature.Rule
	(*feature.Target)(nil),                                    // 177: bucketeer.feature.Target
	(*feature.Strategy)(nil),                                  // 178: bucketeer.feature.Strategy
	(*feature.FixedStrategy)(nil),                             // 179: bucketeer.feature.FixedStrategy
	(*feature.RolloutStrategy)(nil),                           // 180: bucketeer.feature.RolloutStrategy
	(*feature.Clause)(nil),                                    // 181: bucketeer.feature.Clause
	(feature.Clause_Operator)(0),                              // 182: bucketeer.feature.Clause.Operator
	(account.AccountV2_Role_Organization)(0),                  // 183: bucketeer.account.AccountV2.Role.Organization
	(*account.AccountV2_EnvironmentRole)(nil),                 // 184: bucketeer.account.AccountV2.EnvironmentRole
	(account.FilterTargetType)(0),                             // 185: bucketeer.account.FilterTargetType
	(account.APIKey_Role)(0),                                  // 186: bucketeer.account.APIKey.Role
	...
	(notification.Subscription_SourceType)(0),                 // 195: bucketeer.notification.Subscription.SourceType
	(*notification.Recipient)(nil),                            // 196: bucketeer.notification.Recipient
	(*wrapperspb.BoolValue)(nil),                              // 197: google.protobuf.BoolValue
	(autoops.ProgressiveRollout_Type)(0),                      // 198: bucketeer.autoops.ProgressiveRollout.Type
	(autoops.ProgressiveRollout_Status)(0),                    // 199: bucketeer.autoops.ProgressiveRollout.Status
	(autoops.ProgressiveRollout_StoppedBy)(0),                 // 200: bucketeer.autoops.ProgressiveRollout.StoppedBy
	(feature.FlagTrigger_Type)(0),                             // 201: bucketeer.feature.FlagTrigger.Type
	(feature.FlagTrigger_Action)(0),                           // 202: bucketeer.feature.FlagTrigger.Action
}
var file_proto_event_domain_event_proto_depIdxs = []int32{
	...
	171, // 3: bucketeer.event.domain.Event.data:type_name -> google.protobuf.Any
	4,   // 4: bucketeer.event.domain.Event.options:type_name -> bucketeer.event.domain.Options
	170, // 5: bucketeer.event.domain.Editor.public_api_editor:type_name -> bucketeer.event.domain.Editor.PublicAPIEditor
	172, // 6: bucketeer.event.domain.FeatureCreatedEvent.variations:type_name -> bucketeer.feature.Variation
	173, // 7: bucketeer.event.domain.FeatureCreatedEvent.default_on_variation_index:type_name -> google.protobuf.Int32Value
	173, // 8: bucketeer.event.domain.FeatureCreatedEvent.default_off_variation_index:type_name -> google.protobuf.Int32Value
	174, // 9: bucketeer.event.domain.FeatureCreatedEvent.variation_type:type_name -> bucketeer.feature.Feature.VariationType
	175, // 10: bucketeer.event.domain.FeatureCreatedEvent.prerequisites:type_name -> bucketeer.feature.Prerequisite
	176, // 11: bucketeer.event.domain.FeatureCreatedEvent.rules:type_name -> bucketeer.feature.Rule
	177, // 12: bucketeer.event.domain.FeatureCreatedEvent.targets:type_name -> bucketeer.feature.Target
	172, // 13: bucketeer.event.domain.FeatureVariationAddedEvent.variation:type_name -> bucketeer.feature.Variation
	176, // 14: bucketeer.event.domain.FeatureRuleAddedEvent.rule:type_name -> bucketeer.feature.Rule
	178, // 15: bucketeer.event.domain.FeatureChangeRuleStrategyEvent.strategy:type_name -> bucketeer.feature.Strategy
	179, // 16: bucketeer.event.domain.FeatureFixedStrategyChangedEvent.strategy:type_name -> bucketeer.feature.FixedStrategy
	180, // 17: bucketeer.event.domain.FeatureRolloutStrategyChangedEvent.strategy:type_name -> bucketeer.feature.RolloutStrategy
	181, // 18: bucketeer.event.domain.RuleClauseAddedEvent.clause:type_name -> bucketeer.feature.Clause
	182, // 19: bucketeer.event.domain.ClauseOperatorChangedEvent.operator:type_name -> bucketeer.feature.Clause.Operator
	178, // 20: bucketeer.event.domain.FeatureDefaultStrategyChangedEvent.strategy:type_name -> bucketeer.feature.Strategy
	172, // 21: bucketeer.event.domain.FeatureClonedEvent.variations:type_name -> bucketeer.feature.Variation
	177, // 22: bucketeer.event.domain.FeatureClonedEvent.targets:type_name -> bucketeer.feature.Target
	176, // 23: bucketeer.event.domain.FeatureClonedEvent.rules:type_name -> bucketeer.feature.Rule
	178, // 24: bucketeer.event.domain.FeatureClonedEvent.default_strategy:type_name -> bucketeer.feature.Strategy
	174, // 25: bucketeer.event.domain.FeatureClonedEvent.variation_type:type_name -> bucketeer.feature.Feature.VariationType
	175, // 26: bucketeer.event.domain.FeatureClonedEvent.prerequisites:type_name -> bucketeer.feature.Prerequisite
	172, // 27: bucketeer.event.domain.ExperimentCreatedEvent.variations:type_name -> bucketeer.feature.Variation
	183, // 28: bucketeer.event.domain.AccountV2CreatedEvent.organization_role:type_name -> bucketeer.account.AccountV2.Role.Organization
	184, // 29: bucketeer.event.domain.AccountV2CreatedEvent.environment_roles:type_name -> bucketeer.account.AccountV2.EnvironmentRole
	183, // 30: bucketeer.event.domain.AccountV2OrganizationRoleChangedEvent.organization_role:type_name -> bucketeer.account.AccountV2.Role.Organization
	184, // 31: bucketeer.event.domain.AccountV2EnvironmentRolesChangedEvent.environment_roles:type_name -> bucketeer.account.AccountV2.EnvironmentRole
	185, // 32: bucketeer.event.domain.SearchFilterCreatedEvent.TargetType:type_name -> bucketeer.account.FilterTargetType
	186, // 33: bucketeer.event.domain.APIKeyCreatedEvent.role:type_name -> bucketeer.account.APIKey.Role
	187, // 34: bucketeer.event.domain.SegmentUpdatedEvent.name:type_name -> google.protobuf.StringValue
	187, // 35: bucketeer.event.domain.SegmentUpdatedEvent.description:type_name -> google.protobuf.StringValue
	176, // 36: bucketeer.event.domain.SegmentRuleAddedEvent.rule:type_name -> bucketeer.feature.Rule
	181, // 37: bucketeer.event.domain.SegmentRuleClauseAddedEvent.clause:type_name -> bucketeer.feature.Clause
	182, // 38: bucketeer.event.domain.SegmentClauseOperatorChangedEvent.operator:type_name -> bucketeer.feature.Clause.Operator
	188, // 39: bucketeer.event.domain.SegmentUserAddedEvent.state:type_name -> bucketeer.feature.SegmentUser.State
	188, // 40: bucketeer.event.domain.SegmentUserDeletedEvent.state:type_name -> bucketeer.feature.SegmentUser.State
	189, // 41: bucketeer.event.domain.SegmentBulkUploadUsersEvent.status:type_name -> bucketeer.feature.Segment.Status
	188, // 42: bucketeer.event.domain.SegmentBulkUploadUsersEvent.state:type_name -> bucketeer.feature.SegmentUser.State
	189, // 43: bucketeer.event.domain.SegmentBulkUploadUsersStatusChangedEvent.status:type_name -> bucketeer.feature.Segment.Status
	188, // 44: bucketeer.event.domain.SegmentBulkUploadUsersStatusChangedEvent.state:type_name -> bucketeer.feature.SegmentUser.State
	190, // 45: bucketeer.event.domain.AutoOpsRuleCreatedEvent.ops_type:type_name -> bucketeer.autoops.OpsType
	191, // 46: bucketeer.event.domain.AutoOpsRuleCreatedEvent.clauses:type_name -> bucketeer.autoops.Clause
	192, // 47: bucketeer.event.domain.AutoOpsRuleCreatedEvent.ops_status:type_name -> bucketeer.autoops.AutoOpsStatus
	190, // 48: bucketeer.event.domain.AutoOpsRuleOpsTypeChangedEvent.ops_type:type_name -> bucketeer.autoops.OpsType
	192, // 49: bucketeer.event.domain.AutoOpsRuleOpsStatusChangedEvent.ops_status:type_name -> bucketeer.autoops.AutoOpsStatus
	193, // 50: bucketeer.event.domain.OpsEventRateClauseAddedEvent.ops_event_rate_clause:type_name -> bucketeer.autoops.OpsEventRateClause
	193, // 51: bucketeer.event.domain.OpsEventRateClauseChangedEvent.ops_event_rate_clause:type_name -> bucketeer.autoops.OpsEventRateClause
	194, // 52: bucketeer.event.domain.DatetimeClauseAddedEvent.datetime_clause:type_name -> bucketeer.autoops.DatetimeClause
	194, // 53: bucketeer.event.domain.DatetimeClauseChangedEvent.datetime_clause:type_name -> bucketeer.autoops.DatetimeClause
	187, // 54: bucketeer.event.domain.PushUpdatedEvent.name:type_name -> google.protobuf.StringValue
	195, // 55: bucketeer.event.domain.SubscriptionCreatedEvent.source_types:type_name -> bucketeer.notification.Subscription.SourceType
	196, // 56: bucketeer.event.domain.SubscriptionCreatedEvent.recipient:type_name -> bucketeer.notification.Recipient
	195, // 57: bucketeer.event.domain.SubscriptionSourceTypesAddedEvent.source_types:type_name -> bucketeer.notification.Subscription.SourceType
	195, // 58: bucketeer.event.domain.SubscriptionSourceTypesDeletedEvent.source_types:type_name -> bucketeer.notification.Subscription.SourceType
	187, // 59: bucketeer.event.domain.SubscriptionUpdatedEvent.name:type_name -> google.protobuf.StringValue
	195, // 60: bucketeer.event.domain.SubscriptionUpdatedEvent.source_types:type_name -> bucketeer.notification.Subscription.SourceType
	197, // 61: bucketeer.event.domain.SubscriptionUpdatedEvent.disabled:type_name -> google.protobuf.BoolValue
	195, // 62: bucketeer.event.domain.AdminSubscriptionCreatedEvent.source_types:type_name -> bucketeer.notification.Subscription.SourceType
	196, // 63: bucketeer.event.domain.AdminSubscriptionCreatedEvent.recipient:type_name -> bucketeer.notification.Recipient
	195, // 64: bucketeer.event.domain.AdminSubscriptionSourceTypesAddedEvent.source_types:type_name -> bucketeer.notification.Subscription.SourceType
	195, // 65: bucketeer.event.domain.AdminSubscriptionSourceTypesDeletedEvent.source_types:type_name -> bucketeer.notification.Subscription.SourceType
	175, // 66: bucketeer.event.domain.PrerequisiteAddedEvent.prerequisite:type_name -> bucketeer.feature.Prerequisite
	175, // 67: bucketeer.event.domain.PrerequisiteVariationChangedEvent.prerequisite:type_name -> bucketeer.feature.Prerequisite
	171, // 68: bucketeer.event.domain.ProgressiveRolloutCreatedEvent.clause:type_name -> google.protobuf.Any
	198, // 69: bucketeer.event.domain.ProgressiveRolloutCreatedEvent.type:type_name -> bucketeer.autoops.ProgressiveRollout.Type
	199, // 70: bucketeer.event.domain.ProgressiveRolloutStoppedEvent.status:type_name -> bucketeer.autoops.ProgressiveRollout.Status
	200, // 71: bucketeer.event.domain.ProgressiveRolloutStoppedEvent.stopped_by:type_name -> bucketeer.autoops.ProgressiveRollout.StoppedBy
	201, // 72: bucketeer.event.domain.FlagTriggerCreatedEvent.type:type_name -> bucketeer.feature.FlagTrigger.Type
	202, // 73: bucketeer.event.domain.FlagTriggerCreatedEvent.action:type_name -> bucketeer.feature.FlagTrigger.Action
