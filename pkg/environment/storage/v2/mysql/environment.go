...
func NewEnvironmentStorage(qe mysqlstorage.QueryExecer) v2es.EnvironmentStorage {
...
func (s *environmentStorage) ListEnvironmentsV2(
	...
	countQuery, countWhereArgs := mysqlstorage.ConstructCountQuery(countEnvironmentsSQL, options)
...
func listEnvironmentsOptionsFromParams(p v2es.ListEnvironmentsV2Params) (*mysqlstorage.ListOptions, error) {
