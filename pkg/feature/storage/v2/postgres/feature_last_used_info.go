...
func NewFeatureLastUsedInfoStorage(qe pgstorage.QueryExecer) v2fs.FeatureLastUsedInfoStorage {
...
func (s *featureLastUsedInfoStorage) GetFeatureLastUsedInfos(
	...
	whereParts := []pgstorage.WherePart{
		&pgstorage.InFilter{Column: "id", Values: inFilterIDs},
		&pgstorage.Filter{Column: "environment_id", Operator: pgstorage.OperatorEqual, Value: environmentId},
	}
