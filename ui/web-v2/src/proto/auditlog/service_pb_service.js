...
AuditLogServiceClient.prototype.listAdminAuditLogs =
  function listAdminAuditLogs(requestMessage, metadata, callback) {
    if (arguments.length === 2) {
      callback = arguments[1];
    }
...
AuditLogServiceClient.prototype.listFeatureHistory =
  function listFeatureHistory(requestMessage, metadata, callback) {
    if (arguments.length === 2) {
      callback = arguments[1];
    }
