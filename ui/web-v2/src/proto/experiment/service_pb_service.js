...
ExperimentServiceClient.prototype.getGoal = function getGoal(
  requestMessage,
  metadata,
  callback
) {
...
ExperimentServiceClient.prototype.listGoals = function listGoals(
  requestMessage,
  metadata,
  callback
) {
...
ExperimentServiceClient.prototype.createGoal = function createGoal(
  requestMessage,
  metadata,
  callback
) {
...
ExperimentServiceClient.prototype.updateGoal = function updateGoal(
  requestMessage,
  metadata,
  callback
) {
...
ExperimentServiceClient.prototype.archiveGoal = function archiveGoal(
  requestMessage,
  metadata,
  callback
) {
...
ExperimentServiceClient.prototype.deleteGoal = function deleteGoal(
  requestMessage,
  metadata,
  callback
) {
...
ExperimentServiceClient.prototype.getExperiment = function getExperiment(
  requestMessage,
  metadata,
  callback
) {
...
ExperimentServiceClient.prototype.listExperiments = function listExperiments(
  requestMessage,
  metadata,
  callback
) {
...
ExperimentServiceClient.prototype.createExperiment = function createExperiment(
  requestMessage,
  metadata,
  callback
) {
...
ExperimentServiceClient.prototype.updateExperiment = function updateExperiment(
  requestMessage,
  metadata,
  callback
) {
...
ExperimentServiceClient.prototype.startExperiment = function startExperiment(
  requestMessage,
  metadata,
  callback
) {
...
ExperimentServiceClient.prototype.finishExperiment = function finishExperiment(
  requestMessage,
  metadata,
  callback
) {
...
ExperimentServiceClient.prototype.stopExperiment = function stopExperiment(
  requestMessage,
  metadata,
  callback
) {
...
ExperimentServiceClient.prototype.archiveExperiment =
  function archiveExperiment(requestMessage, metadata, callback) {
    if (arguments.length === 2) {
      callback = arguments[1];
    }
...
ExperimentServiceClient.prototype.deleteExperiment = function deleteExperiment(
  requestMessage,
  metadata,
  callback
) {
