...
func (x *ChangeTagsCommand) Reset() {
	*x = ChangeTagsCommand{}
	if protoimpl.UnsafeEnabled {
...
func (x *ChangeTagsCommand) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ChangeTagsCommand) ProtoMessage() {}

func (x *ChangeTagsCommand) ProtoReflect() protoreflect.Message {
	mi := &file_proto_account_command_proto_msgTypes[7]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ChangeTagsCommand.ProtoReflect.Descriptor instead.
func (*ChangeTagsCommand) Descriptor() ([]byte, []int) {
	return file_proto_account_command_proto_rawDescGZIP(), []int{7}
}

func (x *ChangeTagsCommand) GetTags() []string {
	if x != nil {
		return x.Tags
	}
	return nil
...
var file_proto_account_command_proto_rawDesc = []byte{
	...
	0x22, 0x27, 0x0a, 0x11, 0x43, 0x68, 0x61, 0x6e, 0x67, 0x65, 0x54, 0x61, 0x67, 0x73, 0x43, 0x6f,
	0x6d, 0x6d, 0x61, 0x6e, 0x64, 0x12, 0x12, 0x0a, 0x04, 0x74, 0x61, 0x67, 0x73, 0x18, 0x01, 0x20,
	0x03, 0x28, 0x09, 0x52, 0x04, 0x74, 0x61, 0x67, 0x73, 0x22, 0x3d, 0x0a, 0x1e, 0x43, 0x68, 0x61,
	0x6e, 0x67, 0x65, 0x41, 0x63, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x56, 0x32, 0x4c, 0x61, 0x73, 0x74,
	0x53, 0x65, 0x65, 0x6e, 0x43, 0x6f, 0x6d, 0x6d, 0x61, 0x6e, 0x64, 0x12, 0x1b, 0x0a, 0x09, 0x6c,
	0x61, 0x73, 0x74, 0x5f, 0x73, 0x65, 0x65, 0x6e, 0x18, 0x01, 0x20, 0x01, 0x28, 0x03, 0x52, 0x08,
	0x6c, 0x61, 0x73, 0x74, 0x53, 0x65, 0x65, 0x6e, 0x22, 0x6c, 0x0a, 0x26, 0x43, 0x68, 0x61, 0x6e,
...
var file_proto_account_command_proto_goTypes = []interface{}{
	...
	(*ChangeTagsCommand)(nil),                             // 8: bucketeer.account.ChangeTagsCommand
...
func file_proto_account_command_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_proto_account_command_proto_msgTypes[7].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*ChangeTagsCommand); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
