...
goog.exportSymbol('proto.bucketeer.feature.RuleListValue', null, global);
/**
...
proto.bucketeer.feature.Rule = function (opt_data) {
  jspb.Message.initialize(
    ...
    0,
    -1,
    proto.bucketeer.feature.Rule.repeatedFields_,
    null
  );
};
 ...
 * @constructor
 */
proto.bucketeer.feature.RuleListValue = function (opt_data) {
  jspb.Message.initialize(
    this,
    opt_data,
    0,
    -1,
    proto.bucketeer.feature.RuleListValue.repeatedFields_,
    null
  );
};
goog.inherits(proto.bucketeer.feature.RuleListValue, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.bucketeer.feature.RuleListValue.displayName =
    'proto.bucketeer.feature.RuleListValue';
}
...
if (jspb.Message.GENERATE_TO_OBJECT) {
   ...
   * @return {!Object}
   */
  proto.bucketeer.feature.Rule.prototype.toObject = function (
    opt_includeInstance
  ) {
 ...
 * @return {!proto.bucketeer.feature.Rule}
 */
proto.bucketeer.feature.Rule.deserializeBinaryFromReader = function (
  msg,
  reader
) {
 ...
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.bucketeer.feature.Rule.serializeBinaryToWriter = function (
  message,
  writer
) {
  var f = undefined;
 ...
 */
proto.bucketeer.feature.Rule.prototype.addClauses = function (
  opt_value,
  opt_index
) {
  return jspb.Message.addToRepeatedWrapperField(
    ...
    3,
    opt_value,
    proto.bucketeer.feature.Clause,
    opt_index
  );
};
 ...
 * @const
 */
proto.bucketeer.feature.RuleListValue.repeatedFields_ = [1];
...
if (jspb.Message.GENERATE_TO_OBJECT) {
   ...
   * @return {!Object}
   */
  proto.bucketeer.feature.RuleListValue.prototype.toObject = function (
    opt_includeInstance
  ) {
    return proto.bucketeer.feature.RuleListValue.toObject(
      opt_includeInstance,
      this
    );
  };
   ...
   *     the JSPB instance for transitional soy proto support:
   *     http://goto/soy-param-migration
   * @param {!proto.bucketeer.feature.RuleListValue} msg The msg instance to transform.
   * @return {!Object}
   * @suppress {unusedLocalVariables} f is only used for nested messages
   */
  proto.bucketeer.feature.RuleListValue.toObject = function (
    includeInstance,
    msg
  ) {
    var f,
      obj = {
        valuesList: jspb.Message.toObjectList(
          msg.getValuesList(),
          proto.bucketeer.feature.Rule.toObject,
          includeInstance
        )
      };
 ...
 */
proto.bucketeer.feature.RuleListValue.deserializeBinary = function (bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.bucketeer.feature.RuleListValue();
  return proto.bucketeer.feature.RuleListValue.deserializeBinaryFromReader(
    msg,
    reader
  );
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.bucketeer.feature.RuleListValue} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.bucketeer.feature.RuleListValue}
 */
proto.bucketeer.feature.RuleListValue.deserializeBinaryFromReader = function (
  msg,
  reader
) {
  while (reader.nextField()) {
    ...
    switch (field) {
      case 1:
        var value = new proto.bucketeer.feature.Rule();
        reader.readMessage(
          value,
          proto.bucketeer.feature.Rule.deserializeBinaryFromReader
        );
        msg.addValues(value);
        break;
      default:
 ...
 * @return {!Uint8Array}
 */
proto.bucketeer.feature.RuleListValue.prototype.serializeBinary = function () {
  var writer = new jspb.BinaryWriter();
  proto.bucketeer.feature.RuleListValue.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.bucketeer.feature.RuleListValue} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.bucketeer.feature.RuleListValue.serializeBinaryToWriter = function (
  message,
  writer
) {
  var f = undefined;
  ...
  if (f.length > 0) {
    writer.writeRepeatedMessage(
      1,
      f,
      proto.bucketeer.feature.Rule.serializeBinaryToWriter
    );
  }
};
 ...
 */
proto.bucketeer.feature.RuleListValue.prototype.getValuesList = function () {
  return /** @type{!Array<!proto.bucketeer.feature.Rule>} */ (
    jspb.Message.getRepeatedWrapperField(this, proto.bucketeer.feature.Rule, 1)
  );
};

/**
 * @param {!Array<!proto.bucketeer.feature.Rule>} value
 * @return {!proto.bucketeer.feature.RuleListValue} returns this
 */
proto.bucketeer.feature.RuleListValue.prototype.setValuesList = function (
  value
) {
 ...
 * @return {!proto.bucketeer.feature.Rule}
 */
proto.bucketeer.feature.RuleListValue.prototype.addValues = function (
  opt_value,
  opt_index
) {
  return jspb.Message.addToRepeatedWrapperField(
 ...
 * @return {!proto.bucketeer.feature.RuleListValue} returns this
 */
proto.bucketeer.feature.RuleListValue.prototype.clearValuesList = function () {
