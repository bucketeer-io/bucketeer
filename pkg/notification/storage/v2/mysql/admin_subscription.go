...
func NewAdminSubscriptionStorage(qe mysql.QueryExecer) v2ns.AdminSubscriptionStorage {
...
func (s *adminSubscriptionStorage) ListAdminSubscriptions(
	...
	countQuery, countWhereArgs := mysql.ConstructCountQuery(selectAdminSubscriptionV2CountSQLQuery, options)
...
func listAdminSubscriptionsOptions(params v2ns.ListAdminSubscriptionsParams) (*mysql.ListOptions, error) {
