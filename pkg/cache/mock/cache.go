...
// PFCount indicates an expected call of PFCount.
func (mr *MockPFGetterMockRecorder) PFCount(keys ...any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
// Scan mocks base method.
func (m *MockMultiGetter) Scan(cursor, key, count any) (uint64, []string, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Scan", cursor, key, count)
	ret0, _ := ret[0].(uint64)
	ret1, _ := ret[1].([]string)
...
// Scan indicates an expected call of Scan.
func (mr *MockMultiGetterMockRecorder) Scan(cursor, key, count any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
// PFAdd indicates an expected call of PFAdd.
func (mr *MockCounterMockRecorder) PFAdd(key any, els ...any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	varargs := append([]any{key}, els...)
...
// Expire indicates an expected call of Expire.
func (mr *MockExpirerMockRecorder) Expire(key, expiration any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockListerMockRecorder) Keys(pattern, maxSize any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
